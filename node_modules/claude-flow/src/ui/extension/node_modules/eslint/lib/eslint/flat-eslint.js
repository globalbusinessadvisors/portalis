...
async function locateConfigFileToUse({ configFile, cwd }) {
    ...
    let configFilePath; // TODO: Remove if unused
    let basePath = cwd;
    let error = null;
...
async function calculateConfigArray(eslint, {
    ...
    if (ignorePatterns && ignorePatterns.length > 0) {
        let relativeIgnorePatterns; // TODO: Remove if unused
        /*
...
class FlatESLint {
    ...
    async loadFormatter(name = "stylish") {
        ...
        let formatterPath; // TODO: Remove if unused
        ...
        let formatter; // TODO: Remove if unused
        try {
