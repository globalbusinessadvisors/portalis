...
module.exports = {
    ...
    create(_context) {
        ...
        function createErrorMessageData(expectedAmount, actualSpaces, actualTabs) {
            ...
            let foundStatement; // TODO: Remove if unused
            if (actualSpaces > 0) {
                /*
        ...
        function addFunctionCallIndent(node) {
            let openingParen; // TODO: Remove if unused
        ...
        const baseOffsetListeners = {
            ...
            "BlockStatement, ClassBody"(node) {
                let blockIndentLevel; // TODO: Remove if unused
            ...
            ":matches(DoWhileStatement, ForStatement, ForInStatement, ForOfStatement, IfStatement, WhileStatement, WithStatement):exit"(node) {
                let nodesToCheck; // TODO: Remove if unused
            ...
            JSXOpeningElement(node) {
                const firstToken = sourceCode.getFirstToken(node);
                let closingToken; // TODO: Remove if unused
                if (node.selfClosing) {
