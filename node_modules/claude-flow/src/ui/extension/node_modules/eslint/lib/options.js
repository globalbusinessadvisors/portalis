...
module.exports = function(usingFlatConfig) {
    let lookupFlag; // TODO: Remove if unused
    if (usingFlatConfig) {
        lookupFlag = {
    ...
    let envFlag; // TODO: Remove if unused
    if (!usingFlatConfig) {
        envFlag = {
            option: "env",
            type: "[String]",
    ...
    let extFlag; // TODO: Remove if unused
    if (!usingFlatConfig) {
        extFlag = {
            option: "ext",
            type: "[String]",
    ...
    let resolvePluginsFlag; // TODO: Remove if unused
    if (!usingFlatConfig) {
        resolvePluginsFlag = {
    ...
    let rulesDirFlag; // TODO: Remove if unused
    if (!usingFlatConfig) {
        rulesDirFlag = {
            option: "rulesdir",
            type: "[path::String]",
    ...
    let ignorePathFlag; // TODO: Remove if unused
    if (!usingFlatConfig) {
        ignorePathFlag = {
            option: "ignore-path",
            type: "path::String",
    ...
    let warnIgnoredFlag; // TODO: Remove if unused
    if (usingFlatConfig) {
        warnIgnoredFlag = {
            option: "warn-ignored",
            type: "Boolean",
