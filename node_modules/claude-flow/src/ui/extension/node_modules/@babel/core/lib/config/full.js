...
var _default = exports.default = _gensync()(function* loadFullConfig(inputOpts) {
  ...
  const ignored = yield* enhanceError(_context, function* recursePresetDescriptors(rawPresets, pluginDescriptorsPass) {
    const presets = [];
  ...
  yield* enhanceError(_context, function* loadPluginDescriptors() {
...
function enhanceError(_context, fn) {
...
function* loadPluginDescriptor(descriptor, _context) {
...
const validatePreset = (preset, _context, descriptor) => {
  if (!context.filename) {
...
function* loadPresetDescriptor(descriptor, _context) {
