...
function addCompletionRecords(path, records, _context) {
  if (path) {
    records.push(..._getCompletionRecords(path, context));
  }
  return records;
}
function completionRecordForSwitch(cases, records, _context) {
...
function getStatementListCompletion(paths, _context) {
  const completions = [];
...
function _getCompletionRecords(path, _context) {
  let records = [];
...
function get(key, _context = true) {
...
function _getPattern(parts, _context) {
  let path = this;
