...
let scopeVisitor; // TODO: Remove if unused
let uid = 0;
class Scope {
  constructor(path) {
    this.uid = void 0;
  ...
  get parent() {
    var _parent;
    let parent, // TODO: Remove if unused
      path = this.path;
    do {
      var _path;
  ...
  getBinding(name) {
    let scope = this;
    let previousPath; // TODO: Remove if unused
    do {
  ...
  hasBinding(name, opts) {
    ...
    let noGlobals; // TODO: Remove if unused
    let noUids; // TODO: Remove if unused
    let upToScope; // TODO: Remove if unused
  ...
  hoistVariables(emit = id => this.push({
    ...
    for (const name of Object.keys(this.bindings)) {
      ...
      let firstId; // TODO: Remove if unused
      const init = [];
...
Scope.contextVariables = ["arguments", "undefined", "Infinity", "NaN"];
{
  ...
  Scope.prototype.toArray = function toArray(node, i, arrayLikeIsIterable) {
    ...
    let helperName; // TODO: Remove if unused
    const args = [node];
    if (i === true) {
