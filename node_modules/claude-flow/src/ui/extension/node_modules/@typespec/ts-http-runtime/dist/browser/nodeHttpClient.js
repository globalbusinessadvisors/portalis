...
class ReportTransform extends Transform {
    ...
    _transform(chunk, _encoding, _callback) {
        this.push(chunk);
...
class NodeHttpClient {
    ...
    async sendRequest(request) {
        ...
        let abortListener; // TODO: Remove if unused
        if (request.abortSignal) {
            if (request.abortSignal.aborted) {
                throw new AbortError("The operation was aborted. Request has already been canceled.");
            }
            abortListener = (_event) => {
                if (event.type === "abort") {
        ...
        let timeoutId; // TODO: Remove if unused
        ...
        let responseStream; // TODO: Remove if unused
        try {
            ...
            responseStream = shouldDecompress ? getDecodedResponseStream(_res, headers) : res;
...
function getResponseHeaders(_res) {
