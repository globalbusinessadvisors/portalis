...
declare module 'highlight.js' {
    ...
    interface PublicApi {
constructor(code: string, options: HighlightOptions): HighlightResult
        /** @deprecated use `higlight(code, {lang: ..., ignoreIllegals: ...})` */
constructor(languageName: string, code: string, ignoreIllegals?: boolean): HighlightResult
    ...
    export type HLJSPlugin = {
        ...
        'before:highlight'?: (_context: BeforeHighlightContext) => void,
...
constructor(): string
constructor(): void
constructor(emitter: Emitter, subLanguageName: string): void
    }
    ...
    const hljs : HLJSApi; // TODO: Remove if unused
    export default hljs;
}
declare module 'highlight.js/lib/languages/*' {
    import { LanguageFn } from "highlight.js";
    const defineLanguage: LanguageFn; // TODO: Remove if unused
