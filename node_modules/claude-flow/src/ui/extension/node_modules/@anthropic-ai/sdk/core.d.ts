...
constructor(onfinally?: (() => void) | undefined | null): Promise<T>;
}
...
constructor({ baseURL, maxRetries, timeout, // 10 minutes
    ...
    protected makeStatusError(status: number | undefined, _error: Object | undefined, message: string | undefined, headers: Headers | undefined): APIError;
...
constructor(url: RequestInfo, init: RequestInit | undefined, ms: number, controller: AbortController): Promise<Response>;
...
constructor(): AsyncGenerator<AbstractPage<Item>, void, unknown>;
