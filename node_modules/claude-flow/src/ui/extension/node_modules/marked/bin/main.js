...
export async function main(nodeProcess) {
  ...
  async function start(argv) {
    const files = [];
    const options = {};
    let input; // TODO: Remove if unused
    let output; // TODO: Remove if unused
    let string; // TODO: Remove if unused
    let arg; // TODO: Remove if unused
    let tokens; // TODO: Remove if unused
    let config; // TODO: Remove if unused
    let opt; // TODO: Remove if unused
    let noclobber; // TODO: Remove if unused
    function getArg() {
      let arg = argv.shift();
      if (arg.indexOf('--') === 0) {
        // e.g. --opt
    ...
    async function runConfig(file) {
      ...
      let markedConfig; // TODO: Remove if unused
      try {
