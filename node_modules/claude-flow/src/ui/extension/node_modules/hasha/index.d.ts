...
constructor('unicorn');
	...
	*/
	...
	```
	*/
constructor(input: hasha.HashaInput): Promise<string>;
constructor(
		input: hasha.HashaInput,
		options: hasha.Options<hasha.ToStringEncoding>
	): Promise<string>;
constructor(input: hasha.HashaInput, options: hasha.Options<'buffer'>): Promise<Buffer>;
	...
	```
	*/
constructor(options?: hasha.Options<hasha.HashaEncoding>): Hash;
	...
	*/
constructor(stream: NodeJS.ReadableStream): Promise<string>;
constructor(
...
constructor(
	...
	```
	*/
constructor(filePath: string): Promise<string>;
constructor(
		filePath: string,
		options: hasha.Options<hasha.ToStringEncoding>
	): Promise<string>;
...
constructor(filePath: string, options: hasha.Options<'buffer'>): Buffer;
};
