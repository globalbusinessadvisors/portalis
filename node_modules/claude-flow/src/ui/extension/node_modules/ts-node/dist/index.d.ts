...
import type { TSCommon } from './ts-compiler-types.js';
import type { createEsmHooks as createEsmHooksFn } from './esm.js';
export { TSCommon };
export { createRepl, CreateReplOptions, ReplService, EvalAwarePartialHost, } from './repl.js';
export type { TranspilerModule, TranspilerFactory, CreateTranspilerOptions, TranspileOutput, TranspileOptions, Transpiler, } from './transpilers/types.js';
export type { NodeLoaderHooksAPI1, NodeLoaderHooksAPI2, NodeLoaderHooksFormat, } from './esm.js';
/**
...
constructor(enabled?: boolean): boolean;
constructor(fileName: string): boolean;
constructor(code: string, fileName: string, lineOffset?: number): string;
constructor(code: string, fileName: string, position: number): TypeInfo;
}
/**
