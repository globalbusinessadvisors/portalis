...
import type { TSError } from './node-utils.js';
import type { ParserWeakMap, ParserWeakMapESTreeToTSNode } from './parser-options.js';
import type { SemanticOrSyntacticError } from './semantic-or-syntactic-errors.js';
import { TSESTree, TSNode } from './ts-estree.js';
 ...
 */
export declare function convertError(_error: ts.DiagnosticWithLocation | SemanticOrSyntacticError): TSError;
