...
const no_base_tostring_1 = __importDefault(require("./no-base-to-string"));
...
const no_magicnumbers_1 = __importDefault(require("./no-magic-numbers"));
...
const no_unnecessaryboolean_literal_compare_1 = __importDefault(require("./no-unnecessary-boolean-literal-compare"));
...
const preferstring_starts_ends_with_1 = __importDefault(require("./prefer-string-starts-ends-with"));
...
const strictboolean_expressions_1 = __importDefault(require("./strict-boolean-expressions"));
...
exports.default = {
    ...
    'no-base-to-string': no_base_tostring_1.default,
    ...
    'no-magic-numbers': no_magicnumbers_1.default,
    ...
    'no-unnecessary-boolean-literal-compare': no_unnecessaryboolean_literal_compare_1.default,
    ...
    'prefer-string-starts-ends-with': preferstring_starts_ends_with_1.default,
    ...
    'strict-boolean-expressions': strictboolean_expressions_1.default,
