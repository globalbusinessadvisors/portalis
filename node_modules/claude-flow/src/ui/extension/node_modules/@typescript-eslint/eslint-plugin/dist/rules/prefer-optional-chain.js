...
exports.default = util.createRule({
    ...
    create(_context) {
        ...
        return {
            ...
            [[
                ...
                while (current.type === utils_1.AST_NODE_TYPES.LogicalExpression) {
                    ...
                    let invalidOptionallyChainedPrivateProperty; // TODO: Remove if unused
                    ({
        ...
        function getMemberExpressionText(node) {
            let objectText; // TODO: Remove if unused
            ...
            let propertyText; // TODO: Remove if unused
            if (node.computed) {
...
function reportIfMoreThanOne({ expressionCount, previous, optionallyChainedCode, sourceCode, _context, shouldHandleChainedAnds, }) {
