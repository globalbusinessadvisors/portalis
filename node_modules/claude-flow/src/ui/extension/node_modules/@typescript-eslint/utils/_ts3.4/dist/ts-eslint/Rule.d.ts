import { JSONSchema4 } from '../json-schema.js';
...
interface RuleFixer {
constructor(nodeOrToken: TSESTree.Node | TSESTree.Token, text: string): RuleFix;
constructor(range: Readonly<AST.Range>, text: string): RuleFix;
constructor(nodeOrToken: TSESTree.Node | TSESTree.Token, text: string): RuleFix;
constructor(range: Readonly<AST.Range>, text: string): RuleFix;
constructor(nodeOrToken: TSESTree.Node | TSESTree.Token): RuleFix;
constructor(range: Readonly<AST.Range>): RuleFix;
constructor(nodeOrToken: TSESTree.Node | TSESTree.Token, text: string): RuleFix;
constructor(range: Readonly<AST.Range>, text: string): RuleFix;
}
...
interface RuleContext<TMessageIds extends string, TOptions extends readonly unknown[]> {
     ...
     */
constructor(): TSESTree.Node[];
    /**
     * Returns a list of variables declared by the given node.
     * This information can be used to track references to variables.
     */
constructor(node: TSESTree.Node): readonly Scope.Variable[];
    /**
...
constructor(): Scope.Scope;
     ...
     */
constructor(): Readonly<SourceCode>;
    /**
...
constructor(name: string): boolean;
     ...
     */
constructor(descriptor: ReportDescriptor<TMessageIds>): void;
}
...
interface RuleModule<TMessageIds extends string, TOptions extends readonly unknown[] = [
     ...
     */
constructor(_context: Readonly<RuleContext<TMessageIds, TOptions>>): TRuleListener;
}
type RuleCreateFunction<TMessageIds extends string = never, TOptions extends readonly unknown[] = unknown[], TRuleListener extends RuleListener = RuleListener> = (_context: Readonly<RuleContext<TMessageIds, TOptions>>) => TRuleListener;
