...
import type { ReferenceImplicitGlobal } from '../referencer/Reference.js';
import { Reference, ReferenceFlag } from '../referencer/Reference.js';
...
import { TSModuleScope } from './TSModuleScope.js';
...
constructor(scopeManager: ScopeManager): Scope | null;
    /**
...
constructor(node: TSESTree.Identifier, def: Definition): void;
constructor(node: TSESTree.StringLiteral, def: Definition): void;
constructor(node: TSESTree.Identifier | TSESTree.JSXIdentifier, assign?: ReferenceFlag, writeExpr?: TSESTree.Expression | null, maybeImplicitGlobal?: ReferenceImplicitGlobal | null, init?: boolean): void;
