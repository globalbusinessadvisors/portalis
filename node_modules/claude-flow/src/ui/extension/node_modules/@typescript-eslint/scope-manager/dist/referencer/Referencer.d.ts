...
import type { ReferenceImplicitGlobal } from './Reference.js';
import type { VisitorOptions } from './Visitor.js';
...
constructor(): Scope;
constructor(throwOnNull: true): Scope | null;
constructor(node: TSESTree.Node): void;
constructor(pattern: TSESTree.Identifier, assignments: (TSESTree.AssignmentExpression | TSESTree.AssignmentPattern)[], maybeImplicitGlobal: ReferenceImplicitGlobal | null, init: boolean): void;
