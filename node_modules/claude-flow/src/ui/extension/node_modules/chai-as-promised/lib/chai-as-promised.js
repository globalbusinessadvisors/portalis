...
export default function (chai, utils) {
  ...
  originalAssertMethods.forEach((assertMethodName) => {
    assert.eventually[assertMethodName] = function (promise) {
      ...
      let customRejectionHandler; // TODO: Remove if unused
...
let customTransferPromiseness; // TODO: Remove if unused
let customTransformAsserterArgs; // TODO: Remove if unused
