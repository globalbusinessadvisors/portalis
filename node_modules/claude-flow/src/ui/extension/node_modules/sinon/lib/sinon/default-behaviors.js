...
function throwsException(fake, _error, message) {
...
const defaultBehaviors = {
    ...
    callsArgOn: function callsArgOn(fake, index, _context) {
        if (typeof index !== "number") {
            throw new TypeError("argument index is not number");
        }
        fake.callArgAt = index;
    ...
    callsArgOnWith: function callsArgWith(fake, index, _context) {
        if (typeof index !== "number") {
            throw new TypeError("argument index is not number");
        }
        fake.callArgAt = index;
    ...
    yieldsOn: function (fake, _context) {
        fake.callArgAt = useLeftMostCallback;
        fake.callbackArguments = slice(arguments, 2);
        fake.callbackContext = context;
        fake.callArgProp = undefined;
    ...
    yieldsToOn: function (fake, prop, _context) {
        fake.callArgAt = useLeftMostCallback;
        fake.callbackArguments = slice(arguments, 3);
        fake.callbackContext = context;
        fake.callArgProp = prop;
    ...
    rejects: function rejects(fake, _error, message) {
        let reason; // TODO: Remove if unused
