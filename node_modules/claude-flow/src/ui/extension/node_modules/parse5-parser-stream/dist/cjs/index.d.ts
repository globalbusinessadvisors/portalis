...
constructor(chunk: string, _encoding: string, _callback: () => void): void;
constructor(chunk?: any, encoding?: any, callback?: any): any;
}
export interface ParserStream<T extends TreeAdapterTypeMap = DefaultTreeAdapterMap> {
     ...
     * @param handler
     */
constructor(_event: 'script', handler: (scriptElement: T['element'], documentWrite: (html: string) => void, resume: () => void) => void): void;
    /**
     * Base event handler.
     *
     * @param event Name of the event
     ...
     */
constructor(_event: string, handler: (...args: any[]) => void): this;
}
