...
constructor(key: CacheKey): GetResult | Promise<GetResult | undefined> | undefined

constructor(key: CacheKey, val: CacheValue): Writable | undefined

constructor(key: CacheKey): void | Promise<void>
  }
