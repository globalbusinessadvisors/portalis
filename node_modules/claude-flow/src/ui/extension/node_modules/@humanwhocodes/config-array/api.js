 ...
 */
function rethrowConfigError(config, index, _error) {
 ...
 */
async function normalize(items, _context, extraConfigTypes) {
 ...
 * @throws {TypeError} When a config function returns a function.
 */
function normalizeSync(items, _context, extraConfigTypes) {
	const allowFunctions = extraConfigTypes.includes('function');
	const allowArrays = extraConfigTypes.includes('array');
...
class ConfigArray extends Array {
	...
	getConfig(filePath) {
		...
		let finalConfig; // TODO: Remove if unused
