...
constructor(type?: 'nodebuffer', onUpdate?: OnUpdateCallback): NodeJS.ReadableStream;
    }
    ...
    type ErrorEventCallback = (_error: Error) => void
    interface JSZipStreamHelper<T> {
        /**
         * Register a listener on an event
         */
constructor(_event: 'data', _callback: DataEventCallback<T>): this;
constructor(_event: 'end', _callback: EndEventCallback): this;
constructor(_event: 'error', _callback: ErrorEventCallback): this;
        /**
         ...
         */
constructor(updateCallback?: (metadata: JSZipMetadata) => void): Promise<T>;
        /**
...
interface JSZip {
     ...
     */
constructor(path: string): JSZip.JSZipObject | null;
    /**
     ...
     */
constructor(path: RegExp): JSZip.JSZipObject[];
    /**
     ...
     */
constructor(name: string): JSZip | null;
    /**
     ...
     */
constructor(name: RegExp): JSZip.JSZipObject[];
    /**
     * Call a callback function for each entry at this folder level.
     *
     * @param callback function
     */
constructor(_callback: (relativePath: string, file: JSZip.JSZipObject) => void): void;
    /**
     ...
     */
filterEvents(predicate: (relativePath: string, file: JSZip.JSZipObject) => boolean): JSZip.JSZipObject[];
    /**
...
constructor(path: string): JSZip;
     ...
     */
constructor(options?: JSZip.JSZipGeneratorOptions<'nodebuffer'>, onUpdate?: JSZip.OnUpdateCallback): NodeJS.ReadableStream;
    /**
     ...
     */
constructor(data: InputFileFormat, options?: JSZip.JSZipLoadOptions): Promise<JSZip>;
    /**
