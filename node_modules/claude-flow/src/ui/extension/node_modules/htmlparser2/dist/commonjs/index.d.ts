 ...
 */
export declare function createDocumentStream(_callback: (error: Error | null, document: Document) => void, options?: Options, elementCallback?: (element: Element) => void): Parser;
/**
 * Creates a parser instance, with an attached DOM handler.
 *
 ...
 */
export declare function createDomStream(_callback: (error: Error | null, dom: ChildNode[]) => void, options?: Options, elementCallback?: (element: Element) => void): Parser;
