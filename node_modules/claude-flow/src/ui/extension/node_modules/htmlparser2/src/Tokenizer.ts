...
const enum CharCodes { // TODO: Remove if unused
    Tab = 0x9, // "\t"
    NewLine = 0xa, // "\n"
    FormFeed = 0xc, // "\f"
...
const enum State { // TODO: Remove if unused
    Text = 1,
    BeforeTagName, // After <
    InTagName,
    InSelfClosingTag,
...
constructor(codepoint: number): void;
constructor(quote: QuoteType, endIndex: number): void;
constructor(start: number, endIndex: number): void;
constructor(start: number, endIndex: number, endOffset: number): void;
constructor(start: number, endIndex: number): void;
constructor(start: number, endIndex: number, endOffset: number): void;
constructor(start: number, endIndex: number): void;
constructor(): void;
...
constructor(endIndex: number): void;
constructor(start: number, endIndex: number): void;
constructor(codepoint: number, endIndex: number): void;
}
/**
