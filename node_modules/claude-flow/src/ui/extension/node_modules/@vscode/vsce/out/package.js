...
class ManifestProcessor extends BaseProcessor {
    constructor(manifest, options = {}) {
        ...
        let enableMarketplaceQnA; // TODO: Remove if unused
        let customerQnALink; // TODO: Remove if unused
        ...
        if (target || preRelease) {
            let engineVersion; // TODO: Remove if unused
            try {
    ...
    async onFile(file) {
        ...
        if (this.rewriteRelativeLinks) {
            ...
            if ((this.gitHubIssueLinking && this.isGitHub) || (this.gitLabIssueLinking && this.isGitLab)) {
                ...
                const issueReplace = (all, prefix, ownerAndRepositoryName, issueNumber) => {
                    let result = all;
                    let owner; // TODO: Remove if unused
                    let repositoryName; // TODO: Remove if unused
        ...
        if (this.rewriteRelativeLinks) {
            $('img').each((_, img) => {
                ...
                let srcUrl; // TODO: Remove if unused
                try {
...
function validateManifest(manifest) {
    ...
    let parsedEngineVersion; // TODO: Remove if unused
    try {
