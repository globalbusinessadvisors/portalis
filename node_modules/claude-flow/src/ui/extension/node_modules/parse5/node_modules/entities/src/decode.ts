...
const enum EntityDecoderState { // TODO: Remove if unused
    EntityStart,
    NumericStart,
    NumericDecimal,
    NumericHex,
...
constructor(decodeMode: DecodingMode): void {
     ...
     */
constructor(input: string, offset: number): number {
        switch (this.state) {
