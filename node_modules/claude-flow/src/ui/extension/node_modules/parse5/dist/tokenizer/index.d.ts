...
constructor(token: CommentToken): void;
constructor(token: DoctypeToken): void;
constructor(token: TagToken): void;
constructor(token: TagToken): void;
constructor(token: EOFToken): void;
constructor(token: CharacterToken): void;
constructor(token: CharacterToken): void;
constructor(token: CharacterToken): void;
...
constructor(): void;
constructor(writeCallback?: () => void): void;
constructor(chunk: string, isLastChunk: boolean, writeCallback?: () => void): void;
constructor(chunk: string): void;
