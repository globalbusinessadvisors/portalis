...
export interface TreeAdapter<T extends TreeAdapterTypeMap = TreeAdapterTypeMap> {
     ...
     */
constructor(recipient: T['element'], attrs: Attribute[]): void;
    /**
     ...
     */
constructor(parentNode: T['parentNode'], newNode: T['childNode']): void;
    /**
     * Creates a comment node.
     *
     * @param data - Comment text.
     */
constructor(data: string): T['commentNode'];
    /**
     * Creates a text node.
     *
     * @param value - Text.
     */
constructor(value: string): T['textNode'];
    /**
...
constructor(): T['document'];
     ...
     */
constructor(): T['documentFragment'];
    /**
     ...
     */
constructor(tagName: string, namespaceURI: NS, attrs: Attribute[]): T['element'];
    /**
     * Removes a node from its parent.
     *
     * @param node - Node to remove.
     */
constructor(node: T['childNode']): void;
    /**
     ...
     */
constructor(element: T['element']): Attribute[];
    /**
     * Returns the given node's children in an array.
     *
     * @param node - Node.
     */
constructor(node: T['parentNode']): T['childNode'][];
    /**
     * Returns the given comment node's content.
     *
     * @param commentNode - Comment node.
     */
constructor(commentNode: T['commentNode']): string;
    /**
     * Returns [document mode](https://dom.spec.whatwg.org/#concept-document-limited-quirks).
     *
     * @param document - Document node.
     */
constructor(document: T['document']): DOCUMENT_MODE;
    /**
     * Returns the given document type node's name.
     *
     * @param doctypeNode - Document type node.
     */
constructor(doctypeNode: T['documentType']): string;
    /**
...
constructor(doctypeNode: T['documentType']): string;
     ...
     * @param node - Node.
     */
constructor(node: T['parentNode']): T['childNode'] | null;
    /**
     * Returns the given element's namespace.
     *
     * @param element - Element.
     */
constructor(element: T['element']): NS;
    /**
     * Returns the given node's source code location information.
     *
     * @param node - Node.
     */
constructor(node: T['node']): ElementLocation | undefined | null;
    /**
     * Returns the given node's parent.
     *
     * @param node - Node.
     */
constructor(node: T['node']): T['parentNode'] | null;
    /**
     * Returns the given element's tag name.
     *
     * @param element - Element.
     */
constructor(element: T['element']): string;
    /**
     * Returns the given text node's content.
     *
     * @param textNode - Text node.
     */
constructor(textNode: T['textNode']): string;
    /**
     * Returns the `<template>` element content element.
     *
     * @param templateElement - `<template>` element.
     */
constructor(templateElement: T['template']): T['documentFragment'];
    /**
     ...
     */
constructor(parentNode: T['parentNode'], newNode: T['childNode'], referenceNode: T['childNode']): void;
    /**
     ...
     */
constructor(parentNode: T['parentNode'], text: string): void;
    /**
     ...
     */
constructor(parentNode: T['parentNode'], text: string, referenceNode: T['childNode']): void;
    /**
     * Determines if the given node is a comment node.
     *
     * @param node - Node.
     */
constructor(node: T['node']): node is T['commentNode'];
    /**
     * Determines if the given node is a document type node.
     *
     * @param node - Node.
     */
constructor(node: T['node']): node is T['documentType'];
    /**
     * Determines if the given node is an element.
     *
     * @param node - Node.
     */
constructor(node: T['node']): node is T['element'];
    /**
     * Determines if the given node is a text node.
     *
     * @param node - Node.
     */
constructor(node: T['node']): node is T['textNode'];
    /**
     ...
     */
constructor(document: T['document'], mode: DOCUMENT_MODE): void;
    /**
     ...
     */
constructor(document: T['document'], name: string, publicId: string, systemId: string): void;
    /**
     * Attaches source code location information to the node.
     *
     * @param node - Node.
     */
constructor(node: T['node'], location: ElementLocation | null): void;
    /**
     * Updates the source code location information of the node.
     *
     * @param node - Node.
     */
constructor(node: T['node'], location: Partial<ElementLocation>): void;
    /**
     ...
     */
constructor(templateElement: T['template'], contentElement: T['documentFragment']): void;
    /**
