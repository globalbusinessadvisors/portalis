...
constructor(dataObject: any): void;
constructor(message: string, data?: string): void;
}
...
export interface IdCancellationReceiverStrategy {
     ...
     */
constructor(id: CancellationId): AbstractCancellationTokenSource;
    /**
...
export interface RequestCancellationReceiverStrategy {
     ...
     */
constructor(requestMessage: RequestMessage): AbstractCancellationTokenSource;
    /**
     * An optional method to dispose the strategy.
     */
    dispose?(): void;
...
export interface CancellationSenderStrategy {
     ...
     * @param id The cancellation id.
     */
constructor(conn: MessageConnection, id: CancellationId): Promise<void>;
    /**
     ...
     * @param id The cancellation id.
     */
constructor(id: CancellationId): void;
    /**
     * An optional method to dispose the strategy.
     */
    dispose?(): void;
...
constructor(message: Message, next: (message: Message) => void): void;
}
...
constructor(handler: StarRequestHandler): Disposable;
constructor(): boolean;
constructor(type: NotificationType0): Promise<void>;
...
constructor(method: string, r0?: ParameterStructures | any, ...rest: any[]): Promise<void>;
constructor(type: NotificationType0, handler: NotificationHandler0): Disposable;
...
constructor(method: string, handler: GenericNotificationHandler): Disposable;
constructor(handler: StarNotificationHandler): Disposable;
    onUnhandledNotification: Event<NotificationMessage>;
    onProgress<P>(type: ProgressType<P>, token: string | number, handler: NotificationHandler<P>): Disposable;
    sendProgress<P>(type: ProgressType<P>, token: string | number, value: P): Promise<void>;
    onUnhandledProgress: Event<ProgressParams<any>>;
constructor(value: Trace, tracer: Tracer, sendNotification?: boolean): Promise<void>;
constructor(value: Trace, tracer: Tracer, traceOptions?: TraceOptions): Promise<void>;
