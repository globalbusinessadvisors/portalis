...
function fill(str, width, right, tabs) {
    ...
    if (remaining > 0) {
        ...
        let fillStr; // TODO: Remove if unused
        if (remaining >= strlen) {
...
function nodeMissing(node) {
    ...
    let coveredLines; // TODO: Remove if unused
...
function findWidth(node, _context, nodeExtractor, depthFor = nullDepthFor) {
    let last = 0;
