import * as fastq from '../.js'
import { promise as queueAsPromised } from '../.js'

// Basic example

const queue = fastq(worker, 1)

(queue as any[]).push('world', (err, result) => {
  if (err) throw err
  console.log('the result is', result)
})

(queue as any[]).push('push without cb')
...
(genericsQueue as any[]).push(7, (err, done) => {
  if (err) throw err
...
constructor(null, 'the meaning of life is ' + (this.base * task))
}
