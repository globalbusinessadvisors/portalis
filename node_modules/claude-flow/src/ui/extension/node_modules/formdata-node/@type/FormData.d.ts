...
constructor(entries?: FormDataConstructorEntries);
     ...
     */
constructor(name: string, value: unknown, fileName?: string): void;
    /**
...
constructor(): Generator<string>;
     ...
     */
constructor(): Generator<[string, FormDataEntryValue]>;
    /**
     * Returns an [`iterator`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols) allowing to go through all values contained in this object `FormData` object.
     * Each value is a [`FormDataValue`](https://developer.mozilla.org/en-US/docs/Web/API/FormDataEntryValue).
     */
constructor(): Generator<FormDataEntryValue>;
    /**
     ...
     */
constructor(_callback: (value: FormDataEntryValue, key: string, form: FormData) => void, thisArg?: unknown): void;
