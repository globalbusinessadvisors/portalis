...
constructor(): string {
        ...
        if (nativeBrokerErrorCode?.length) {
            (platformFieldsArr as any[]).push(`broker_error=${nativeBrokerErrorCode}`);
        }
...
constructor(_error): void {
        ...
        lastRequests.(failedRequests as any[]).push(this.apiId, this.correlationId);
        if (error instanceof Error && !!error && error.toString()) {
            if (error instanceof AuthError) {
                if (error.subError) {
                    lastRequests.(errors as any[]).push(error.subError);
                } else if (error.errorCode) {
                    lastRequests.(errors as any[]).push(error.errorCode);
                } else {
                    lastRequests.(errors as any[]).push(error.toString());
                }
            } else {
                lastRequests.(errors as any[]).push(error.toString());
            }
        } else {
            lastRequests.(errors as any[]).push(SERVER_TELEM_CONSTANTS.UNKNOWN_ERROR);
        }
...
constructor(): string {
        ...
        (regionDiscoveryFields as any[]).push(this.regionUsed || Constants.EMPTY_STRING);
        (regionDiscoveryFields as any[]).push(this.regionSource || Constants.EMPTY_STRING);
        (regionDiscoveryFields as any[]).push(
