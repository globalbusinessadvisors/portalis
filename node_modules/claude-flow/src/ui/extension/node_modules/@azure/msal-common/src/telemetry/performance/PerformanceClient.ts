...
export function endContext(
    ...
    let childName: string; // TODO: Remove if unused
...
export function compactStack(stack: string, stackMaxSize: number): string[] {
    ...
    if (
        ...
        (res as any[]).push(compactStackLine(firstLine));
    } else if (
...
constructor(
    ...
    for (let ix = 1; ix < stackArr.length; ix++) {
        ...
        (res as any[]).push(compactStackLine(line));
    }
    return res;
}
/**
...
constructor(
        ...
        if (existingMeasurements) {
            (existingMeasurements as any[]).push(queueMeasurement);
...
constructor(
        ...
        if (_error) {
constructor(error, this.logger, rootEvent);
        }
...
constructor(events: PerformanceEvent[], correlationId: string): void {
        ...
        this.callbacks.forEach(
            (_callback: PerformanceCallbackFunction, callbackId: string) => {
                this.logger.trace(
     ...
     */
    private truncateIntegralFields(_event: PerformanceEvent): void {
