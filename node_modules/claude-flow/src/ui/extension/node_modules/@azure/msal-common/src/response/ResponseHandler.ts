...
constructor(
        ...
        let idTokenClaims: TokenClaims | undefined; // TODO: Remove if unused
...
constructor(authTime, request.maxAge);
            }
        }
        ...
        let requestStateObj: RequestStateObject | undefined; // TODO: Remove if unused
        ...
        let cacheContext; // TODO: Remove if unused
        try {
    ...
    private generateCacheRecord(
        ...
        let cachedIdToken: IdTokenEntity | undefined; // TODO: Remove if unused
        let cachedAccount: AccountEntity | undefined; // TODO: Remove if unused
        ...
        if (serverTokenResponse.refresh_token) {
            let rtExpiresOn: number | undefined; // TODO: Remove if unused
    ...
    static async generateAuthenticationResult(
        ...
        let extExpiresOn: Date | undefined; // TODO: Remove if unused
        let refreshOn: Date | undefined; // TODO: Remove if unused
...
export function buildAccountToCache(
    ...
    if (
        ...
        (tenantProfiles as any[]).push(newTenantProfile);
    }
