...
constructor(
    ...
    private async getCloudDiscoveryMetadataFromNetwork(): Promise<CloudDiscoveryMetadata | null> {
        ...
        try {
            ...
            let typedResponseBody: // TODO: Remove if unused
                | CloudInstanceDiscoveryResponse
                | CloudInstanceDiscoveryErrorResponse;
            let metadata: Array<CloudDiscoveryMetadata>; // TODO: Remove if unused
    ...
    static generateAuthority(
        ...
        let authorityAzureCloudInstance; // TODO: Remove if unused
        if (
            azureCloudOptions &&
