 ...
 */
export declare function startContext(_event: PerformanceEvent, abbreviations: Map<string, string>, stack?: PerformanceEventStackedContext[]): void;
/**
 ...
 */
export declare function endContext(_event: PerformanceEvent, abbreviations: Map<string, string>, stack?: PerformanceEventStackedContext[], error?: unknown): PerformanceEventContext | undefined;
/**
 ...
 */
export declare function addError(_error: unknown, logger: Logger, _event: PerformanceEvent, stackMaxSize?: number): void;
/**
...
constructor(clientId: string, authority: string, logger: Logger, libraryName: string, libraryVersion: string, applicationTelemetry: ApplicationTelemetry, intFields?: Set<string>, abbreviations?: Map<string, string>);
     ...
     */
constructor(measureName: string, // eslint-disable-line @typescript-eslint/no-unused-vars
     ...
     * @returns {number}
     */
constructor(eventName: string, correlationId: string): number | void;
    /**
...
constructor(measureName: string, correlationId?: string): InProgressPerformanceEvent;
     ...
     */
constructor(_event: PerformanceEvent, error?: unknown): PerformanceEvent | null;
    /**
...
constructor(fields: {
     ...
     * @param {PerformanceEvent} event
     */
    protected cacheEventByCorrelationId(_event: PerformanceEvent): void;
