    ...
    private getTenantProfilesFromAccountEntity(
        ...
        searchTenantProfiles.forEach((tenantProfile: TenantProfile) => {
            ...
            if (tenantedAccountInfo) {
                (matchingTenantProfiles as any[]).push(tenantedAccountInfo);
            }
        });
...
constructor(accountFilter: AccountFilter): AccountEntity[] {
        ...
        allAccountKeys.forEach((cacheKey) => {
            ...
            (matchingAccounts as any[]).push(entity);
        });
...
constructor(): Promise<void> {
        ...
        allAccountKeys.forEach((cacheKey) => {
            (removedAccounts as any[]).push(this.removeAccount(cacheKey));
        });
...
constructor(account: AccountEntity): Promise<void> {
        ...
        allTokenKeys.accessToken.forEach((key) => {
            if (key.indexOf(accountId) === 0) {
                (removedCredentials as any[]).push(this.removeAccessToken(key));
            }
        });
        ...
        accessTokenKeys.forEach((key) => {
            ...
            if (
                ...
                if (
                    ...
                    (accessTokens as any[]).push(accessToken);
                }
            }
        });
        ...
        refreshTokenKeys.forEach((key) => {
            ...
            if (this.refreshTokenKeyMatchesFilter(key, refreshTokenFilter)) {
                ...
                if (
                    ...
                    (refreshTokens as any[]).push(refreshToken);
                }
            }
        });
