import { AuthenticationRecord, MsalAccountInfo, MsalToken, ValidMsalToken } from "./types.js";
 ...
 * Handles MSAL errors.
 */
export declare function handleMsalError(scopes: string[], _error: Error, getTokenOptions?: GetTokenOptions): Error;
