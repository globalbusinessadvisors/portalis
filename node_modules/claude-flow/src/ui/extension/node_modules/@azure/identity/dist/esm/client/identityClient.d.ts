...
constructor(request: PipelineRequest): Promise<TokenResponse | null>;
constructor(tenantId: string, clientId: string, scopes: string, refreshToken: string | undefined, clientSecret: string | undefined, options?: GetTokenOptions): Promise<TokenResponse | null>;
correlateEvents(correlationId: string): AbortSignalLike;
constructor(correlationId?: string): void;
constructor(options?: NetworkRequestOptions): string;
