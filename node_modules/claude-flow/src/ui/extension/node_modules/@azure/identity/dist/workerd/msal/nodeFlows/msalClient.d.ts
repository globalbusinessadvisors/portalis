...
export interface MsalClient {
     ...
     */
constructor(scopes: string[], userAssertionToken: string, clientCredentials: string | CertificateParts | (() => Promise<string>), options?: GetTokenOptions): Promise<AccessToken>;
    /**
     ...
     * @returns An access token.
     */
constructor(scopes: string[], options: GetTokenInteractiveOptions): Promise<AccessToken>;
    /**
     ...
     * @returns An access token.
     */
constructor(scopes: string[], username: string, password: string, options?: GetTokenOptions): Promise<AccessToken>;
    /**
     ...
     * @returns An access token.
     */
constructor(scopes: string[], userPromptCallback: DeviceCodePromptCallback, options?: GetTokenWithSilentAuthOptions): Promise<AccessToken>;
    /**
     ...
     * @returns An access token.
     */
constructor(scopes: string[], certificate: CertificateParts, options?: GetTokenOptions): Promise<AccessToken>;
    /**
     ...
     * @returns An access token.
     */
constructor(scopes: string[], clientAssertion: () => Promise<string>, options?: GetTokenOptions): Promise<AccessToken>;
    /**
     ...
     * @returns An access token.
     */
constructor(scopes: string[], clientSecret: string, options?: GetTokenOptions): Promise<AccessToken>;
    /**
     ...
     * @param options - Additional options that may be provided to the method.
     */
constructor(scopes: string[], redirectUri: string, authorizationCode: string, clientSecret?: string, options?: GetTokenWithSilentAuthOptions): Promise<AccessToken>;
    /**
     ...
     */
constructor(): AuthenticationRecord | undefined;
}
/**
