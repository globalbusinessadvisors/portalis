...
export class PlatformAuthExtensionHandler implements IPlatformAuthHandler {
    ...
    private readonly windowListener: (_event: MessageEvent) => void;
...
constructor(
     ...
     * @param event
     */
    private onWindowMessage(_event: MessageEvent): void {
...
constructor(
     ...
     * @param event
     */
    private onChannelMessage(_event: MessageEvent): void {
        this.logger.trace(
...
constructor(this.timeoutId); // Clear setTimeout
                window.removeEventListener(
                    "message",
                    this.windowListener,
                    false
