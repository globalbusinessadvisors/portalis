...
constructor(
    ...
    private async handleRedirectPromiseInternal(
        ...
        let rootMeasurement: InProgressPerformanceEvent; // TODO: Remove if unused
        this.eventHandler.emitEvent(
            EventType.HANDLE_REDIRECT_START,
            InteractionType.Redirect
        );
        let redirectResponse: Promise<AuthenticationResult | null>; // TODO: Remove if unused
        try {
...
constructor(request: RedirectRequest): Promise<void> {
        ...
        try {
            ...
            let result: Promise<void>; // TODO: Remove if unused
            if (
                this.platformAuthProvider &&
...
constructor(this.initialized, atPopupMeasurement);
            this.browserStorage.setInteractionInProgress(
                true,
                INTERACTION_TYPE.SIGNIN
            );
        ...
        let result: Promise<AuthenticationResult>; // TODO: Remove if unused
...
constructor(this.initialized, this.ssoSilentMeasurement);
...
constructor(this.initialized, atbcMeasurement);
        this.eventHandler.emitEvent(
...
constructor(this.initialized, atsMeasurement);
...
constructor(
    ...
    private logMultipleInstances(
        ...
        // @ts-ignore
        window.msal.(clientIds as any[]).push(clientId);
constructor(clientId, performanceEvent, this.logger);
    }
}
/**
