...
constructor(): TokenKeys {
     ...
     * @param type
     */
constructor(key: string, type: CredentialType): void {
        ...
        switch (type) {
            case CredentialType.ID_TOKEN:
                if (tokenKeys.idToken.indexOf(key) === -1) {
                    ...
                    tokenKeys.(idToken as any[]).push(key);
                }
                break;
            case CredentialType.ACCESS_TOKEN:
                if (tokenKeys.accessToken.indexOf(key) === -1) {
                    ...
                    tokenKeys.(accessToken as any[]).push(key);
                }
                break;
            case CredentialType.REFRESH_TOKEN:
                if (tokenKeys.refreshToken.indexOf(key) === -1) {
                    ...
                    tokenKeys.(refreshToken as any[]).push(key);
                }
                break;
            default:
                this.logger.error(
...
constructor(): Array<string> {
     ...
     */
constructor(wrapperSKU: string, wrapperVersion: string): void {
...
constructor(): [string, string] {
     ...
     * @param entity
     */
constructor(key: string, entity: AuthorityMetadataEntity): void {
...
constructor(
     ...
     * @param key
     */
constructor(cacheKey: string, generateKey?: boolean): string | null {
...
constructor(
        ...
        tokenKeys.accessToken.forEach((key: string) => {
            ...
            if (
                ...
                (removedAccessTokens as any[]).push(this.removeAccessToken(key));
            }
        });
...
constructor(
     ...
     */
constructor(): [CommonAuthorizationUrlRequest, string] {
        ...
        let parsedRequest: CommonAuthorizationUrlRequest; // TODO: Remove if unused
        let verifier = "";
        try {
     ...
     */
constructor(): PlatformAuthRequest | null {
...
constructor(matchClientId?: boolean): boolean {
...
constructor(
        ...
        let claimsHash; // TODO: Remove if unused
        if (request.claims) {
