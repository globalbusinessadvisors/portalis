 ...
 * will be rethrown.
 */
async function trySendRequest(request, _next) {
    try {
...
function bearerTokenAuthenticationPolicy(options) {
    ...
    return {
         ...
         */
        async sendRequest(request, _next) {
            ...
            let response; // TODO: Remove if unused
            let error; // TODO: Remove if unused
            let shouldSendRequest; // TODO: Remove if unused
            [response, error] = await trySendRequest(request, next);
            if (isChallengeResponse(response)) {
                let claims = getCaeChallengeClaims(response.headers.get("WWW-Authenticate"));
                // Handle CAE by default when receive CAE claim
                if (claims) {
                    let parsedClaim; // TODO: Remove if unused
...
function parseChallenges(challenges) {
    ...
    while ((match = challengeRegex.exec(challenges)) !== null) {
        ...
        const params = {};
        let paramMatch; // TODO: Remove if unused
