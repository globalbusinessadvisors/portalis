...
class ParallelBufferedRunner extends Runner {
  ...
  _createFileRunner(pool, options) {
     ...
     */
    const emitEvent = (_event, failureCount) => {
    ...
    const linkEvent = event => {
      ...
      while (stack.length) {
        ...
        let newObj; // TODO: Remove if unused
  ...
  run(_callback, {files, options = {}} = {}) {
    ...
    (async () => {
       ...
       */
      let debugInterval; // TODO: Remove if unused
      /**
       * @type {BufferedWorkerPool}
       */
      let pool; // TODO: Remove if unused
      try {
