...
constructor(obj: any): boolean;
         ...
         * @param args
         */
constructor(...args: MatchPartialArguments<TArgs>): boolean;
        /**
         * Returns true if spy was called at least once with the provided arguments and no others.
         */
constructor(...args: MatchExactArguments<TArgs>): boolean;
        /**
...
constructor(...args: MatchPartialArguments<TArgs>): boolean;
         ...
         * @param value
         */
constructor(value: TReturnValue | SinonMatcher): boolean;
        /**
...
constructor(): boolean;
         ...
         */
constructor(type: string): boolean;
        /**
...
constructor(obj: any): boolean;
         ...
         * @param pos
         */
constructor(pos: number): unknown[];
constructor(pos: number, obj: any, ...args: any[]): unknown[];
        /**
         * Like callArg, but with arguments.
         */
constructor(pos: number, ...args: any[]): unknown[];
constructor(pos: number, obj: any, ...args: any[]): unknown[];
        /**
...
constructor(obj: any, ...args: any[]): unknown[];
        /**
         ...
         */
constructor(property: string, ...args: any[]): unknown[];
constructor(property: string, obj: any, ...args: any[]): unknown[];
    }
        ...
        extends SinonSpyCallApi<TArgs, TReturnValue>
    {
         ...
         * @param call
         */
constructor(call: SinonSpyCall<any>): boolean;
        /**
...
constructor(call: SinonSpyCall<any>): boolean;
        ...
        >
    {
         ...
         * @param anotherSpy
         */
constructor(anotherSpy: SinonSpy<any>): boolean;
        /**
...
constructor(anotherSpy: SinonSpy<any>): boolean;
         ...
         */
constructor(...args: MatchPartialArguments<TArgs>): SinonSpy<TArgs, TReturnValue>;
        /**
...
constructor(obj: any): boolean;
         ...
         * Returns an Array with all callbacks return values in the order they were called, if no error is thrown.
         */
constructor(...args: TArgs): void;
        /**
         * Set the displayName of the spy or stub.
         * @param name
         */
constructor(name: string): SinonSpy<TArgs, TReturnValue>;
        /**
         * Returns the nth call.
         * Accessing individual calls helps with more detailed behavior verification when the spy is called more than once.
         * @param n Zero-based index of the spy call.
         */
constructor(n: number): SinonSpyCall<TArgs, TReturnValue>;
        /**
         * Returns an Array of all calls recorded by the spy.
         */
constructor(): Array<SinonSpyCall<TArgs, TReturnValue>>;
        /**
...
constructor(): void;
         ...
         * @param args
         */
constructor(format: string, ...args: any[]): string;
        /**
...
constructor(): void;
         ...
         */
constructor(promiseLibrary: any): SinonStub<TArgs, TReturnValue>;
        /**
         * Makes the stub return the provided @param obj value.
         * @param obj
         */
constructor(obj: TReturnValue): SinonStub<TArgs, TReturnValue>;
        /**
         ...
         * @param index
         */
constructor(index: number): SinonStub<TArgs, TReturnValue>;
        /**
         * Causes the stub to return its this value.
         * Useful for stubbing jQuery-style fluent APIs.
         */
constructor(): SinonStub<TArgs, TReturnValue>;
        /**
...
constructor(): SinonStub<TArgs, TReturnValue>;
         ...
         * @param type
         */
constructor(type?: string): SinonStub<TArgs, TReturnValue>;
        /**
         * Causes the stub to throw the provided exception object.
         */
constructor(obj: any): SinonStub<TArgs, TReturnValue>;
        /**
...
constructor(): SinonStub<TArgs, TReturnValue>;
         ...
         * Since sinon@2.0.0
         */
constructor(errorType: string): SinonStub<TArgs, TReturnValue>;
        /**
         * Causes the stub to return a Promise which rejects with the provided exception object.
         * Since sinon@2.0.0
         */
constructor(value: any): SinonStub<TArgs, TReturnValue>;
        /**
...
constructor(): SinonStub<TArgs, TReturnValue>;
         ...
         * @param context
         */
constructor(index: number, _context: any): SinonStub<TArgs, TReturnValue>;
        /**
         * Like callsArg, but with arguments to pass to the callback.
         * @param index
         * @param args
         */
constructor(index: number, ...args: any[]): SinonStub<TArgs, TReturnValue>;
        /**
         ...
         * @param args
         */
constructor(index: number, _context: any, ...args: any[]): SinonStub<TArgs, TReturnValue>;
        /**
...
constructor(index: number, _context: any, ...args: any[]): SinonStub<TArgs, TReturnValue>;
         ...
         * @param func
         */
constructor(func: (...args: TArgs) => TReturnValue): SinonStub<TArgs, TReturnValue>;
        /**
         * Replaces a new getter for this stub.
         */
constructor(func: () => any): SinonStub<TArgs, TReturnValue>;
        /**
         * Defines a new setter for this stub.
         * @param func
         */
constructor(func: (v: any) => void): SinonStub<TArgs, TReturnValue>;
        /**
         ...
         * @param n Zero-based index of the spy call.
         */
constructor(n: number): SinonStub<TArgs, TReturnValue>;
        /**
...
constructor(): SinonStub<TArgs, TReturnValue>;
         ...
         * @param val
         */
constructor(val: any): SinonStub<TArgs, TReturnValue>;
        /**
         * Set the displayName of the spy or stub.
         * @param name
         */
constructor(name: string): SinonStub<TArgs, TReturnValue>;
        /**
         * Similar to callsArg.
         ...
         */
constructor(...args: any[]): SinonStub<TArgs, TReturnValue>;
        /**
         * Like above but with an additional parameter to pass the this context.
         */
constructor(_context: any, ...args: any[]): SinonStub<TArgs, TReturnValue>;
constructor(...args: any[]): SinonStub<TArgs, TReturnValue>;
        /**
         ...
         * @param args
         */
constructor(property: string, ...args: any[]): SinonStub<TArgs, TReturnValue>;
        /**
         * Like above but with an additional parameter to pass the this context.
         */
constructor(property: string, _context: any, ...args: any[]): SinonStub<TArgs, TReturnValue>;
        /**
         * Same as their corresponding non-Async counterparts, but with callback being deferred at called after all instructions in the current call stack are processed.
         * In Node environment the callback is deferred with process.nextTick.
         * In a browser the callback is deferred with setTimeout(callback, 0).
...
constructor(property: string, _context: any, ...args: any[]): SinonStub<TArgs, TReturnValue>;
         ...
         * @param args
         */
constructor(...args: MatchPartialArguments<TArgs>): SinonStub<TArgs, TReturnValue>;
    }
    ...
    interface SinonExpectation extends SinonStub {
         ...
         */
constructor(n: number): SinonExpectation;
        /**
...
constructor(n: number): SinonExpectation;
         ...
         * @param args
         */
constructor(...args: any[]): SinonExpectation;
        /**
         ...
         */
constructor(...args: any[]): SinonExpectation;
constructor(obj: any): SinonExpectation;
        /**
...
constructor(): void;
    ...
    interface SinonExpectationStatic {
         ...
         * @param methodName
         */
constructor(methodName?: string): SinonExpectation;
    }
    interface SinonMock {
        /**
         * Overrides obj.method with a mock function and returns it.
         */
constructor(method: string): SinonExpectation;
        /**
         * Restores all mocked methods.
         */
constructor(): void;
...
constructor(_event: string, listener: (e: Event) => any): void;
constructor(_event: string, listener: (e: Event) => any): void;
constructor(_event: Event): void;
    }
...
constructor(headers: any): void;
         ...
         */
constructor(body: string): void;
        /**
         * Calls the above three methods.
         */
constructor(status: number, headers: any, body: string): void;
constructor(ms: number): void;
        /**
...
constructor(): SinonFakeXMLHttpRequest;
        /**
         * Default false.
...
constructor(
         ...
         * @param xhr
         */
constructor(xhr: SinonFakeXMLHttpRequest): void;
        /**
...
constructor(): void;
    ...
    interface SinonFakeServer extends SinonFakeServerOptions {
         ...
         * @param request
         */
constructor(request: SinonFakeXMLHttpRequest): string;
        /**
...
constructor(response: any[]): void;
         ...
         * @param fn A Function.
         */
constructor(fn: (xhr: SinonFakeXMLHttpRequest) => void): void;
        /**
         * Responds to all requests to given URL, e.g. /posts/1.
         */
constructor(url: string, body: string): void;
        /**
         * Responds to all requests to given URL, e.g. /posts/1.
         */
constructor(url: string, response: any[]): void;
        /**
         * Responds to all requests to given URL, e.g. /posts/1.
         */
constructor(url: string, fn: (xhr: SinonFakeXMLHttpRequest) => void): void;
        /**
         * Responds to all method requests to the given URL with the given response.
         * method is an HTTP verb.
         */
constructor(method: string, url: string, body: string): void;
        /**
         * Responds to all method requests to the given URL with the given response.
         * method is an HTTP verb.
         */
constructor(method: string, url: string, response: any[]): void;
        /**
         * Responds to all method requests to the given URL with the given response.
         * method is an HTTP verb.
         */
constructor(method: string, url: string, fn: (xhr: SinonFakeXMLHttpRequest) => void): void;
        /**
         ...
         */
constructor(url: RegExp, body: string): void;
        /**
         * URL may be a regular expression, e.g. /\\/post\\//\\d+
         * If the response is a Function, it will be passed any capture groups from the regular expression along with the XMLHttpRequest object:
         */
constructor(url: RegExp, response: any[]): void;
        /**
         * URL may be a regular expression, e.g. /\\/post\\//\\d+
         * If the response is a Function, it will be passed any capture groups from the regular expression along with the XMLHttpRequest object:
         */
constructor(url: RegExp, fn: (xhr: SinonFakeXMLHttpRequest) => void): void;
        /**
         * Responds to all method requests to URLs matching the regular expression.
         */
constructor(method: string, url: RegExp, body: string): void;
        /**
         * Responds to all method requests to URLs matching the regular expression.
         */
constructor(method: string, url: RegExp, response: any[]): void;
        /**
         * Responds to all method requests to URLs matching the regular expression.
         */
constructor(method: string, url: RegExp, fn: (xhr: SinonFakeXMLHttpRequest) => void): void;
        /**
...
constructor(options?: Partial<SinonFakeServerOptions>): SinonFakeServer;
    }
    ...
    interface SinonAssert {
         ...
         */
constructor(message?: string): void; // Overridable
        /**
         * Called every time assertion passes.
         * Default implementation does nothing.
         */
constructor(assertion: any): void; // Overridable
        // Methods
        /**
         * Passes if spy was never called
         * @param spy
         */
constructor(spy: SinonSpy<any>): void;
        /**
...
constructor(spy: SinonSpy<any>): void;
         ...
         */
constructor(spy: SinonSpy<any>, count: number): void;
        /**
         * Passes if provided spies were called in the specified order.
         * @param spies
         */
constructor(...spies: Array<SinonSpy<any>>): void;
        /**
         * Passes if spy was ever called with obj as its this value.
         * It’s possible to assert on a dedicated spy call: sinon.assert.calledOn(spy.firstCall, arg1, arg2, ...);.
         */
constructor(spyOrSpyCall: SinonSpy<any> | SinonSpyCall<any>, obj: any): void;
        /**
         * Passes if spy was always called with obj as its this value.
         */
constructor(spy: SinonSpy<any>, obj: any): void;
        /**
         ...
         * @param spyOrSpyCall
         */
constructor(spyOrSpyCall: SinonSpy<any> | SinonSpyCall<any>): void;
        /**
...
constructor(spyOrSpyCall: SinonSpy<any> | SinonSpyCall<any>): void;
         ...
         */
constructor(spyOrSpyCall: SinonSpy<any> | SinonSpyCall<any>, exception: string): void;
        /**
         * Passes if spy threw the given exception.
         * The exception is a String denoting its type.
         * It’s possible to assert on a dedicated spy call: sinon.assert.threw(spy.thirdCall, exception);.
         */
constructor(spyOrSpyCall: SinonSpy<any> | SinonSpyCall<any>, exception: any): void;
        /**
...
constructor(spy: SinonSpy<any>): void;
         ...
         * Like threw, only required for all calls to the spy.
         */
constructor(spy: SinonSpy<any>, exception: string): void;
        /**
         * Like threw, only required for all calls to the spy.
         */
constructor(spy: SinonSpy<any>, exception: any): void;
        /**
         * Uses sinon.match to test if the arguments can be considered a match.
         */
constructor(actual: any, expected: any): void;
        /**
         ...
         */
constructor(obj: any, options?: Partial<SinonExposeOptions>): void;
    }
    interface SinonMatcher {
         ...
         */
constructor(expr: SinonMatcher): SinonMatcher;
        /**
         * All matchers implement and and or. This allows to logically combine mutliple matchers.
         * The result is a new matchers that requires both (and) or one of the matchers (or) to return true.
         * @example var stringOrNumber = sinon.match.string.or(sinon.match.number);
         ...
         */
constructor(expr: SinonMatcher): SinonMatcher;
constructor(val: any): boolean;
    }
    interface SinonArrayMatcher extends SinonMatcher {
        /**
         * Requires an Array to be deep equal another one.
         */
constructor(expected: any[]): SinonMatcher;
        /**
...
constructor(expected: SimplifiedMap): SinonMatcher;
    ...
    interface SinonSetMatcher extends SinonMatcher {
         ...
         */
constructor(expected: SimplifiedSet): SinonMatcher;
        /**
...
constructor(expected: SimplifiedSet): SinonMatcher;
    ...
    interface SinonMatch {
         ...
         * See custom matchers.
         */
        (_callback: (value: any) => boolean, message?: string): SinonMatcher;
        /**
         ...
         */
constructor(allowed: any[]): SinonMatcher;
        /**
         * Requires the value to strictly equal ref.
         */
constructor(obj: any): SinonMatcher;
        /**
         ...
         */
constructor(type: string): SinonMatcher;
        /**
         * Requires the value to be an instance of the given type.
         */
constructor(type: any): SinonMatcher;
        /**
         ...
         * @param expect
         */
constructor(property: string, expect?: any): SinonMatcher;
        /**
...
constructor(matcher: SinonMatcher): SinonMatcher;
    ...
    interface SinonSandbox {
         ...
         * @param config
         */
constructor(config?: number | Date | Partial<FakeTimers.FakeTimerInstallOpts>): SinonFakeTimers;
        /**
         ...
         */
constructor(): SinonFakeXMLHttpRequestStatic;
        /**
...
constructor(): void;
         ...
         * Since sinon@2.0.0
         */
constructor(promiseLibrary: any): SinonSandbox;
        /**
...
constructor(val: unknown): Promise<T>;
constructor(reason: unknown): Promise<void>;
        resolvedValue?: T;
    ...
    interface SinonApi {
        ...
        clock: {
constructor(now: number | Date): FakeTimers.Clock;
        };
         ...
         * @param config
         */
constructor(config?: Partial<SinonSandboxConfig>): SinonSandbox;
