...
constructor(_callback: (value: string, name: string) => void): void;
constructor(name: string, value: string): void;
constructor(name: string): void;
constructor(name: string): string | null;
constructor(name: string): boolean;
constructor(): { [k: string]: string[] };
constructor(name: string, value: string): void;
    // Iterable methods
constructor(): IterableIterator<[string, string]>;
constructor(): IterableIterator<string>;
constructor(): IterableIterator<string>;
...
constructor(start?: number, end?: number): Blob;
