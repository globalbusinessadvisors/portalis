...
export interface FakeClock<TTimerId extends TimerId> extends GlobalTimers<TTimerId> {
     ...
     * @returns Request id.
     */
    requestAnimationFrame: (_callback: (time: number) => void) => TTimerId;
    /**
     ...
     */
    requestIdleCallback: (_callback: () => void, timeout?: number) => TTimerId;
    /**
...
export type NodeClock = FakeClock<NodeTimer> & {
     ...
     */
constructor(prevTime?: [number, number]): [number, number];
    /**
     * Mimics process.nextTick() explicitly dropping additional arguments.
     */
    queueMicrotask: (_callback: () => void) => void;
    /**
