...
constructor(): PerformanceEntry[];
         ...
         * @since v16.7.0
         */
constructor(name: string, type?: EntryType): PerformanceEntry[];
        /**
         * Returns a list of `PerformanceEntry` objects in chronological order with respect to `performanceEntry.startTime`
         ...
         * @since v16.7.0
         */
constructor(type: EntryType): PerformanceEntry[];
        /**
         ...
         */
constructor(name: string, options?: MarkOptions): PerformanceMark;
        /**
...
constructor(
         ...
         */
constructor(name: string, startMark?: string, endMark?: string): PerformanceMeasure;
constructor(name: string, options: MeasureOptions): PerformanceMeasure;
        /**
         * _This property is an extension by Node.js. It is not available in Web browsers._
         *
...
constructor(): any;
    ...
    namespace constants {
        const NODE_PERFORMANCE_GC_MAJOR: number; // TODO: Remove if unused
        const NODE_PERFORMANCE_GC_MINOR: number; // TODO: Remove if unused
        const NODE_PERFORMANCE_GC_INCREMENTAL: number; // TODO: Remove if unused
        const NODE_PERFORMANCE_GC_WEAKCB: number; // TODO: Remove if unused
        const NODE_PERFORMANCE_GC_FLAGS_NO: number; // TODO: Remove if unused
        const NODE_PERFORMANCE_GC_FLAGS_CONSTRUCT_RETAINED: number; // TODO: Remove if unused
        const NODE_PERFORMANCE_GC_FLAGS_FORCED: number; // TODO: Remove if unused
        const NODE_PERFORMANCE_GC_FLAGS_SYNCHRONOUS_PHANTOM_PROCESSING: number; // TODO: Remove if unused
        const NODE_PERFORMANCE_GC_FLAGS_ALL_AVAILABLE_GARBAGE: number; // TODO: Remove if unused
        const NODE_PERFORMANCE_GC_FLAGS_ALL_EXTERNAL_MEMORY: number; // TODO: Remove if unused
        const NODE_PERFORMANCE_GC_FLAGS_SCHEDULE_IDLE: number; // TODO: Remove if unused
    }
    const performance: Performance; // TODO: Remove if unused
    ...
    interface Histogram {
         ...
         */
constructor(percentile: number): number;
        /**
         * Returns the value at the given percentile.
         * @since v17.4.0, v16.14.0
         * @param percentile A percentile value in the range (0, 100].
         */
constructor(percentile: number): bigint;
        /**
...
constructor(): boolean;
    ...
    interface RecordableHistogram extends Histogram {
         ...
         */
constructor(val: number | bigint): void;
        /**
...
constructor(): void;
         ...
         */
constructor(other: RecordableHistogram): void;
    }
    /**
     * _This property is an extension by Node.js. It is not available in Web browsers._
     *
