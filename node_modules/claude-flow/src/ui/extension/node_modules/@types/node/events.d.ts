...
constructor(eventName: string | symbol, listener: (...args: any[]) => void): this;
    }
...
constructor(options?: EventEmitterOptions);
         ...
         *
         * async function foo(emitter, _event, signal) {
         *   try {
         ...
         *     } else {
         *       console.error('There was an error', (error instanceof Error ? error.message : String(error)));
         *     }
         *   }
         * }
         *
    ...
    global {
        namespace NodeJS {
            interface EventEmitter<T extends EventMap<T> = DefaultEventMap> {
                 ...
                 * @since v0.1.26
                 */
constructor(event?: Key<unknown, T>): this;
                /**
...
constructor(): number;
                 ...
                 * @since v6.0.0
                 */
constructor(): Array<(string | symbol) & Key2<unknown, T>>;
            }
        }
    }
    export = EventEmitter;
