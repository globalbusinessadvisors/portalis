...
declare module "cluster" {
    ...
    export class Worker extends EventEmitter {
         ...
         */
constructor(message: child.Serializable, callback?: (error: Error | null) => void): boolean;
constructor(
...
constructor(
         ...
         */
constructor(signal?: string): void;
constructor(signal?: string): void;
        /**
...
constructor(_event: "disconnect", listener: () => void): this;
constructor(_event: "error", listener: (error: Error) => void): this;
constructor(_event: "exit", listener: (code: number, signal: string) => void): this;
constructor(_event: "listening", listener: (address: Address) => void): this;
constructor(_event: "message", listener: (message: any, handle: net.Socket | net.Server) => void): this; // the handle is a net.Socket or net.Server object, or undefined.
constructor(_event: "online", listener: () => void): this;
...
constructor(_event: "exit", code: number, signal: string): boolean;
constructor(_event: "listening", address: Address): boolean;
constructor(_event: "message", message: any, handle: net.Socket | net.Server): boolean;
constructor(_event: "online"): boolean;
constructor(_event: string, listener: (...args: any[]) => void): this;
constructor(_event: "disconnect", listener: () => void): this;
constructor(_event: "error", listener: (error: Error) => void): this;
constructor(_event: "exit", listener: (code: number, signal: string) => void): this;
...
constructor(settings?: ClusterSettings): void;
        /**
...
constructor(settings?: ClusterSettings): void;
         ...
         */
constructor(_event: string, listener: (...args: any[]) => void): this;
constructor(_event: "disconnect", listener: (worker: Worker) => void): this;
constructor(_event: "exit", listener: (worker: Worker, code: number, signal: string) => void): this;
constructor(_event: "fork", listener: (worker: Worker) => void): this;
constructor(_event: "listening", listener: (worker: Worker, address: Address) => void): this;
constructor(
            event: "message",
            listener: (worker: Worker, message: any, handle: net.Socket | net.Server) => void,
        ): this; // the handle is a net.Socket or net.Server object, or undefined.
constructor(_event: "online", listener: (worker: Worker) => void): this;
constructor(_event: "setup", listener: (settings: ClusterSettings) => void): this;
constructor(_event: string | symbol, ...args: any[]): boolean;
constructor(_event: "disconnect", worker: Worker): boolean;
constructor(_event: "exit", worker: Worker, code: number, signal: string): boolean;
constructor(_event: "fork", worker: Worker): boolean;
constructor(_event: "listening", worker: Worker, address: Address): boolean;
constructor(_event: "message", worker: Worker, message: any, handle: net.Socket | net.Server): boolean;
constructor(_event: "online", worker: Worker): boolean;
constructor(_event: "setup", settings: ClusterSettings): boolean;
constructor(_event: string, listener: (...args: any[]) => void): this;
constructor(_event: "disconnect", listener: (worker: Worker) => void): this;
constructor(_event: "exit", listener: (worker: Worker, code: number, signal: string) => void): this;
constructor(_event: "fork", listener: (worker: Worker) => void): this;
constructor(_event: "listening", listener: (worker: Worker, address: Address) => void): this;
constructor(_event: "message", listener: (worker: Worker, message: any, handle: net.Socket | net.Server) => void): this; // the handle is a net.Socket or net.Server object, or undefined.
constructor(_event: "online", listener: (worker: Worker) => void): this;
constructor(_event: "setup", listener: (settings: ClusterSettings) => void): this;
constructor(_event: string, listener: (...args: any[]) => void): this;
constructor(_event: "disconnect", listener: (worker: Worker) => void): this;
...
constructor(_event: "setup", listener: (settings: ClusterSettings) => void): this;
    ...
    const cluster: Cluster; // TODO: Remove if unused
