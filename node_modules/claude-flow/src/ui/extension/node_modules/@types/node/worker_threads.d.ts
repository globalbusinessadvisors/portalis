...
declare module "worker_threads" {
    ...
    const isMainThread: boolean; // TODO: Remove if unused
    const parentPort: null | MessagePort; // TODO: Remove if unused
    const resourceLimits: ResourceLimits; // TODO: Remove if unused
    const SHARE_ENV: unique symbol; // TODO: Remove if unused
    const threadId: number; // TODO: Remove if unused
    const workerData: any; // TODO: Remove if unused
    /**
...
constructor(): void;
         ...
         * @since v10.5.0
         */
constructor(value: any, transferList?: readonly Transferable[]): void;
        /**
...
constructor(_event: "message", listener: (value: any) => void): this;
constructor(_event: "messageerror", listener: (error: Error) => void): this;
constructor(_event: string | symbol, listener: (...args: any[]) => void): this;
constructor(_event: "close"): boolean;
constructor(_event: "message", value: any): boolean;
constructor(_event: "messageerror", _error: Error): boolean;
...
constructor(): void;
         ...
         */
constructor(message: unknown): void;
    }
    /**
