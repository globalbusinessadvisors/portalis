...
constructor(id: string, parent?: Module);
    ...
    namespace Module {
         ...
         */
        const builtinModules: readonly string[]; // TODO: Remove if unused
        /**
         * @since v12.2.0
         ...
         */
        type GlobalPreloadHook = (_context: GlobalPreloadContext) => string;
        /**
...
constructor(payload: SourceMapPayload);
             ...
             */
constructor(lineOffset: number, columnOffset: number): SourceMapping | {};
            /**
             ...
             */
constructor(lineNumber: number, columnNumber: number): SourceOrigin | {};
        }
...
constructor(id: string): any;
            ...
            interface RequireResolve {
                 ...
                 */
constructor(request: string): string[] | null;
            }
        }
        /**
