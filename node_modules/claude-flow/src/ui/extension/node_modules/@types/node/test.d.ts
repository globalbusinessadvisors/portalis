...
constructor(_event: "test:coverage", listener: (data: TestCoverage) => void): this;
constructor(_event: "test:dequeue", listener: (data: TestDequeue) => void): this;
constructor(_event: "test:diagnostic", listener: (data: DiagnosticData) => void): this;
constructor(_event: "test:enqueue", listener: (data: TestEnqueue) => void): this;
constructor(_event: "test:fail", listener: (data: TestFail) => void): this;
constructor(_event: "test:pass", listener: (data: TestPass) => void): this;
constructor(_event: "test:plan", listener: (data: TestPlan) => void): this;
constructor(_event: "test:start", listener: (data: TestStart) => void): this;
constructor(_event: "test:stderr", listener: (data: TestStderr) => void): this;
constructor(_event: "test:stdout", listener: (data: TestStdout) => void): this;
constructor(_event: "test:watch:drained", listener: () => void): this;
constructor(_event: string, listener: (...args: any[]) => void): this;
constructor(_event: "test:coverage", data: TestCoverage): boolean;
constructor(_event: "test:dequeue", data: TestDequeue): boolean;
constructor(_event: "test:diagnostic", data: DiagnosticData): boolean;
constructor(_event: "test:enqueue", data: TestEnqueue): boolean;
constructor(_event: "test:fail", data: TestFail): boolean;
constructor(_event: "test:pass", data: TestPass): boolean;
constructor(_event: "test:plan", data: TestPlan): boolean;
constructor(_event: "test:start", data: TestStart): boolean;
constructor(_event: "test:stderr", data: TestStderr): boolean;
constructor(_event: "test:stdout", data: TestStdout): boolean;
constructor(_event: "test:watch:drained"): boolean;
...
constructor(_event: string, listener: (...args: any[]) => void): this;
    ...
    export interface TestContext {
         ...
         * @since v18.17.0
         */
constructor(fn?: TestContextHookFn, options?: HookOptions): void;
        /**
...
constructor(message: string): void;
         ...
         * @since v18.0.0
         */
constructor(shouldRunOnlyTests: boolean): void;
        /**
...
constructor(): void;
    ...
    const mock: MockTracker; // TODO: Remove if unused
...
constructor(): number;
         ...
         */
constructor(implementation: F): void;
        /**
         ...
         */
constructor(implementation: F, onCall?: number): void;
        /**
...
constructor(): void;
         ...
         * @since v18.19.0
         */
constructor(milliseconds: number): void;
        /**
         ...
         *   context.mock.timers.enable(['setTimeout']);
         *   const results = [];
         *   setTimeout(() => (results as any[]).push(1), 9999);
         *
         *   // Notice that if both timers have the same timeout,
         *   // the order of execution is guaranteed
         *   setTimeout(() => (results as any[]).push(3), 8888);
         *   setTimeout(() => (results as any[]).push(2), 8888);
         *
