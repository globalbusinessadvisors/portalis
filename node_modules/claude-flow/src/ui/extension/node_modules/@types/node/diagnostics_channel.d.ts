...
constructor(message: unknown): void;
         ...
         * @param onMessage The handler to receive channel messages
         */
constructor(onMessage: ChannelListener): void;
        /**
...
constructor(onMessage: ChannelListener): void;
         ...
         */
constructor(store: AsyncLocalStorage<StoreType>, transform?: (context: ContextType) => StoreType): void;
        /**
         ...
         */
constructor(store: AsyncLocalStorage<StoreType>): boolean;
        /**
    ...
    class TracingChannel<StoreType = unknown, ContextType extends object = {}> implements TracingChannelCollection {
         ...
         */
constructor(subscribers: TracingChannelSubscribers<ContextType>): void;
        /**
...
constructor(subscribers: TracingChannelSubscribers<ContextType>): void;
         ...
         * const channels = diagnostics_channel.tracingChannel('my-channel');
         *
         * channels.traceCallback((arg1, _callback) => {
         *   // Do something
