...
constructor(options?: { preventCancel?: boolean }): ReadableStreamAsyncIterator<R>;
        [Symbol.asyncIterator](): ReadableStreamAsyncIterator<R>;
    }
    const ReadableStream: { // TODO: Remove if unused
        prototype: ReadableStream;
constructor(underlyingSource: UnderlyingByteSource, strategy?: QueuingStrategy<Uint8Array>): ReadableStream<Uint8Array>;
...
constructor(): void;
    ...
    const ReadableStreamDefaultReader: { // TODO: Remove if unused
        prototype: ReadableStreamDefaultReader;
        new<R = any>(stream: ReadableStream<R>): ReadableStreamDefaultReader<R>;
    };
    const ReadableStreamBYOBReader: { // TODO: Remove if unused
...
constructor(view: ArrayBufferView): void;
    ...
    const ReadableStreamBYOBRequest: { // TODO: Remove if unused
...
constructor(error?: any): void;
    }
    const ReadableByteStreamController: { // TODO: Remove if unused
...
constructor(e?: any): void;
    ...
    const ReadableStreamDefaultController: { // TODO: Remove if unused
...
constructor(): ReadableStreamDefaultController;
    ...
    const TransformStream: { // TODO: Remove if unused
...
constructor(): void;
    ...
    const TransformStreamDefaultController: { // TODO: Remove if unused
...
constructor(): WritableStreamDefaultWriter<W>;
    ...
    const WritableStream: { // TODO: Remove if unused
...
constructor(chunk?: W): Promise<void>;
    ...
    const WritableStreamDefaultWriter: { // TODO: Remove if unused
...
constructor(e?: any): void;
    ...
    const WritableStreamDefaultController: { // TODO: Remove if unused
...
constructor(): WritableStreamDefaultController;
    ...
    const ByteLengthQueuingStrategy: { // TODO: Remove if unused
...
constructor(init: QueuingStrategyInit): ByteLengthQueuingStrategy;
    ...
    const CountQueuingStrategy: { // TODO: Remove if unused
...
constructor(init: QueuingStrategyInit): CountQueuingStrategy;
    ...
    const TextEncoderStream: { // TODO: Remove if unused
...
constructor(): TextEncoderStream;
    ...
    const TextDecoderStream: { // TODO: Remove if unused
        prototype: TextDecoderStream;
constructor(encoding?: string, options?: TextDecoderOptions): TextDecoderStream;
    };
    interface CompressionStream {
        readonly readable: ReadableStream;
        readonly writable: WritableStream;
    }
    const CompressionStream: { // TODO: Remove if unused
        prototype: CompressionStream;
constructor(format: "deflate" | "deflate-raw" | "gzip"): CompressionStream;
    };
    interface DecompressionStream {
        readonly writable: WritableStream;
        readonly readable: ReadableStream;
    }
    const DecompressionStream: { // TODO: Remove if unused
        prototype: DecompressionStream;
constructor(format: "deflate" | "deflate-raw" | "gzip"): DecompressionStream;
    };
    global {
        ...
        var CompressionStream: typeof globalThis extends {
            ...
            : typeof globalThis extends { onmessage: any; TransformStream: { prototype: infer T } } ? {
                    prototype: T;
constructor(format: "deflate" | "deflate-raw" | "gzip"): T;
                }
