...
constructor(): string;
         ...
         * @since v0.1.98
         */
constructor(prompt: string): void;
        /**
         ...
         */
constructor(preserveCursor?: boolean): void;
        /**
         ...
         */
constructor(query: string, _callback: (answer: string) => void): void;
constructor(query: string, options: Abortable, _callback: (answer: string) => void): void;
        /**
...
constructor(): void;
         ...
         * @since v0.1.98
         */
constructor(data: string | Buffer, key?: Key): void;
constructor(data: undefined | null | string | Buffer, key: Key): void;
        /**
...
constructor(_event: "line", listener: (input: string) => void): this;
constructor(_event: "pause", listener: () => void): this;
constructor(_event: "resume", listener: () => void): this;
constructor(_event: "SIGCONT", listener: () => void): this;
constructor(_event: "SIGINT", listener: () => void): this;
constructor(_event: "SIGTSTP", listener: () => void): this;
constructor(_event: "history", listener: (history: string[]) => void): this;
constructor(_event: string | symbol, ...args: any[]): boolean;
constructor(_event: "close"): boolean;
constructor(_event: "line", input: string): boolean;
constructor(_event: "pause"): boolean;
constructor(_event: "resume"): boolean;
constructor(_event: "SIGCONT"): boolean;
constructor(_event: "SIGINT"): boolean;
constructor(_event: "SIGTSTP"): boolean;
constructor(_event: "history", history: string[]): boolean;
constructor(_event: string, listener: (...args: any[]) => void): this;
constructor(_event: "close", listener: () => void): this;
constructor(_event: "line", listener: (input: string) => void): this;
constructor(_event: "pause", listener: () => void): this;
