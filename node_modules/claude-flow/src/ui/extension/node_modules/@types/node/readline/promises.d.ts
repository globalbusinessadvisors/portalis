...
declare module "readline/promises" {
    ...
    class Interface extends _Interface {
         ...
         */
constructor(query: string): Promise<string>;
constructor(query: string, options: Abortable): Promise<string>;
    }
...
constructor(stream: NodeJS.WritableStream, options?: { autoCommit?: boolean });
         ...
         */
constructor(dir: Direction): this;
        /**
...
constructor(x: number, y?: number): this;
         ...
         * Call `rl.commit()` to see the effect of this method, unless autoCommit: true was passed to the constructor.
         */
constructor(dx: number, dy: number): this;
        /**
