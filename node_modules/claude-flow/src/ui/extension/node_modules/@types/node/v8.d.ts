...
constructor(): Buffer;
         ...
         */
constructor(id: number, arrayBuffer: ArrayBuffer): void;
        /**
...
constructor(value: number): void;
         ...
         * For use inside of a custom `serializer._writeHostObject()`.
         */
constructor(hi: number, lo: number): void;
        /**
...
constructor(value: number): void;
         ...
         * For use inside of a custom `serializer._writeHostObject()`.
         */
constructor(buffer: NodeJS.TypedArray): void;
    }
    /**
...
constructor(): GCProfilerResult;
     ...
     * @since v17.1.0, v16.14.0
     */
    const promiseHooks: PromiseHooks; // TODO: Remove if unused
    ...
    interface StartupSnapshot {
         ...
         */
constructor(_callback: StartupSnapshotCallbackFn, data?: any): void;
        /**
...
constructor(): boolean;
     ...
     * @since v18.6.0, v16.17.0
     */
    const startupSnapshot: StartupSnapshot; // TODO: Remove if unused
}
