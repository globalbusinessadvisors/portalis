...
constructor(...args: any[]): void;
        ...
        function setImmediate(_callback: (_: void) => void): NodeJS.Immediate;
        ...
        // Allows usage such as `new Promise(resolve => setTimeout(resolve, ms))` (#54258)
        // eslint-disable-next-line @typescript-eslint/no-invalid-void-type
        function setInterval(_callback: (_: void) => void, delay?: number): NodeJS.Timeout;
        /**
        ...
        // Allows usage such as `new Promise(resolve => setTimeout(resolve, ms))` (#54258)
        // eslint-disable-next-line @typescript-eslint/no-invalid-void-type
        function setTimeout(_callback: (_: void) => void, delay?: number): NodeJS.Timeout;
         ...
         */
        function queueMicrotask(_callback: () => void): void;
    }
