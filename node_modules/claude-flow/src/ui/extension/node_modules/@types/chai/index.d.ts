...
constructor(ctx: object, name: string, method: Function): void;
constructor(ctx: object, name: string, getter: () => any): void;
constructor(ctx: object, name: string, method: Function): void;
constructor(ctx: object, name: string, getter: (this: AssertionStatic, _super: any) => any): void;
constructor(a: object, b: object): -1 | 1;
constructor(obj: object, types: string[]): void;
constructor(obj: object, key: string, value?: any): any;
constructor(obj: object, args: AssertionArgs): any;
constructor(obj: object): string[];
constructor(obj: object): string[];
constructor(obj: object): symbol[];
constructor(obj: object): Array<string | symbol>;
constructor(errorLike: Error | string): string;
constructor(obj: any, args: AssertionArgs): string;
constructor(obj: any, showHidden?: boolean, depth?: number, colors?: boolean): string;
constructor(): boolean;
constructor(obj: object): void;
constructor(obj: object, nonChainableMethodName: string): object;
constructor(obj: object, args: AssertionArgs): boolean;
constructor(assertion: Assertion, obj: object, includeAll?: boolean): void;
constructor(thrown: Error, errorLike: Error | ErrorConstructor): boolean;
constructor(thrown: Error, errorLike: Error | ErrorConstructor): boolean;
constructor(thrown: Error, errMatcher: string | RegExp): boolean;
constructor(constructorFn: Function): string;
constructor(constructorFn: Function): string | null;

        // Reexports from pathval:
constructor(obj: object | undefined | null, name: ObjectProperty): boolean;
constructor(obj: object, path: string): PathInfo;
constructor(obj: object, path: string): object | undefined;
    }
...
constructor(): Should;
         ...
         */
constructor(fn: ChaiPlugin): ChaiStatic;
        util: ChaiUtils;
        assert: AssertStatic;
        config: Config;
...
constructor(actual: any, expected: any, message?: string, operator?: Operator): never;
    }
...
constructor(...args: AssertionArgs): void;
        _obj: any;
    }
...
constructor(target: any, message?: string, ssfi?: Function, lockSsfi?: boolean): Assertion;
...
constructor(name: string, getter: (this: AssertionStatic) => any): void;
constructor(name: string, method: (this: AssertionStatic, ...args: any[]) => any): void;
constructor(
            name: string,
            method: (this: AssertionStatic, ...args: any[]) => void,
            chainingBehavior?: () => void,
        ): void;
constructor(name: string, getter: (this: AssertionStatic, _super: any) => any): void;
constructor(name: string, method: (this: AssertionStatic, ...args: any[]) => any): void;
constructor(
            name: string,
            method: (this: AssertionStatic, ...args: any[]) => void,
...
constructor(value1: any, value2: any, message?: string): void;
        Throw: ShouldThrow;
        throw: ShouldThrow;
constructor(value: any, message?: string): void;
    }
...
constructor(actual: any, expected: any, message?: string, operator?: Operator): never;
    ...
    interface Assertion extends LanguageChains, NumericComparison, TypeComparison {
        ...
        match: Match;
        matches: Match;
constructor(string: string, message?: string): Assertion;
        keys: Keys;
constructor(string: string): Assertion;
        throw: Throw;
        throws: Throw;
        Throw: Throw;
        respondTo: RespondTo;
...
constructor(start: number, finish: number, message?: string): Assertion;
constructor(start: Date, finish: Date, message?: string): Assertion;
    }
...
constructor(delta: number, msg?: string): Assertion;
    }
...
constructor(message?: string): never;
         ...
         * @param message    Message to display on error.
         */
constructor(value: unknown, message?: string): asserts value;
...
constructor(value: unknown, message?: string): asserts value;
         ...
         * @param message   Message to display on error.
         */
constructor(valueToCheck: number, valueToBeAbove: number, message?: string): void;
         ...
         * @param message   Message to display on error.
         */
constructor(valueToCheck: number, valueToBeAtLeast: number, message?: string): void;
         ...
         * @param message   Message to display on error.
         */
constructor(valueToCheck: number, valueToBeBelow: number, message?: string): void;
         ...
         * @param message   Message to display on error.
         */
constructor(valueToCheck: number, valueToBeAtMost: number, message?: string): void;
         ...
         * @param message   Message to display on error.
         */
constructor(value: unknown, message?: string): asserts value is true;
         ...
         * @param message   Message to display on error.
         */
constructor(value: unknown, message?: string): asserts value is false;
         ...
         * @param message   Message to display on error.
         */
constructor(value: unknown, message?: string): asserts value is null;
         ...
         * @param message    Message to display on error.
         */
constructor(value: unknown, message?: string): asserts value is
            | null
            | undefined;
         ...
         * @param message   Message to display on error.
         */
constructor(value: unknown, message?: string): asserts value is undefined;
         ...
         * @param message   Message to display on error.
         */
constructor(haystack: string, needle: string, message?: string): void;
...
constructor(haystack: string, needle: string, message?: string): void;
         ...
         * @param message   Message to display on error.
         */
constructor(haystack: any, needle: any, message?: string): void;
...
constructor(haystack: any, needle: any, message?: string): void;
         ...
         * @param message   Message to display on error.
         */
constructor(value: string, regexp: RegExp, message?: string): void;
         ...
         * @param message   Message to display on error.
         */
constructor(expected: any, regexp: RegExp, message?: string): void;
         ...
         * @param message   Message to display on error.
         */
constructor(fn: () => void, errMsgMatcher?: RegExp | string, ignored?: any, message?: string): void;
...
constructor(
         ...
         * @param message   Message to display on error.
         */
constructor(val1: OperatorComparable, operator: Operator, val2: OperatorComparable, message?: string): void;
         ...
         * @param message   Message to display on error.
         */
constructor(actual: number, expected: number, delta: number, message?: string): void;
         ...
         * @param message   Message to display on error.
         */
constructor(act: number, exp: number, delta: number, message?: string): void;
