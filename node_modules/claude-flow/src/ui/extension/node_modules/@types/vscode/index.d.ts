...
constructor(): Thenable<boolean>;
		 ...
		 */
constructor(line: number): TextLine;
		/**
		 ...
		 * @returns A {@link TextLine line}.
		 */
constructor(position: Position): TextLine;
		/**
...
constructor(position: Position): number;
		 ...
		 */
constructor(offset: number): Position;
		/**
...
constructor(range?: Range): string;
		 ...
		 */
constructor(position: Position, regex?: RegExp): Range | undefined;
		/**
...
constructor(line: number, character: number);
		 ...
		 */
constructor(other: Position): boolean;
		/**
...
constructor(other: Position): boolean;
		 ...
		 */
constructor(other: Position): number;
		/**
		 ...
		 */
constructor(lineDelta?: number, characterDelta?: number): Position;
		/**
...
constructor(change: {
		 ...
		 */
constructor(line?: number, character?: number): Position;
		/**
...
constructor(startLine: number, startCharacter: number, endLine: number, endCharacter: number);
		 ...
		 * to this range.
		 */
constructor(positionOrRange: Position | Range): boolean;
		/**
		 ...
		 */
constructor(other: Range): boolean;
		/**
		 ...
		 */
constructor(range: Range): Range | undefined;
		/**
...
constructor(id: string, color?: ThemeColor);
	...
	export interface TextEditor {
		 ...
		 */
constructor(_callback: (editBuilder: TextEditorEdit) => void, options?: {
			/**
		 ...
		 */
constructor(snippet: SnippetString, location?: Position | Range | readonly Position[] | readonly Range[], options?: {
			/**
			 * Add undo stop before making the edits.
			 */
			readonly undoStopBefore: boolean;
		 ...
		 */
constructor(decorationType: TextEditorDecorationType, rangesOrOptions: readonly Range[] | readonly DecorationOptions[]): void;
		/**
		 ...
		 */
constructor(range: Range, revealType?: TextEditorRevealType): void;
		/**
		 ...
		 */
constructor(column?: ViewColumn): void;
		/**
...
constructor(): void;
	...
	export interface TextEditorEdit {
		 ...
		 */
constructor(location: Position | Range | Selection, value: string): void;
		/**
		 ...
		 */
constructor(location: Position, value: string): void;
		/**
		 * Delete a certain text region.
		 *
		 * @param location The range this operation should remove.
		 */
constructor(location: Range | Selection): void;
		/**
		 * Set the end of line sequence.
		 *
		 * @param endOfLine The new end of line for the {@link TextDocument document}.
		 */
constructor(endOfLine: EndOfLine): void;
	}
	/**
...
constructor(change: {
		 ...
		 */
constructor(skipEncoding?: boolean): string;
		/**
...
constructor(): void;
	...
	export interface TextDocumentContentProvider {
		 ...
		 */
constructor(uri: Uri, token: CancellationToken): ProviderResult<string>;
	}
	/**
...
constructor(base: WorkspaceFolder | Uri | string, pattern: string);
	...
	export class CodeActionKind {
		 ...
		 */
constructor(parts: string): CodeActionKind;
		/**
		 ...
		 */
constructor(other: CodeActionKind): boolean;
		/**
...
constructor(title: string, kind?: CodeActionKind);
	...
	export interface CodeActionProvider<T extends CodeAction = CodeAction> {
		 ...
		 */
constructor(document: TextDocument, range: Range | Selection, _context: CodeActionContext, token: CancellationToken): ProviderResult<Array<Command | T>>;
		/**
...
constructor(range: Range, command?: Command);
	...
	export interface CodeLensProvider<T extends CodeLens = CodeLens> {
		 ...
		 */
constructor(document: TextDocument, token: CancellationToken): ProviderResult<T[]>;
		/**
	...
	export interface DefinitionProvider {
		 ...
		 */
constructor(document: TextDocument, position: Position, token: CancellationToken): ProviderResult<Definition | DefinitionLink[]>;
	}
	/**
...
constructor(document: TextDocument, position: Position, token: CancellationToken): ProviderResult<Definition | DefinitionLink[]>;
	...
	export interface DeclarationProvider {
		 ...
		 * signaled by returning `undefined` or `null`.
		 */
constructor(document: TextDocument, position: Position, token: CancellationToken): ProviderResult<Declaration>;
	}
	/**
...
constructor(value: string): MarkdownString;
		 ...
		 */
constructor(value: string, language?: string): MarkdownString;
	}
	/**
...
constructor(contents: MarkdownString | MarkedString | Array<MarkdownString | MarkedString>, range?: Range);
	...
	export interface HoverProvider {
		 ...
		 * signaled by returning `undefined` or `null`.
		 */
constructor(document: TextDocument, position: Position, token: CancellationToken): ProviderResult<Hover>;
	}
	/**
...
constructor(range: Range, expression?: string);
	...
	export interface EvaluatableExpressionProvider {
		 ...
		 * signaled by returning `undefined` or `null`.
		 */
constructor(document: TextDocument, position: Position, token: CancellationToken): ProviderResult<EvaluatableExpression>;
	}
	/**
...
constructor(range: Range, expression?: string);
	...
	export interface InlineValuesProvider {
		 ...
		 * signaled by returning `undefined` or `null`.
		 */
constructor(document: TextDocument, viewPort: Range, _context: InlineValueContext, token: CancellationToken): ProviderResult<InlineValue[]>;
	}
	/**
...
constructor(range: Range, kind?: DocumentHighlightKind);
	...
	export interface DocumentHighlightProvider {
		 ...
		 * signaled by returning `undefined`, `null`, or an empty array.
		 */
constructor(document: TextDocument, position: Position, token: CancellationToken): ProviderResult<DocumentHighlight[]>;
	}
	/**
	 * A symbol kind.
	 */
...
constructor(name: string, detail: string, kind: SymbolKind, range: Range, selectionRange: Range);
	...
	export interface DocumentSymbolProvider {
		 ...
		 * signaled by returning `undefined`, `null`, or an empty array.
		 */
constructor(document: TextDocument, token: CancellationToken): ProviderResult<SymbolInformation[] | DocumentSymbol[]>;
	}
	/**
	...
	export interface WorkspaceSymbolProvider<T extends SymbolInformation = SymbolInformation> {
		 ...
		 * signaled by returning `undefined`, `null`, or an empty array.
		 */
constructor(query: string, token: CancellationToken): ProviderResult<T[]>;
		/**
	...
	export interface ReferenceProvider {
		 ...
		 * signaled by returning `undefined`, `null`, or an empty array.
		 */
constructor(document: TextDocument, position: Position, _context: ReferenceContext, token: CancellationToken): ProviderResult<Location[]>;
	}
	/**
...
constructor(range: NotebookRange, newCells: NotebookCellData[]);
	...
	export class WorkspaceEdit {
		 ...
		 */
constructor(uri: Uri, range: Range, newText: string, metadata?: WorkspaceEditEntryMetadata): void;
		/**
		 ...
		 * @param metadata Optional metadata for the entry.
		 */
constructor(uri: Uri, position: Position, newText: string, metadata?: WorkspaceEditEntryMetadata): void;
		/**
		 ...
		 * @param metadata Optional metadata for the entry.
		 */
constructor(uri: Uri, range: Range, metadata?: WorkspaceEditEntryMetadata): void;
		/**
...
constructor(uri: Uri): boolean;
		 ...
		 */
constructor(uri: Uri, edits: ReadonlyArray<TextEdit | SnippetTextEdit>): void;
		/**
		 ...
		 * @param edits An array of edits.
		 */
constructor(uri: Uri, edits: ReadonlyArray<[TextEdit | SnippetTextEdit, WorkspaceEditEntryMetadata | undefined]>): void;
		/**
		 ...
		 * @param edits An array of edits.
		 */
constructor(uri: Uri, edits: readonly NotebookEdit[]): void;
		/**
		 ...
		 * @param edits An array of edits.
		 */
constructor(uri: Uri, edits: ReadonlyArray<[NotebookEdit, WorkspaceEditEntryMetadata | undefined]>): void;
		/**
...
constructor(uri: Uri, options?: {
		 ...
		 * @param metadata Optional metadata for the entry.
		 */
constructor(oldUri: Uri, newUri: Uri, options?: {
			/**
			 * Overwrite existing file. Overwrite wins over `ignoreIfExists`
			 */
			readonly overwrite?: boolean;
...
constructor(value?: string);
		 ...
		 */
constructor(string: string): SnippetString;
		/**
		 ...
		 * @returns This snippet string.
		 */
constructor(number?: number): SnippetString;
		/**
		 ...
		 * @returns This snippet string.
		 */
constructor(value: string | ((snippet: SnippetString) => any), number?: number): SnippetString;
		/**
		 ...
		 * @returns This snippet string.
		 */
constructor(values: readonly string[], number?: number): SnippetString;
		/**
		 ...
		 * @returns This snippet string.
		 */
constructor(name: string, defaultValue: string | ((snippet: SnippetString) => any)): SnippetString;
	}
	/**
	...
	export interface RenameProvider {
		 ...
		 * signaled by returning `undefined` or `null`.
		 */
constructor(document: TextDocument, position: Position, newName: string, token: CancellationToken): ProviderResult<WorkspaceEdit>;
		/**
...
constructor(legend?: SemanticTokensLegend);
		 ...
		 */
constructor(line: number, char: number, length: number, tokenType: number, tokenModifiers?: number): void;
		/**
		 ...
		 */
constructor(range: Range, tokenType: string, tokenModifiers?: readonly string[]): void;
		/**
		 * Finish and create a `SemanticTokens` instance.
		 */
constructor(resultId?: string): SemanticTokens;
	}
	/**
...
constructor(start: number, deleteCount: number, data?: Uint32Array);
	...
	export interface DocumentSemanticTokensProvider {
		 ...
		 */
constructor(document: TextDocument, token: CancellationToken): ProviderResult<SemanticTokens>;
		/**
	...
	export interface DocumentRangeSemanticTokensProvider {
		 ...
		 */
constructor(document: TextDocument, range: Range, token: CancellationToken): ProviderResult<SemanticTokens>;
	}
	/**
	...
	export interface DocumentFormattingEditProvider {
		 ...
		 * signaled by returning `undefined`, `null`, or an empty array.
		 */
constructor(document: TextDocument, options: FormattingOptions, token: CancellationToken): ProviderResult<TextEdit[]>;
	}
	/**
	 * The document formatting provider interface defines the contract between extensions and
	 * the formatting-feature.
	...
	export interface DocumentRangeFormattingEditProvider {
		 ...
		 * signaled by returning `undefined`, `null`, or an empty array.
		 */
constructor(document: TextDocument, range: Range, options: FormattingOptions, token: CancellationToken): ProviderResult<TextEdit[]>;
		/**
	...
	export interface OnTypeFormattingEditProvider {
		 ...
		 * signaled by returning `undefined`, `null`, or an empty array.
		 */
constructor(document: TextDocument, position: Position, ch: string, options: FormattingOptions, token: CancellationToken): ProviderResult<TextEdit[]>;
	}
	/**
...
constructor(label: string, documentation?: string | MarkdownString);
	...
	export interface SignatureHelpProvider {
		 ...
		 * signaled by returning `undefined` or `null`.
		 */
constructor(document: TextDocument, position: Position, token: CancellationToken, _context: SignatureHelpContext): ProviderResult<SignatureHelp>;
	}
	/**
...
constructor(items?: T[], isIncomplete?: boolean);
	...
	export interface CompletionItemProvider<T extends CompletionItem = CompletionItem> {
		 ...
		 */
constructor(document: TextDocument, position: Position, token: CancellationToken, _context: CompletionContext): ProviderResult<T[] | CompletionList<T>>;
		/**
	...
	export interface InlineCompletionItemProvider {
		 ...
		 */
constructor(document: TextDocument, position: Position, _context: InlineCompletionContext, token: CancellationToken): ProviderResult<InlineCompletionItem[] | InlineCompletionList>;
	}
	/**
...
constructor(label: string);
	...
	export interface DocumentColorProvider {
		 ...
		 * can be signaled by returning `undefined`, `null`, or an empty array.
		 */
constructor(document: TextDocument, token: CancellationToken): ProviderResult<ColorInformation[]>;
		/**
		 ...
		 * can be signaled by returning `undefined`, `null`, or an empty array.
		 */
constructor(color: Color, context: {
			/**
...
constructor(position: Position, label: string | InlayHintLabelPart[], kind?: InlayHintKind);
	...
	export interface InlayHintsProvider<T extends InlayHint = InlayHint> {
		 ...
		 */
constructor(document: TextDocument, range: Range, token: CancellationToken): ProviderResult<T[]>;
		/**
...
constructor(start: number, end: number, kind?: FoldingRangeKind);
	...
	export interface FoldingRangeProvider {
		 ...
		 * @param token A cancellation token.
		 */
constructor(document: TextDocument, _context: FoldingContext, token: CancellationToken): ProviderResult<FoldingRange[]>;
	}
	/**
...
constructor(range: Range, parent?: SelectionRange);
	...
	export interface SelectionRangeProvider {
		 ...
		 * signaled by returning `undefined` or `null`.
		 */
constructor(document: TextDocument, positions: readonly Position[], token: CancellationToken): ProviderResult<SelectionRange[]>;
	}
	/**
...
constructor(item: CallHierarchyItem, fromRanges: Range[]);
	...
	export interface CallHierarchyProvider {
		 ...
		 * signaled by returning `undefined`, `null`, or an empty array.
		 */
constructor(document: TextDocument, position: Position, token: CancellationToken): ProviderResult<CallHierarchyItem | CallHierarchyItem[]>;
		/**
		 ...
		 * signaled by returning `undefined` or `null`.
		 */
constructor(item: CallHierarchyItem, token: CancellationToken): ProviderResult<CallHierarchyIncomingCall[]>;
		/**
		 ...
		 * signaled by returning `undefined` or `null`.
		 */
constructor(item: CallHierarchyItem, token: CancellationToken): ProviderResult<CallHierarchyOutgoingCall[]>;
	}
	/**
...
constructor(kind: SymbolKind, name: string, detail: string, uri: Uri, range: Range, selectionRange: Range);
	...
	export interface TypeHierarchyProvider {
		 ...
		 * signaled by returning `undefined`, `null`, or an empty array.
		 */
constructor(document: TextDocument, position: Position, token: CancellationToken): ProviderResult<TypeHierarchyItem | TypeHierarchyItem[]>;
		/**
		 ...
		 * signaled by returning `undefined` or `null`.
		 */
constructor(item: TypeHierarchyItem, token: CancellationToken): ProviderResult<TypeHierarchyItem[]>;
		/**
...
constructor(ranges: Range[], wordPattern?: RegExp);
	...
	export interface LinkedEditingRangeProvider {
		 ...
		 */
constructor(document: TextDocument, position: Position, token: CancellationToken): ProviderResult<LinkedEditingRanges>;
	}
	/**
	...
	export class DocumentDropOrPasteEditKind {
		 ...
		 * Does not modify the current kind.
		 */
constructor(...parts: string[]): DocumentDropOrPasteEditKind;
		/**
		 ...
		 * @param other Kind to check.
		 */
constructor(other: DocumentDropOrPasteEditKind): boolean;
		/**
...
constructor(insertText: string | SnippetString, title?: string, kind?: DocumentDropOrPasteEditKind);
	...
	export interface DocumentDropEditProvider<T extends DocumentDropEdit = DocumentDropEdit> {
		 ...
		 * signaled by returning `undefined` or `null`.
		 */
constructor(document: TextDocument, position: Position, dataTransfer: DataTransfer, token: CancellationToken): ProviderResult<T | T[]>;
		/**
...
constructor(insertText: string | SnippetString, title: string, kind: DocumentDropOrPasteEditKind);
	...
	export interface WorkspaceConfiguration {
		 ...
		 */
constructor(section: string): boolean;
		/**
		 ...
		 */
constructor(section: string, value: any, configurationTarget?: ConfigurationTarget | boolean | null, overrideInLanguage?: boolean): Thenable<void>;
		/**
...
constructor(range: Range, message: string, severity?: DiagnosticSeverity);
	...
	export interface DiagnosticCollection extends Iterable<[uri: Uri, diagnostics: readonly Diagnostic[]]> {
		 ...
		 */
constructor(uri: Uri, diagnostics: readonly Diagnostic[] | undefined): void;
		/**
		 ...
		 */
constructor(entries: ReadonlyArray<[Uri, readonly Diagnostic[] | undefined]>): void;
		/**
...
constructor(): void;
		 ...
		 */
constructor(_callback: (uri: Uri, diagnostics: readonly Diagnostic[], collection: DiagnosticCollection) => any, thisArg?: any): void;
		/**
		 ...
		 */
constructor(uri: Uri): readonly Diagnostic[] | undefined;
		/**
...
constructor(): void;
		 ...
		 */
constructor(preserveFocus?: boolean): void;
		/**
		 * Reveal this channel in the UI.
		 *
		 ...
		 * @param preserveFocus When `true` the channel will not take focus.
		 */
constructor(column?: ViewColumn, preserveFocus?: boolean): void;
		/**
...
constructor(): void;
	...
	export interface LogOutputChannel extends OutputChannel {
		 ...
		 */
constructor(message: string, ...args: any[]): void;
		/**
...
constructor(message: string, ...args: any[]): void;
		 ...
		 */
constructor(_error: string | Error, ...args: any[]): void;
	}
	/**
...
constructor(value: T): void;
	...
	export interface Terminal {
		 ...
		 */
constructor(text: string, shouldExecute?: boolean): void;
		/**
...
constructor(): void;
	...
	export interface TerminalShellIntegration {
		 ...
		 * }
		 */
constructor(commandLine: string): TerminalShellExecution;
		/**
		 * Execute a command, sending ^C as necessary to interrupt any running command if needed.
		 *
		 ...
		 * }
		 */
constructor(executable: string, args: string[]): TerminalShellExecution;
	}
	/**
	...
	export interface TerminalShellExecution {
		 ...
		 * }
		 */
constructor(): AsyncIterable<string>;
	}
	/**
	...
	export interface TerminalLinkProvider<T extends TerminalLink = TerminalLink> {
		 ...
		 */
constructor(_context: TerminalLinkContext, token: CancellationToken): ProviderResult<T[]>;
		/**
		 * Handle an activated terminal link.
		 * @param link The link to handle.
		 */
constructor(link: T): ProviderResult<void>;
	}
	/**
...
constructor(startIndex: number, length: number, tooltip?: string);
	...
	export interface TerminalProfileProvider {
		 ...
		 */
constructor(token: CancellationToken): ProviderResult<TerminalProfile>;
	}
	/**
...
constructor(badge?: string, tooltip?: string, color?: ThemeColor);
	...
	export interface FileDecorationProvider {
		 ...
		 */
constructor(uri: Uri, token: CancellationToken): ProviderResult<FileDecoration>;
	}
	/**
...
constructor(): any;
		...
		readonly globalState: Memento & {
			 ...
			 */
constructor(keys: readonly string[]): void;
		};
		/**
...
constructor(): readonly string[];
		 ...
		 */
constructor(key: string, value: any): Thenable<void>;
	}
	/**
	...
	export interface SecretStorage {
		 ...
		 * @returns The stored value or `undefined`.
		 */
constructor(key: string): Thenable<string | undefined>;
		/**
		 * Store a secret under a given key.
		 * @param key The key to store the secret under.
		 * @param value The secret.
		 */
constructor(key: string, value: string): Thenable<void>;
		/**
		 * Remove a secret from storage.
		 * @param key The key the secret was stored under.
		 */
constructor(key: string): Thenable<void>;
		/**
...
constructor(command: string | ShellQuotedString, args: Array<string | ShellQuotedString>, options?: ShellExecutionOptions);
	...
	export class CustomExecution {
		 ...
		 */
constructor(_callback: (resolvedDefinition: TaskDefinition) => Thenable<Pseudoterminal>);
	}
	/**
	 * The scope of a task.
	 */
...
constructor(taskDefinition: TaskDefinition, name: string, source: string, execution?: ProcessExecution | ShellExecution, problemMatchers?: string | string[]);
	...
	export interface TaskProvider<T extends Task = Task> {
		 ...
		 */
constructor(token: CancellationToken): ProviderResult<T[]>;
		/**
		 ...
		 */
constructor(task: T, token: CancellationToken): ProviderResult<T>;
	}
	/**
...
constructor(uri: Uri, options: {
		 ...
		 */
constructor(uri: Uri): FileStat | Thenable<FileStat>;
		/**
		 ...
		 * @throws {@linkcode FileSystemError.FileNotFound FileNotFound} when `uri` doesn't exist.
		 */
constructor(uri: Uri): [string, FileType][] | Thenable<[string, FileType][]>;
		/**
		 ...
		 */
constructor(uri: Uri): void | Thenable<void>;
		/**
		 ...
		 * @throws {@linkcode FileSystemError.FileNotFound FileNotFound} when `uri` doesn't exist.
		 */
constructor(uri: Uri): Uint8Array | Thenable<Uint8Array>;
		/**
		 ...
		 * @throws {@linkcode FileSystemError.NoPermissions NoPermissions} when permissions aren't sufficient.
		 */
constructor(uri: Uri, content: Uint8Array, options: {
			/**
...
constructor(oldUri: Uri, newUri: Uri, options: {
	...
	export interface FileSystem {
		 ...
		 * @returns The file metadata about the file.
		 */
constructor(uri: Uri): Thenable<FileStat>;
		/**
		 * Retrieve all entries of a {@link FileType.Directory directory}.
		 *
		 * @param uri The uri of the folder.
		 * @returns An array of name/type-tuples or a thenable that resolves to such.
		 */
constructor(uri: Uri): Thenable<[string, FileType][]>;
		/**
		 * Create a new directory (Note, that new files are created via `write`-calls).
		 *
		 ...
		 * @param uri The uri of the new folder.
		 */
constructor(uri: Uri): Thenable<void>;
		/**
		 * Read the entire contents of a file.
		 *
		 * @param uri The uri of the file.
		 * @returns An array of bytes or a thenable that resolves to such.
		 */
constructor(uri: Uri): Thenable<Uint8Array>;
		/**
		 * Write data to a file, replacing its entire contents.
		 *
		 * @param uri The uri of the file.
		 * @param content The new content of the file.
		 */
constructor(uri: Uri, content: Uint8Array): Thenable<void>;
		/**
		 * Delete a file.
		 *
		 * @param uri The resource that is to be deleted.
...
constructor(uri: Uri, options?: {
		 ...
		 * @param options Defines if existing files should be overwritten.
		 */
constructor(source: Uri, target: Uri, options?: {
			/**
			 * Overwrite the file if it does exist.
			 */
			overwrite?: boolean;
...
constructor(source: Uri, target: Uri, options?: {
		 ...
		 */
constructor(scheme: string): boolean | undefined;
	}
	/**
	...
	export interface Webview {
		 ...
		 */
constructor(message: any): Thenable<boolean>;
		/**
		 ...
		 * ```
		 */
constructor(localResource: Uri): Uri;
		/**
	...
	export interface WebviewPanel {
		 ...
		 */
constructor(viewColumn?: ViewColumn, preserveFocus?: boolean): void;
		/**
...
constructor(): any;
	...
	export interface WebviewPanelSerializer<T = unknown> {
		 ...
		 */
constructor(webviewPanel: WebviewPanel, state: T): Thenable<void>;
	}
	/**
...
constructor(preserveFocus?: boolean): void;
	...
	export interface WebviewViewProvider {
		 ...
		 */
constructor(webviewView: WebviewView, _context: WebviewViewResolveContext, token: CancellationToken): Thenable<void> | void;
	}
	/**
	...
	export interface CustomTextEditorProvider {
		 ...
		 */
constructor(document: TextDocument, webviewPanel: WebviewPanel, token: CancellationToken): Thenable<void> | void;
	}
	/**
...
constructor(): void;
	...
	export interface CustomDocumentEditEvent<T extends CustomDocument = CustomDocument> {
		 ...
		 */
constructor(): Thenable<void> | void;
		/**
...
constructor(): void;
	...
	export interface CustomReadonlyEditorProvider<T extends CustomDocument = CustomDocument> {
		 ...
		 */
constructor(uri: Uri, openContext: CustomDocumentOpenContext, token: CancellationToken): Thenable<T> | T;
		/**
		 ...
		 */
constructor(document: T, webviewPanel: WebviewPanel, token: CancellationToken): Thenable<void> | void;
	}
	/**
	...
	export interface CustomEditorProvider<T extends CustomDocument = CustomDocument> extends CustomReadonlyEditorProvider<T> {
		 ...
		 */
constructor(document: T, cancellation: CancellationToken): Thenable<void>;
		/**
		 ...
		 * @returns Thenable signaling that saving has completed.
		 */
constructor(document: T, destination: Uri, cancellation: CancellationToken): Thenable<void>;
		/**
...
constructor(document: T, cancellation: CancellationToken): Thenable<void>;
		 ...
		 */
constructor(document: T, _context: CustomDocumentBackupContext, cancellation: CancellationToken): Thenable<CustomDocumentBackup>;
	}
	/**
	...
	export interface Clipboard {
		 ...
		 */
constructor(): Thenable<string>;
		/**
		 * Writes text into the clipboard.
		 * @returns A thenable that resolves when writing happened.
		 */
constructor(value: string): Thenable<void>;
	}
	/**
	...
	export namespace commands {
		 ...
		 * @returns Disposable which unregisters this command on disposal.
		 */
		export function registerTextEditorCommand(command: string, _callback: (textEditor: TextEditor, edit: TextEditorEdit, ...args: any[]) => void, thisArg?: any): Disposable;
		/**
	...
	export interface UriHandler {
		 ...
		 * @see {@link window.registerUriHandler}.
		 */
constructor(uri: Uri): ProviderResult<void>;
	}
	/**
	...
	export interface DataTransferFile {
		 ...
		 */
constructor(): Thenable<Uint8Array>;
	}
	/**
...
constructor(): Thenable<string>;
		 ...
		 */
constructor(): DataTransferFile | undefined;
		/**
...
constructor(value: any);
	...
	export class DataTransfer implements Iterable<[mimeType: string, item: DataTransferItem]> {
		 ...
		 */
constructor(mimeType: string): DataTransferItem | undefined;
		/**
		 ...
		 */
constructor(mimeType: string, value: DataTransferItem): void;
		/**
		 ...
		 * @param thisArg The `this` context used when invoking the handler function.
		 */
constructor(callbackfn: (item: DataTransferItem, mimeType: string, dataTransfer: DataTransfer) => void, thisArg?: any): void;
		/**
...
constructor(element: T, options?: {
	...
	export interface TreeDataProvider<T> {
		 ...
		 */
constructor(element: T): TreeItem | Thenable<TreeItem>;
		/**
		 ...
		 */
constructor(element?: T): ProviderResult<T[]>;
		/**
...
constructor(resourceUri: Uri, collapsibleState?: TreeItemCollapsibleState);
	...
	export interface Pseudoterminal {
		 ...
		 */
constructor(initialDimensions: TerminalDimensions | undefined): void;
		/**
...
constructor(): void;
	...
	export interface EnvironmentVariableCollection extends Iterable<[variable: string, mutator: EnvironmentVariableMutator]> {
		 ...
		 */
constructor(variable: string, value: string, options?: EnvironmentVariableMutatorOptions): void;
		/**
...
constructor(variable: string, value: string, options?: EnvironmentVariableMutatorOptions): void;
		 ...
		 */
constructor(variable: string): EnvironmentVariableMutator | undefined;
		/**
		 ...
		 * @param thisArg The `this` context used when invoking the handler function.
		 */
constructor(_callback: (variable: string, mutator: EnvironmentVariableMutator, collection: EnvironmentVariableCollection) => any, thisArg?: any): void;
		/**
		 * Deletes this collection's mutator for a variable.
		 *
		 * @param variable The variable to delete the mutator for.
		 */
constructor(variable: string): void;
		/**
...
constructor(): void;
	...
	export interface GlobalEnvironmentVariableCollection extends EnvironmentVariableCollection {
		 ...
		 */
constructor(scope: EnvironmentVariableScope): EnvironmentVariableCollection;
	}
	/**
...
constructor(): void;
	...
	export interface TextDocumentWillSaveEvent {
		 ...
		 */
constructor(thenable: Thenable<readonly TextEdit[]>): void;
		/**
		 ...
		 */
constructor(thenable: Thenable<any>): void;
	}
	/**
	...
	export interface FileWillCreateEvent {
		 ...
		 * @param thenable A thenable that delays saving.
		 */
constructor(thenable: Thenable<WorkspaceEdit>): void;
		/**
...
constructor(thenable: Thenable<any>): void;
	...
	export interface ConfigurationChangeEvent {
		 ...
		 */
constructor(section: string, scope?: ConfigurationScope): boolean;
	}
	/**
	...
	export interface NotebookEditor {
		 ...
		 * @param revealType The scrolling strategy for revealing `range`.
		 */
constructor(range: NotebookRange, revealType?: NotebookEditorRevealType): void;
	}
	/**
	...
	export interface NotebookRendererMessaging {
		 ...
		 */
constructor(message: any, editor?: NotebookEditor): Thenable<boolean>;
	}
	/**
	...
	export interface NotebookDocument {
		 ...
		 */
constructor(index: number): NotebookCell;
		/**
		 ...
		 */
constructor(range?: NotebookRange): NotebookCell[];
		/**
...
constructor(cells: NotebookCellData[]);
	...
	export interface NotebookSerializer {
		 ...
		 */
constructor(content: Uint8Array, token: CancellationToken): NotebookData | Thenable<NotebookData>;
		/**
		 ...
		 * @returns An array of bytes or a thenable that resolves to such.
		 */
constructor(data: NotebookData, token: CancellationToken): Uint8Array | Thenable<Uint8Array>;
	}
	/**
	...
	export interface NotebookController {
		 ...
		 */
constructor(cell: NotebookCell): NotebookCellExecution;
		/**
		 ...
		 */
constructor(notebook: NotebookDocument, affinity: NotebookControllerAffinity): void;
		/**
		 * Dispose and free associated resources.
		 */
constructor(): void;
	...
	export interface NotebookCellExecution {
		 ...
		 */
constructor(startTime?: number): void;
		/**
		 ...
		 */
constructor(success: boolean | undefined, endTime?: number): void;
		/**
		 ...
		 */
constructor(cell?: NotebookCell): Thenable<void>;
		/**
		 ...
		 * @returns A thenable that resolves when the operation finished.
		 */
constructor(out: NotebookCellOutput | readonly NotebookCellOutput[], cell?: NotebookCell): Thenable<void>;
		/**
...
constructor(out: NotebookCellOutput | readonly NotebookCellOutput[], cell?: NotebookCell): Thenable<void>;
		 ...
		 * @returns A thenable that resolves when the operation finished.
		 */
constructor(items: NotebookCellOutputItem | readonly NotebookCellOutputItem[], output: NotebookCellOutput): Thenable<void>;
		/**
...
constructor(text: string, alignment: NotebookCellStatusBarAlignment);
	...
	export interface NotebookCellStatusBarItemProvider {
		 ...
		 */
constructor(cell: NotebookCell, token: CancellationToken): ProviderResult<NotebookCellStatusBarItem | NotebookCellStatusBarItem[]>;
	}
	/**
...
constructor(): void;
	...
	export interface SourceControl {
		 ...
		 */
constructor(id: string, label: string): SourceControlResourceGroup;
		/**
...
constructor(): void;
	...
	export interface DebugSession {
		 ...
		 */
constructor(command: string, args?: any): Thenable<any>;
		/**
		 ...
		 */
constructor(breakpoint: Breakpoint): Thenable<DebugProtocolBreakpoint | undefined>;
	}
	/**
...
constructor(path: string);
	...
	export interface DebugAdapter extends Disposable {
		 ...
		 */
constructor(message: DebugProtocolMessage): void;
	}
	/**
...
constructor(implementation: DebugAdapter);
	...
	export interface DebugAdapterDescriptorFactory {
		 ...
		 */
constructor(session: DebugSession, executable: DebugAdapterExecutable | undefined): ProviderResult<DebugAdapterDescriptor>;
	}
	/**
	...
	export interface DebugAdapterTrackerFactory {
		 ...
		 */
constructor(session: DebugSession): ProviderResult<DebugAdapterTracker>;
	}
	/**
...
constructor(): void;
	...
	export interface CommentingRangeProvider {
		 ...
		 */
constructor(document: TextDocument, token: CancellationToken): ProviderResult<Range[] | CommentingRanges>;
	}
	/**
	...
	export interface CommentController {
		 ...
		 */
constructor(uri: Uri, range: Range, comments: readonly Comment[]): CommentThread;
		/**
...
constructor(): void;
	...
	export interface AuthenticationProvider {
		 ...
		 */
constructor(scopes: readonly string[] | undefined, options: AuthenticationProviderSessionOptions): Thenable<AuthenticationSession[]>;
		/**
		 ...
		 */
constructor(scopes: readonly string[], options: AuthenticationProviderSessionOptions): Thenable<AuthenticationSession>;
		/**
		 ...
		 */
constructor(sessionId: string): Thenable<void>;
	}
	/**
...
constructor(): void;
	...
	export interface TestController {
		 ...
		 */
constructor(label: string, kind: TestRunProfileKind, runHandler: (request: TestRunRequest, token: CancellationToken) => Thenable<void> | void, isDefault?: boolean, tag?: TestTag, supportsContinuousRun?: boolean): TestRunProfile;
		/**
		 ...
		 */
constructor(request: TestRunRequest, name?: string, persist?: boolean): TestRun;
		/**
		 ...
		 */
constructor(id: string, label: string, uri?: Uri): TestItem;
		/**
		 ...
		 */
constructor(items?: TestItem | readonly TestItem[]): void;
		/**
...
constructor(include?: readonly TestItem[], exclude?: readonly TestItem[], profile?: TestRunProfile, continuous?: boolean, preserveFocus?: boolean);
	...
	export interface TestRun {
		 ...
		 */
constructor(test: TestItem): void;
		/**
...
constructor(test: TestItem): void;
		 ...
		 */
constructor(test: TestItem, message: TestMessage | readonly TestMessage[], duration?: number): void;
		/**
...
constructor(test: TestItem, message: TestMessage | readonly TestMessage[], duration?: number): void;
		 ...
		 * @param duration How long the test took to execute, in milliseconds.
		 */
constructor(test: TestItem, duration?: number): void;
		/**
		 ...
		 */
constructor(output: string, location?: Location, test?: TestItem): void;
		/**
		 * Adds coverage for a file in the run.
		 */
constructor(fileCoverage: FileCoverage): void;
		/**
...
constructor(): void;
	...
	export interface TestItemCollection extends Iterable<[id: string, testItem: TestItem]> {
		 ...
		 */
constructor(items: readonly TestItem[]): void;
		/**
		 * Iterate over each entry in this collection.
		 *
		 * @param callback Function to execute for each entry.
		 * @param thisArg The `this` context used when invoking the handler function.
		 */
constructor(_callback: (item: TestItem, collection: TestItemCollection) => unknown, thisArg?: any): void;
		/**
		 * Adds the test item to the children. If an item with the same ID already
		 * exists, it'll be replaced.
		 * @param item Item to add.
		 */
constructor(item: TestItem): void;
		/**
		 * Removes a single test item from the collection.
		 * @param itemId Item ID to delete.
		 */
constructor(itemId: string): void;
		/**
		 * Efficiently gets a test item by ID, if it exists, in the children.
		 * @param itemId Item ID to get.
		 * @returns The found item or undefined if it does not exist.
		 */
constructor(itemId: string): TestItem | undefined;
	}
	/**
...
constructor();
	...
	export interface TabGroups {
		 ...
		 */
constructor(tab: Tab | readonly Tab[], preserveFocus?: boolean): Thenable<boolean>;
		/**
		 ...
		 */
constructor(tabGroup: TabGroup | readonly TabGroup[], preserveFocus?: boolean): Thenable<boolean>;
	}
	/**
...
constructor(value: T);
	...
	export interface TelemetryLogger {
		 ...
		 */
constructor(eventName: string, data?: Record<string, any | TelemetryTrustedValue>): void;
		/**
		 * Log an error event.
		 *
...
constructor(eventName: string, data?: Record<string, any | TelemetryTrustedValue>): void;
		 ...
		 */
constructor(_error: Error, data?: Record<string, any | TelemetryTrustedValue>): void;
		/**
		 * Dispose this object and free resources.
		 */
constructor(): void;
	...
	export interface TelemetrySender {
		 ...
		 */
constructor(eventName: string, data?: Record<string, any>): void;
		/**
		 ...
		 */
constructor(_error: Error, data?: Record<string, any>): void;
		/**
	...
	export interface ChatFollowupProvider {
		 ...
		 * @param token A cancellation token.
		 */
constructor(result: ChatResult, _context: ChatContext, token: CancellationToken): ProviderResult<ChatFollowup[]>;
	}
	/**
	 * A chat request handler is a callback that will be invoked when a request is made to a chat participant.
	 */
	export type ChatRequestHandler = (request: ChatRequest, _context: ChatContext, response: ChatResponseStream, token: CancellationToken) => ProviderResult<ChatResult | void>;
	/**
...
constructor(): void;
	...
	export interface ChatResponseStream {
		 ...
		 */
constructor(value: string | MarkdownString): void;
		/**
		 ...
		 */
constructor(value: Uri | Location, title?: string): void;
		/**
		 ...
		 */
constructor(command: Command): void;
		/**
		 ...
		 */
constructor(value: ChatResponseFileTree[], baseUri: Uri): void;
		/**
...
constructor(value: string): void;
		 ...
		 */
constructor(value: Uri | Location, iconPath?: IconPath): void;
		/**
		 * Pushes a part to this stream.
		 *
		 * @param part A response part, rendered or metadata
		 */
constructor(part: ChatResponsePart): void;
	}
	/**
...
constructor(role: LanguageModelChatMessageRole, content: string | Array<LanguageModelTextPart | LanguageModelToolResultPart | LanguageModelToolCallPart>, name?: string);
	...
	export interface LanguageModelChat {
		 ...
		 */
constructor(messages: LanguageModelChatMessage[], options?: LanguageModelChatRequestOptions, token?: CancellationToken): Thenable<LanguageModelChatResponse>;
		/**
		 ...
		 */
constructor(text: string | LanguageModelChatMessage, token?: CancellationToken): Thenable<number>;
	}
	/**
...
constructor(token: CancellationToken): ProviderResult<T[]>;
	...
	export interface LanguageModelAccessInformation {
		 ...
		 */
constructor(chat: LanguageModelChat): boolean | undefined;
	}
	/**
...
constructor(content: Array<LanguageModelTextPart | LanguageModelPromptTsxPart>);
	...
	export interface LanguageModelToolTokenizationOptions {
		 ...
		 * @returns A thenable that resolves to the number of tokens.
		 */
constructor(text: string, token?: CancellationToken): Thenable<number>;
	}
	/**
	...
	export interface LanguageModelTool<T> {
		 ...
		 */
constructor(options: LanguageModelToolInvocationOptions<T>, token: CancellationToken): ProviderResult<LanguageModelToolResult>;
		/**
