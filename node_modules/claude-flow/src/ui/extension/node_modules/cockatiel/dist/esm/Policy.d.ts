...
constructor(options: Readonly<IBasePolicyOptions>);
     ...
     * ```
     */
filterEvents(predicate: (error: Error) => boolean): Policy;
    /**
     ...
     * ```
     */
filterEvents(predicate: (r: unknown) => boolean): Policy;
    /**
     * Adds handling for return values. The predicate will be called with
     * the return value of the executed function,
     *
 ...
 */
export declare function handleWhenResult(predicate: (error) => boolean): Policy;
/**
 ...
 * class Database {
 *   @usePolicy(retry)
 *   public getUserInfo(userId, _context, cancellationToken) {
