...
constructor(options: net.NetConnectOpts, cb?: Function): net.Socket;
constructor(_req: http.IncomingMessage, options: http.RequestOptions, cb: Function): void;
constructor(): AgentKeepAlive.AgentStatus;
}
interface Constants {
  CURRENT_ID: Symbol;
  CREATE_ID: Symbol;
