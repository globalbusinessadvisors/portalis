...
constructor(req: CloseProject): void;
                private closeWatchers;
constructor(req: DiscoverTypings): void;
...
constructor(path: string, callback: FileWatcherCallback, pollingInterval?: number, options?: WatchOptions): FileWatcher;
constructor(path: string, callback: DirectoryWatcherCallback, recursive?: boolean, options?: WatchOptions): FileWatcher;
            preferNonRecursiveWatch?: boolean;
constructor(callback: (...args: any[]) => void, ms: number, ...args: any[]): any;
constructor(timeoutId: any): void;
constructor(callback: (...args: any[]) => void, ...args: any[]): any;
constructor(timeoutId: any): void;
            gc?(): void;
            trace?(s: string): void;
...
constructor(options: InstallPackageOptionsWithProject): Promise<ApplyCodeActionCommandResult>;
constructor(p: Project, typeAcquisition: TypeAcquisition, unresolvedImports: SortedReadonlyArray<string> | undefined): void;
constructor(projectService: ProjectService): void;
constructor(p: Project): void;
        ...
        interface Logger {
constructor(): void;
constructor(level: LogLevel): boolean;
constructor(): boolean;
constructor(s: string): void;
constructor(s: string): void;
constructor(): void;
constructor(): void;
constructor(s: string, type?: Msg): void;
...
constructor(path: NormalizedPath): T | undefined;
constructor(path: NormalizedPath, value: T): void;
constructor(path: NormalizedPath): boolean;
constructor(path: NormalizedPath): void;
        }
...
constructor(): boolean;
constructor(newText: string | undefined): void;
constructor(fileExists?: boolean): void;
constructor(): IScriptSnapshot;
            private ensureRealPath;
constructor(): FormatCodeSettings | undefined;
constructor(): protocol.UserPreferences | undefined;
constructor(project: Project): boolean;
constructor(project: Project): boolean;
constructor(project: Project): void;
constructor(): void;
constructor(): Project;
constructor(): void;
constructor(formatSettings: FormatCodeSettings, preferences: protocol.UserPreferences | undefined): void;
constructor(): string;
constructor(fileName: string): void;
constructor(tempFileName?: NormalizedPath): boolean;
constructor(start: number, end: number, newText: string): void;
constructor(): void;
constructor(): boolean;
            /**
             *  @param line 1 based index
             */
constructor(line: number): TextSpan;
            /**
             * @param line 1 based index
             * @param offset 1 based index
             */
constructor(line: number, offset: number): number;
constructor(position: number): protocol.Location;
constructor(): boolean;
        }
...
constructor(createInfo: PluginCreateInfo): LanguageService;
...
constructor(name: string): boolean;
constructor(options: InstallPackageOptions): Promise<ApplyCodeActionCommandResult>;
constructor(): CompilerOptions;
constructor(): CompilerOptions;
constructor(): string;
constructor(): string;
constructor(): readonly ProjectReference[] | undefined;
constructor(): string[];
            private getOrCreateScriptInfoAndAttachToProject;
constructor(fileName: string): ScriptKind;
constructor(filename: string): string;
constructor(filename: string): IScriptSnapshot | undefined;
constructor(): HostCancellationToken;
constructor(): string;
constructor(): string;
constructor(): boolean;
constructor(path: string, extensions?: readonly string[], exclude?: readonly string[], include?: readonly string[], depth?: number): string[];
constructor(fileName: string): string | undefined;
constructor(fileName: string, content: string): void;
constructor(file: string): boolean;
constructor(path: string): boolean;
...
constructor(): readonly Diagnostic[];
             ...
             */
constructor(): readonly Diagnostic[];
constructor(projectErrors: Diagnostic[] | undefined): void;
constructor(ensureSynchronized?: boolean): LanguageService;
constructor(scriptInfo: ScriptInfo): string[];
            /**
             * Returns true if emit was conducted
             */
constructor(scriptInfo: ScriptInfo, writeFile: (path: string, data: string, writeByteOrderMark?: boolean) => void): EmitResult;
constructor(): void;
constructor(lastFileExceededProgramSize?: string): void;
constructor(): string;
            protected removeLocalTypingsFromTypeAcquisition(newTypeAcquisition: TypeAcquisition): TypeAcquisition;
constructor(updateLevel?: ProgramUpdateLevel): SortedReadonlyArray<string>;
constructor(path: Path): SourceFile | undefined;
constructor(): void;
...
constructor(): ScriptInfo[];
constructor(): readonly NormalizedPath[];
constructor(excludeFilesFromExternalLibraries?: boolean, excludeConfigFiles?: boolean): NormalizedPath[];
constructor(configFilePath: NormalizedPath): boolean;
constructor(info: ScriptInfo): boolean;
constructor(filename: NormalizedPath, requireOpen?: boolean): boolean;
constructor(info: ScriptInfo): boolean;
constructor(info: ScriptInfo, fileName?: NormalizedPath): void;
constructor(fileName: NormalizedPath): void;
constructor(info: ScriptInfo, fileExists: boolean, detachFromProject: boolean): void;
constructor(fileName: string): void;
            /**
...
constructor(fileName: NormalizedPath): ScriptInfo | undefined;
constructor(uncheckedFileName: string): ScriptInfo | undefined;
constructor(writeProjectFileNames: boolean): string;
            private filesToStringWorker;
constructor(compilerOptions: CompilerOptions): void;
constructor(newTypeAcquisition: TypeAcquisition | undefined): void;
constructor(): TypeAcquisition;
...
constructor(isJsInferredProject: boolean): void;
constructor(options?: CompilerOptions): void;
            /** this is canonical project root path */
            readonly projectRootPath: string | undefined;
constructor(info: ScriptInfo): void;
constructor(info: ScriptInfo): void;
constructor(): boolean;
constructor(): void;
constructor(): TypeAcquisition;
...
constructor(): NormalizedPath;
constructor(): readonly ProjectReference[] | undefined;
constructor(refs: readonly ProjectReference[] | undefined): void;
            /**
             * Get the errors that dont have any file name associated
             */
constructor(): readonly Diagnostic[];
             ...
             */
constructor(): readonly Diagnostic[];
constructor(projectErrors: Diagnostic[]): void;
constructor(): void;
constructor(): string[];
        }
        /**
...
constructor(fileName: string): Path;
            private loadTypesMap;
constructor(response: SetTypings | InvalidateCachedTypings | PackageInstalledResponse): void;
            private delayUpdateProjectGraph;
            private delayUpdateProjectGraphs;
constructor(projectCompilerOptions: protocol.InferredProjectCompilerOptions, projectRootPath?: string): void;
constructor(projectName: string): Project | undefined;
constructor(fileName: NormalizedPath, ensureProject: boolean): Project | undefined;
            private tryGetDefaultProjectForEnsuringConfiguredProjectForFile;
            private doEnsureDefaultProjectForFile;
constructor(uncheckedFileName: string): ScriptInfo | undefined;
            private ensureProjectStructuresUptoDate;
constructor(file: NormalizedPath): FormatCodeSettings;
constructor(file: NormalizedPath): protocol.UserPreferences;
constructor(): FormatCodeSettings;
constructor(): protocol.UserPreferences;
...
constructor(fileName: NormalizedPath, openedByClient: boolean, fileContent?: string, scriptKind?: ScriptKind, hasMixedContent?: boolean, hostToQueryFileExistsOn?: {
constructor(path: string): boolean;
             ...
             */
constructor(fileName: NormalizedPath): ScriptInfo | undefined;
constructor(fileName: Path): ScriptInfo | undefined;
            private addSourceInfoToSourceMap;
            private addMissingSourceMapFile;
constructor(args: protocol.ConfigureRequestArguments): void;
...
constructor(): void;
             ...
             */
constructor(fileName: string, fileContent?: string, scriptKind?: ScriptKind, projectRootPath?: string): OpenConfiguredProjectResult;
...
constructor(fileName: NormalizedPath, fileContent?: string, scriptKind?: ScriptKind, hasMixedContent?: boolean, projectRootPath?: NormalizedPath): OpenConfiguredProjectResult;
             ...
             * @param filename is absolute pathname
             */
constructor(uncheckedFileName: string): void;
            private collectChanges;
constructor(uncheckedFileName: string): void;
constructor(projects: protocol.ExternalProject[]): void;
            private static readonly filenameEscapeRegexp;
            private static escapeFilenameForRegex;
constructor(): void;
constructor(proj: protocol.ExternalProject): NormalizedPath[];
            private applySafeListWorker;
constructor(proj: protocol.ExternalProject): void;
constructor(): boolean;
            private endEnablePlugin;
            private enableRequestedPluginsAsync;
            private enableRequestedPluginsWorker;
constructor(args: protocol.ConfigurePluginRequestArguments): void;
...
constructor(requestId: number): void;
constructor(requestId: number): void;
        }
...
constructor(err: Error, cmd: string): void;
            private logErrorWorker;
constructor(msg: protocol.Message): void;
...
constructor(): void;
            ...
            private handlers;
constructor(command: string, handler: (request: protocol.Request) => HandlerResponse): void;
            private setCurrentRequest;
            private resetCurrentRequest;
            executeWithRequestId<T>(requestId: number, f: () => T): T;
constructor(request: protocol.Request): HandlerResponse;
constructor(message: TMessage): void;
...
constructor(path: string): boolean;
constructor(fileName: string): boolean;
constructor(path: string, encoding?: string): string | undefined;
constructor(rootDir: string, extensions: readonly string[], excludes: readonly string[] | undefined, includes: readonly string[] | undefined, depth?: number): string[];
        }
    }
...
constructor(sourceFile?: SourceFile): number;
constructor(index: number, sourceFile?: SourceFile): Node;
constructor(sourceFile?: SourceFile): readonly Node[];
constructor(sourceFile?: SourceFile, includeJsDocComment?: boolean): number;
constructor(): number;
constructor(): number;
constructor(sourceFile?: SourceFileLike): number;
constructor(): number;
constructor(sourceFile?: SourceFile): number;
constructor(sourceFile?: SourceFile): string;
constructor(sourceFile?: SourceFile): string;
constructor(sourceFile?: SourceFile): Node | undefined;
constructor(sourceFile?: SourceFile): Node | undefined;
    ...
    interface SourceFileLike {
constructor(pos: number): LineAndCharacter;
    }
...
constructor(line: number, character: number): number;
constructor(newText: string, textChangeRange: TextChangeRange): SourceFile;
    }
...
constructor(): CompilerOptions;
constructor(fileName: string): SourceFile | undefined;
constructor(path: Path): SourceFile | undefined;
constructor(): string;
    }
    interface ParseConfigHost extends ModuleResolutionHost {
        useCaseSensitiveFileNames: boolean;
constructor(rootDir: string, extensions: readonly string[], excludes: readonly string[] | undefined, includes: readonly string[], depth?: number): readonly string[];
        /**
...
constructor(): readonly string[];
         ...
         */
constructor(): readonly SourceFile[];
        /**
         ...
         */
constructor(targetSourceFile?: SourceFile, writeFile?: WriteFileCallback, cancellationToken?: CancellationToken, emitOnlyDtsFiles?: boolean, customTransformers?: CustomTransformers): EmitResult;
constructor(cancellationToken?: CancellationToken): readonly Diagnostic[];
constructor(cancellationToken?: CancellationToken): readonly Diagnostic[];
constructor(sourceFile?: SourceFile, cancellationToken?: CancellationToken): readonly DiagnosticWithLocation[];
        /** The first time this is called, it will return global diagnostics (no location). */
constructor(sourceFile?: SourceFile, cancellationToken?: CancellationToken): readonly Diagnostic[];
constructor(sourceFile?: SourceFile, cancellationToken?: CancellationToken): readonly DiagnosticWithLocation[];
constructor(): readonly Diagnostic[];
        /**
...
constructor(file: SourceFile): boolean;
constructor(file: SourceFile): boolean;
        /**
         ...
         * ```
         */
constructor(file: SourceFile, usage: StringLiteralLike): ResolutionMode;
        /**
         ...
         * ```
         */
constructor(file: SourceFile, index: number): ResolutionMode;
constructor(): readonly ProjectReference[] | undefined;
constructor(): readonly (ResolvedProjectReference | undefined)[] | undefined;
    }
...
constructor(node: SourceFile): SourceFile;
constructor(node: Bundle): Bundle;
    }
...
constructor(symbol: Symbol, node: Node): Type;
constructor(symbol: Symbol): Type;
constructor(symbol: Symbol): Type;
constructor(type: Type): Symbol[];
constructor(type: Type, propertyName: string): Symbol | undefined;
constructor(leftType: Type, name: string, location: Node): Symbol | undefined;
constructor(type: Type, kind: IndexKind): IndexInfo | undefined;
constructor(type: Type): readonly IndexInfo[];
        getIndexInfosOfIndexSymbol: (indexSymbol: Symbol, siblingSymbols?: Symbol[] | undefined) => IndexInfo[];
constructor(type: Type, kind: SignatureKind): readonly Signature[];
constructor(type: Type, kind: IndexKind): Type | undefined;
constructor(type: InterfaceType): BaseType[];
...
constructor(type: Type): Type;
         ...
         */
constructor(type: Type): Type | undefined;
constructor(signature: Signature): Type;
constructor(type: Type, flags: TypeFlags): Type;
constructor(type: Type): Type;
constructor(type: TypeReference): readonly Type[];
        /** Note that the resulting nodes cannot be checked. */
constructor(type: Type, enclosingDeclaration: Node | undefined, flags: NodeBuilderFlags | undefined): TypeNode | undefined;
        /** Note that the resulting nodes cannot be checked. */
constructor(signature: Signature, kind: SyntaxKind, enclosingDeclaration: Node | undefined, flags: NodeBuilderFlags | undefined):
            | SignatureDeclaration & {
                typeArguments?: NodeArray<TypeNode>;
            }
            | undefined;
        /** Note that the resulting nodes cannot be checked. */
constructor(indexInfo: IndexInfo, enclosingDeclaration: Node | undefined, flags: NodeBuilderFlags | undefined): IndexSignatureDeclaration | undefined;
        /** Note that the resulting nodes cannot be checked. */
constructor(symbol: Symbol, meaning: SymbolFlags, enclosingDeclaration: Node | undefined, flags: NodeBuilderFlags | undefined): EntityName | undefined;
        /** Note that the resulting nodes cannot be checked. */
constructor(symbol: Symbol, meaning: SymbolFlags, enclosingDeclaration: Node | undefined, flags: NodeBuilderFlags | undefined): Expression | undefined;
        /** Note that the resulting nodes cannot be checked. */
constructor(symbol: Symbol, enclosingDeclaration: Node | undefined, flags: NodeBuilderFlags | undefined): NodeArray<TypeParameterDeclaration> | undefined;
        /** Note that the resulting nodes cannot be checked. */
constructor(symbol: Symbol, enclosingDeclaration: Node | undefined, flags: NodeBuilderFlags | undefined): ParameterDeclaration | undefined;
        /** Note that the resulting nodes cannot be checked. */
constructor(parameter: TypeParameter, enclosingDeclaration: Node | undefined, flags: NodeBuilderFlags | undefined): TypeParameterDeclaration | undefined;
constructor(location: Node, meaning: SymbolFlags): Symbol[];
constructor(node: Node): Symbol | undefined;
constructor(parameter: ParameterDeclaration, parameterName: string): Symbol[];
        /**
         * The function returns the value (local variable) symbol of an identifier in the short-hand property assignment.
         * This is necessary as an identifier in short-hand property assignment can contains two meaning: property name and property value.
         */
constructor(location: Node | undefined): Symbol | undefined;
constructor(location: ExportSpecifier | Identifier): Symbol | undefined;
        /**
         ...
         */
constructor(symbol: Symbol): Symbol;
constructor(location: Identifier): Symbol | undefined;
constructor(pattern: AssignmentPattern): Type;
constructor(node: Node): Type;
constructor(node: TypeNode): Type;
constructor(signature: Signature, enclosingDeclaration?: Node, flags?: TypeFormatFlags, kind?: SignatureKind): string;
constructor(type: Type, enclosingDeclaration?: Node, flags?: TypeFormatFlags): string;
constructor(symbol: Symbol, enclosingDeclaration?: Node, meaning?: SymbolFlags, flags?: SymbolFormatFlags): string;
filterEvents(predicate: TypePredicate, enclosingDeclaration?: Node, flags?: TypeFormatFlags): string;
constructor(symbol: Symbol): string;
constructor(type: Type): Symbol[];
constructor(symbol: Symbol): readonly Symbol[];
constructor(node: Node, allowDeclaration: boolean): Symbol | undefined;
constructor(node: Expression): Type | undefined;
        /**
         * returns unknownSignature in the case of an error.
         * returns undefined if the node is not valid.
         * @param argumentCount Apparent number of arguments, passed in case of a possibly incomplete call. This should come from an ArgumentListInfo. See `signatureHelp.ts`.
         */
constructor(node: CallLikeExpression, candidatesOutArray?: Signature[], argumentCount?: number): Signature | undefined;
constructor(declaration: SignatureDeclaration): Signature | undefined;
constructor(node: SignatureDeclaration): boolean | undefined;
constructor(symbol: Symbol): boolean;
constructor(symbol: Symbol): boolean;
constructor(symbol: Symbol): boolean;
constructor(symbol: Symbol): Symbol;
constructor(node: EnumMember | PropertyAccessExpression | ElementAccessExpression): string | number | undefined;
constructor(node: PropertyAccessExpression | QualifiedName | ImportTypeNode, propertyName: string): boolean;
        /** Follow all aliases to get the original symbol. */
constructor(symbol: Symbol): Symbol;
        /** Follow a *single* alias to get the immediately aliased symbol. */
constructor(symbol: Symbol): Symbol | undefined;
constructor(moduleSymbol: Symbol): Symbol[];
constructor(location: Node): Symbol[];
constructor(node: ParameterDeclaration): boolean;
constructor(): Symbol[];
constructor(memberName: string, moduleSymbol: Symbol): Symbol | undefined;
constructor(type: Type): Type;
constructor(type: Type): Type | undefined;
constructor(type: Type): Type | undefined;
        /**
...
constructor(): Type;
constructor(): Type;
constructor(value: string): StringLiteralType;
constructor(): Type;
constructor(value: number): NumberLiteralType;
constructor(): Type;
constructor(value: PseudoBigInt): BigIntLiteralType;
constructor(): Type;
constructor(): Type;
constructor(): Type;
constructor(): Type;
...
constructor(): Type;
         ...
         * ```
         */
constructor(source: Type, target: Type): boolean;
        /**
...
constructor(type: Type): boolean;
         ...
         */
constructor(type: Type): boolean;
constructor(name: string, location: Node | undefined, meaning: SymbolFlags, excludeGlobals: boolean): Symbol | undefined;
constructor(signature: Signature): TypePredicate | undefined;
        /**
...
constructor(signature: Signature): readonly Type[] | undefined;
    }
...
constructor(): string;
constructor(): Declaration[] | undefined;
constructor(typeChecker: TypeChecker | undefined): SymbolDisplayPart[];
constructor(checker?: TypeChecker): JSDocTagInfo[];
    }
...
constructor(): Symbol[];
constructor(propertyName: string): Symbol | undefined;
constructor(): Symbol[];
constructor(): readonly Signature[];
constructor(): readonly Signature[];
...
constructor(): Type | undefined;
constructor(): Type | undefined;
constructor(): this is UnionType;
constructor(): this is IntersectionType;
constructor(): this is UnionOrIntersectionType;
constructor(): this is LiteralType;
constructor(): this is StringLiteralType;
constructor(): this is NumberLiteralType;
constructor(): this is TypeParameter;
constructor(): this is InterfaceType;
constructor(): this is InterfaceType;
constructor(): this is IndexType;
    }
    ...
    interface Signature {
constructor(): SignatureDeclaration;
constructor(): TypeParameter[] | undefined;
constructor(): Symbol[];
constructor(pos: number): Type;
constructor(): Type;
constructor(typeChecker: TypeChecker | undefined): SymbolDisplayPart[];
constructor(): JSDocTagInfo[];
    }
    enum IndexKind {
        String = 0,
        Number = 1,
...
constructor(fileName: string, languageVersionOrOptions: ScriptTarget | CreateSourceFileOptions, onError?: (message: string) => void, shouldCreateNewSourceFile?: boolean): SourceFile | undefined;
        getSourceFileByPath?(fileName: string, path: Path, languageVersionOrOptions: ScriptTarget | CreateSourceFileOptions, onError?: (message: string) => void, shouldCreateNewSourceFile?: boolean): SourceFile | undefined;
        getCancellationToken?(): CancellationToken;
constructor(options: CompilerOptions): string;
...
constructor(value: string | number, numericLiteralFlags?: TokenFlags): NumericLiteral;
constructor(value: string | PseudoBigInt): BigIntLiteral;
constructor(text: string, isSingleQuote?: boolean): StringLiteral;
constructor(sourceNode: PropertyNameLiteral | PrivateIdentifier, isSingleQuote?: boolean): StringLiteral;
constructor(text: string): RegularExpressionLiteral;
constructor(text: string): Identifier;
        /**
         ...
         */
constructor(recordTempVariable: ((node: Identifier) => void) | undefined, reservedInNestedScopes?: boolean): Identifier;
        /**
         ...
         * setting `EmitFlags.ReuseTempVariableScope` on the nested function itself.
         */
constructor(reservedInNestedScopes?: boolean): Identifier;
        /** Create a unique name based on the supplied text. */
constructor(text: string, flags?: GeneratedIdentifierFlags): Identifier;
        /** Create a unique name generated for a node. */
constructor(node: Node | undefined, flags?: GeneratedIdentifierFlags): Identifier;
constructor(text: string): PrivateIdentifier;
constructor(text?: string): PrivateIdentifier;
constructor(node: Node): PrivateIdentifier;
constructor(token: SyntaxKind.SuperKeyword): SuperExpression;
constructor(token: SyntaxKind.ThisKeyword): ThisExpression;
constructor(token: SyntaxKind.NullKeyword): NullLiteral;
constructor(token: SyntaxKind.TrueKeyword): TrueLiteral;
constructor(token: SyntaxKind.FalseKeyword): FalseLiteral;
constructor(token: SyntaxKind.EndOfFileToken): EndOfFileToken;
constructor(token: SyntaxKind.Unknown): Token<SyntaxKind.Unknown>;
...
constructor(): SuperExpression;
constructor(): ThisExpression;
constructor(): NullLiteral;
constructor(): TrueLiteral;
constructor(): FalseLiteral;
        createModifier<T extends ModifierSyntaxKind>(kind: T): ModifierToken<T>;
constructor(flags: ModifierFlags): Modifier[] | undefined;
constructor(left: EntityName, right: string | Identifier): QualifiedName;
constructor(node: QualifiedName, left: EntityName, right: Identifier): QualifiedName;
constructor(expression: Expression): ComputedPropertyName;
constructor(node: ComputedPropertyName, expression: Expression): ComputedPropertyName;
constructor(modifiers: readonly Modifier[] | undefined, name: string | Identifier, constraint?: TypeNode, defaultType?: TypeNode): TypeParameterDeclaration;
constructor(node: TypeParameterDeclaration, modifiers: readonly Modifier[] | undefined, name: Identifier, constraint: TypeNode | undefined, defaultType: TypeNode | undefined): TypeParameterDeclaration;
constructor(modifiers: readonly ModifierLike[] | undefined, dotDotDotToken: DotDotDotToken | undefined, name: string | BindingName, questionToken?: QuestionToken, type?: TypeNode, initializer?: Expression): ParameterDeclaration;
constructor(node: ParameterDeclaration, modifiers: readonly ModifierLike[] | undefined, dotDotDotToken: DotDotDotToken | undefined, name: string | BindingName, questionToken: QuestionToken | undefined, type: TypeNode | undefined, initializer: Expression | undefined): ParameterDeclaration;
constructor(expression: Expression): Decorator;
constructor(node: Decorator, expression: Expression): Decorator;
constructor(modifiers: readonly Modifier[] | undefined, name: PropertyName | string, questionToken: QuestionToken | undefined, type: TypeNode | undefined): PropertySignature;
constructor(node: PropertySignature, modifiers: readonly Modifier[] | undefined, name: PropertyName, questionToken: QuestionToken | undefined, type: TypeNode | undefined): PropertySignature;
constructor(modifiers: readonly ModifierLike[] | undefined, name: string | PropertyName, questionOrExclamationToken: QuestionToken | ExclamationToken | undefined, type: TypeNode | undefined, initializer: Expression | undefined): PropertyDeclaration;
constructor(node: PropertyDeclaration, modifiers: readonly ModifierLike[] | undefined, name: string | PropertyName, questionOrExclamationToken: QuestionToken | ExclamationToken | undefined, type: TypeNode | undefined, initializer: Expression | undefined): PropertyDeclaration;
constructor(modifiers: readonly Modifier[] | undefined, name: string | PropertyName, questionToken: QuestionToken | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined): MethodSignature;
constructor(node: MethodSignature, modifiers: readonly Modifier[] | undefined, name: PropertyName, questionToken: QuestionToken | undefined, typeParameters: NodeArray<TypeParameterDeclaration> | undefined, parameters: NodeArray<ParameterDeclaration>, type: TypeNode | undefined): MethodSignature;
constructor(modifiers: readonly ModifierLike[] | undefined, asteriskToken: AsteriskToken | undefined, name: string | PropertyName, questionToken: QuestionToken | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined, body: Block | undefined): MethodDeclaration;
constructor(node: MethodDeclaration, modifiers: readonly ModifierLike[] | undefined, asteriskToken: AsteriskToken | undefined, name: PropertyName, questionToken: QuestionToken | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined, body: Block | undefined): MethodDeclaration;
constructor(modifiers: readonly ModifierLike[] | undefined, parameters: readonly ParameterDeclaration[], body: Block | undefined): ConstructorDeclaration;
constructor(node: ConstructorDeclaration, modifiers: readonly ModifierLike[] | undefined, parameters: readonly ParameterDeclaration[], body: Block | undefined): ConstructorDeclaration;
constructor(modifiers: readonly ModifierLike[] | undefined, name: string | PropertyName, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined, body: Block | undefined): GetAccessorDeclaration;
constructor(node: GetAccessorDeclaration, modifiers: readonly ModifierLike[] | undefined, name: PropertyName, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined, body: Block | undefined): GetAccessorDeclaration;
constructor(modifiers: readonly ModifierLike[] | undefined, name: string | PropertyName, parameters: readonly ParameterDeclaration[], body: Block | undefined): SetAccessorDeclaration;
constructor(node: SetAccessorDeclaration, modifiers: readonly ModifierLike[] | undefined, name: PropertyName, parameters: readonly ParameterDeclaration[], body: Block | undefined): SetAccessorDeclaration;
constructor(typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined): CallSignatureDeclaration;
constructor(node: CallSignatureDeclaration, typeParameters: NodeArray<TypeParameterDeclaration> | undefined, parameters: NodeArray<ParameterDeclaration>, type: TypeNode | undefined): CallSignatureDeclaration;
constructor(typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined): ConstructSignatureDeclaration;
constructor(node: ConstructSignatureDeclaration, typeParameters: NodeArray<TypeParameterDeclaration> | undefined, parameters: NodeArray<ParameterDeclaration>, type: TypeNode | undefined): ConstructSignatureDeclaration;
constructor(modifiers: readonly ModifierLike[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode): IndexSignatureDeclaration;
constructor(node: IndexSignatureDeclaration, modifiers: readonly ModifierLike[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode): IndexSignatureDeclaration;
constructor(type: TypeNode, literal: TemplateMiddle | TemplateTail): TemplateLiteralTypeSpan;
constructor(node: TemplateLiteralTypeSpan, type: TypeNode, literal: TemplateMiddle | TemplateTail): TemplateLiteralTypeSpan;
constructor(body: Block): ClassStaticBlockDeclaration;
constructor(node: ClassStaticBlockDeclaration, body: Block): ClassStaticBlockDeclaration;
        createKeywordTypeNode<TKind extends KeywordTypeSyntaxKind>(kind: TKind): KeywordTypeNode<TKind>;
constructor(assertsModifier: AssertsKeyword | undefined, parameterName: Identifier | ThisTypeNode | string, type: TypeNode | undefined): TypePredicateNode;
constructor(node: TypePredicateNode, assertsModifier: AssertsKeyword | undefined, parameterName: Identifier | ThisTypeNode, type: TypeNode | undefined): TypePredicateNode;
constructor(typeName: string | EntityName, typeArguments?: readonly TypeNode[]): TypeReferenceNode;
constructor(node: TypeReferenceNode, typeName: EntityName, typeArguments: NodeArray<TypeNode> | undefined): TypeReferenceNode;
constructor(typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode): FunctionTypeNode;
constructor(node: FunctionTypeNode, typeParameters: NodeArray<TypeParameterDeclaration> | undefined, parameters: NodeArray<ParameterDeclaration>, type: TypeNode): FunctionTypeNode;
constructor(modifiers: readonly Modifier[] | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode): ConstructorTypeNode;
constructor(node: ConstructorTypeNode, modifiers: readonly Modifier[] | undefined, typeParameters: NodeArray<TypeParameterDeclaration> | undefined, parameters: NodeArray<ParameterDeclaration>, type: TypeNode): ConstructorTypeNode;
constructor(exprName: EntityName, typeArguments?: readonly TypeNode[]): TypeQueryNode;
constructor(node: TypeQueryNode, exprName: EntityName, typeArguments?: readonly TypeNode[]): TypeQueryNode;
constructor(members: readonly TypeElement[] | undefined): TypeLiteralNode;
constructor(node: TypeLiteralNode, members: NodeArray<TypeElement>): TypeLiteralNode;
constructor(elementType: TypeNode): ArrayTypeNode;
constructor(node: ArrayTypeNode, elementType: TypeNode): ArrayTypeNode;
constructor(elements: readonly (TypeNode | NamedTupleMember)[]): TupleTypeNode;
constructor(node: TupleTypeNode, elements: readonly (TypeNode | NamedTupleMember)[]): TupleTypeNode;
constructor(dotDotDotToken: DotDotDotToken | undefined, name: Identifier, questionToken: QuestionToken | undefined, type: TypeNode): NamedTupleMember;
constructor(node: NamedTupleMember, dotDotDotToken: DotDotDotToken | undefined, name: Identifier, questionToken: QuestionToken | undefined, type: TypeNode): NamedTupleMember;
constructor(type: TypeNode): OptionalTypeNode;
constructor(node: OptionalTypeNode, type: TypeNode): OptionalTypeNode;
constructor(type: TypeNode): RestTypeNode;
constructor(node: RestTypeNode, type: TypeNode): RestTypeNode;
constructor(types: readonly TypeNode[]): UnionTypeNode;
constructor(node: UnionTypeNode, types: NodeArray<TypeNode>): UnionTypeNode;
constructor(types: readonly TypeNode[]): IntersectionTypeNode;
constructor(node: IntersectionTypeNode, types: NodeArray<TypeNode>): IntersectionTypeNode;
constructor(checkType: TypeNode, extendsType: TypeNode, trueType: TypeNode, falseType: TypeNode): ConditionalTypeNode;
constructor(node: ConditionalTypeNode, checkType: TypeNode, extendsType: TypeNode, trueType: TypeNode, falseType: TypeNode): ConditionalTypeNode;
constructor(typeParameter: TypeParameterDeclaration): InferTypeNode;
constructor(node: InferTypeNode, typeParameter: TypeParameterDeclaration): InferTypeNode;
constructor(argument: TypeNode, attributes?: ImportAttributes, qualifier?: EntityName, typeArguments?: readonly TypeNode[], isTypeOf?: boolean): ImportTypeNode;
constructor(node: ImportTypeNode, argument: TypeNode, attributes: ImportAttributes | undefined, qualifier: EntityName | undefined, typeArguments: readonly TypeNode[] | undefined, isTypeOf?: boolean): ImportTypeNode;
constructor(type: TypeNode): ParenthesizedTypeNode;
constructor(node: ParenthesizedTypeNode, type: TypeNode): ParenthesizedTypeNode;
constructor(): ThisTypeNode;
constructor(operator: SyntaxKind.KeyOfKeyword | SyntaxKind.UniqueKeyword | SyntaxKind.ReadonlyKeyword, type: TypeNode): TypeOperatorNode;
constructor(node: TypeOperatorNode, type: TypeNode): TypeOperatorNode;
constructor(objectType: TypeNode, indexType: TypeNode): IndexedAccessTypeNode;
constructor(node: IndexedAccessTypeNode, objectType: TypeNode, indexType: TypeNode): IndexedAccessTypeNode;
constructor(readonlyToken: ReadonlyKeyword | PlusToken | MinusToken | undefined, typeParameter: TypeParameterDeclaration, nameType: TypeNode | undefined, questionToken: QuestionToken | PlusToken | MinusToken | undefined, type: TypeNode | undefined, members: NodeArray<TypeElement> | undefined): MappedTypeNode;
constructor(node: MappedTypeNode, readonlyToken: ReadonlyKeyword | PlusToken | MinusToken | undefined, typeParameter: TypeParameterDeclaration, nameType: TypeNode | undefined, questionToken: QuestionToken | PlusToken | MinusToken | undefined, type: TypeNode | undefined, members: NodeArray<TypeElement> | undefined): MappedTypeNode;
constructor(literal: LiteralTypeNode["literal"]): LiteralTypeNode;
constructor(node: LiteralTypeNode, literal: LiteralTypeNode["literal"]): LiteralTypeNode;
constructor(head: TemplateHead, templateSpans: readonly TemplateLiteralTypeSpan[]): TemplateLiteralTypeNode;
constructor(node: TemplateLiteralTypeNode, head: TemplateHead, templateSpans: readonly TemplateLiteralTypeSpan[]): TemplateLiteralTypeNode;
constructor(elements: readonly BindingElement[]): ObjectBindingPattern;
constructor(node: ObjectBindingPattern, elements: readonly BindingElement[]): ObjectBindingPattern;
constructor(elements: readonly ArrayBindingElement[]): ArrayBindingPattern;
constructor(node: ArrayBindingPattern, elements: readonly ArrayBindingElement[]): ArrayBindingPattern;
constructor(dotDotDotToken: DotDotDotToken | undefined, propertyName: string | PropertyName | undefined, name: string | BindingName, initializer?: Expression): BindingElement;
constructor(node: BindingElement, dotDotDotToken: DotDotDotToken | undefined, propertyName: PropertyName | undefined, name: BindingName, initializer: Expression | undefined): BindingElement;
constructor(elements?: readonly Expression[], multiLine?: boolean): ArrayLiteralExpression;
constructor(node: ArrayLiteralExpression, elements: readonly Expression[]): ArrayLiteralExpression;
constructor(properties?: readonly ObjectLiteralElementLike[], multiLine?: boolean): ObjectLiteralExpression;
constructor(node: ObjectLiteralExpression, properties: readonly ObjectLiteralElementLike[]): ObjectLiteralExpression;
constructor(expression: Expression, name: string | MemberName): PropertyAccessExpression;
constructor(node: PropertyAccessExpression, expression: Expression, name: MemberName): PropertyAccessExpression;
constructor(expression: Expression, questionDotToken: QuestionDotToken | undefined, name: string | MemberName): PropertyAccessChain;
constructor(node: PropertyAccessChain, expression: Expression, questionDotToken: QuestionDotToken | undefined, name: MemberName): PropertyAccessChain;
constructor(expression: Expression, index: number | Expression): ElementAccessExpression;
constructor(node: ElementAccessExpression, expression: Expression, argumentExpression: Expression): ElementAccessExpression;
constructor(expression: Expression, questionDotToken: QuestionDotToken | undefined, index: number | Expression): ElementAccessChain;
constructor(node: ElementAccessChain, expression: Expression, questionDotToken: QuestionDotToken | undefined, argumentExpression: Expression): ElementAccessChain;
constructor(expression: Expression, typeArguments: readonly TypeNode[] | undefined, argumentsArray: readonly Expression[] | undefined): CallExpression;
constructor(node: CallExpression, expression: Expression, typeArguments: readonly TypeNode[] | undefined, argumentsArray: readonly Expression[]): CallExpression;
constructor(expression: Expression, questionDotToken: QuestionDotToken | undefined, typeArguments: readonly TypeNode[] | undefined, argumentsArray: readonly Expression[] | undefined): CallChain;
constructor(node: CallChain, expression: Expression, questionDotToken: QuestionDotToken | undefined, typeArguments: readonly TypeNode[] | undefined, argumentsArray: readonly Expression[]): CallChain;
constructor(expression: Expression, typeArguments: readonly TypeNode[] | undefined, argumentsArray: readonly Expression[] | undefined): NewExpression;
constructor(node: NewExpression, expression: Expression, typeArguments: readonly TypeNode[] | undefined, argumentsArray: readonly Expression[] | undefined): NewExpression;
constructor(tag: Expression, typeArguments: readonly TypeNode[] | undefined, template: TemplateLiteral): TaggedTemplateExpression;
constructor(node: TaggedTemplateExpression, tag: Expression, typeArguments: readonly TypeNode[] | undefined, template: TemplateLiteral): TaggedTemplateExpression;
constructor(type: TypeNode, expression: Expression): TypeAssertion;
constructor(node: TypeAssertion, type: TypeNode, expression: Expression): TypeAssertion;
constructor(expression: Expression): ParenthesizedExpression;
constructor(node: ParenthesizedExpression, expression: Expression): ParenthesizedExpression;
constructor(modifiers: readonly Modifier[] | undefined, asteriskToken: AsteriskToken | undefined, name: string | Identifier | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[] | undefined, type: TypeNode | undefined, body: Block): FunctionExpression;
constructor(node: FunctionExpression, modifiers: readonly Modifier[] | undefined, asteriskToken: AsteriskToken | undefined, name: Identifier | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined, body: Block): FunctionExpression;
constructor(modifiers: readonly Modifier[] | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined, equalsGreaterThanToken: EqualsGreaterThanToken | undefined, body: ConciseBody): ArrowFunction;
constructor(node: ArrowFunction, modifiers: readonly Modifier[] | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined, equalsGreaterThanToken: EqualsGreaterThanToken, body: ConciseBody): ArrowFunction;
constructor(expression: Expression): DeleteExpression;
constructor(node: DeleteExpression, expression: Expression): DeleteExpression;
constructor(expression: Expression): TypeOfExpression;
constructor(node: TypeOfExpression, expression: Expression): TypeOfExpression;
constructor(expression: Expression): VoidExpression;
constructor(node: VoidExpression, expression: Expression): VoidExpression;
constructor(expression: Expression): AwaitExpression;
constructor(node: AwaitExpression, expression: Expression): AwaitExpression;
constructor(operator: PrefixUnaryOperator, operand: Expression): PrefixUnaryExpression;
constructor(node: PrefixUnaryExpression, operand: Expression): PrefixUnaryExpression;
constructor(operand: Expression, operator: PostfixUnaryOperator): PostfixUnaryExpression;
constructor(node: PostfixUnaryExpression, operand: Expression): PostfixUnaryExpression;
constructor(left: Expression, operator: BinaryOperator | BinaryOperatorToken, right: Expression): BinaryExpression;
constructor(node: BinaryExpression, left: Expression, operator: BinaryOperator | BinaryOperatorToken, right: Expression): BinaryExpression;
constructor(condition: Expression, questionToken: QuestionToken | undefined, whenTrue: Expression, colonToken: ColonToken | undefined, whenFalse: Expression): ConditionalExpression;
constructor(node: ConditionalExpression, condition: Expression, questionToken: QuestionToken, whenTrue: Expression, colonToken: ColonToken, whenFalse: Expression): ConditionalExpression;
constructor(head: TemplateHead, templateSpans: readonly TemplateSpan[]): TemplateExpression;
constructor(node: TemplateExpression, head: TemplateHead, templateSpans: readonly TemplateSpan[]): TemplateExpression;
constructor(text: string, rawText?: string, templateFlags?: TokenFlags): TemplateHead;
constructor(text: string | undefined, rawText: string, templateFlags?: TokenFlags): TemplateHead;
constructor(text: string, rawText?: string, templateFlags?: TokenFlags): TemplateMiddle;
constructor(text: string | undefined, rawText: string, templateFlags?: TokenFlags): TemplateMiddle;
constructor(text: string, rawText?: string, templateFlags?: TokenFlags): TemplateTail;
constructor(text: string | undefined, rawText: string, templateFlags?: TokenFlags): TemplateTail;
constructor(text: string, rawText?: string): NoSubstitutionTemplateLiteral;
constructor(text: string | undefined, rawText: string): NoSubstitutionTemplateLiteral;
constructor(asteriskToken: AsteriskToken, expression: Expression): YieldExpression;
constructor(asteriskToken: undefined, expression: Expression | undefined): YieldExpression;
constructor(node: YieldExpression, asteriskToken: AsteriskToken | undefined, expression: Expression | undefined): YieldExpression;
constructor(expression: Expression): SpreadElement;
constructor(node: SpreadElement, expression: Expression): SpreadElement;
constructor(modifiers: readonly ModifierLike[] | undefined, name: string | Identifier | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, heritageClauses: readonly HeritageClause[] | undefined, members: readonly ClassElement[]): ClassExpression;
constructor(node: ClassExpression, modifiers: readonly ModifierLike[] | undefined, name: Identifier | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, heritageClauses: readonly HeritageClause[] | undefined, members: readonly ClassElement[]): ClassExpression;
constructor(): OmittedExpression;
constructor(expression: Expression, typeArguments: readonly TypeNode[] | undefined): ExpressionWithTypeArguments;
constructor(node: ExpressionWithTypeArguments, expression: Expression, typeArguments: readonly TypeNode[] | undefined): ExpressionWithTypeArguments;
constructor(expression: Expression, type: TypeNode): AsExpression;
constructor(node: AsExpression, expression: Expression, type: TypeNode): AsExpression;
constructor(expression: Expression): NonNullExpression;
constructor(node: NonNullExpression, expression: Expression): NonNullExpression;
constructor(expression: Expression): NonNullChain;
constructor(node: NonNullChain, expression: Expression): NonNullChain;
constructor(keywordToken: MetaProperty["keywordToken"], name: Identifier): MetaProperty;
constructor(node: MetaProperty, name: Identifier): MetaProperty;
constructor(expression: Expression, type: TypeNode): SatisfiesExpression;
constructor(node: SatisfiesExpression, expression: Expression, type: TypeNode): SatisfiesExpression;
constructor(expression: Expression, literal: TemplateMiddle | TemplateTail): TemplateSpan;
constructor(node: TemplateSpan, expression: Expression, literal: TemplateMiddle | TemplateTail): TemplateSpan;
constructor(): SemicolonClassElement;
constructor(statements: readonly Statement[], multiLine?: boolean): Block;
constructor(node: Block, statements: readonly Statement[]): Block;
constructor(modifiers: readonly ModifierLike[] | undefined, declarationList: VariableDeclarationList | readonly VariableDeclaration[]): VariableStatement;
constructor(node: VariableStatement, modifiers: readonly ModifierLike[] | undefined, declarationList: VariableDeclarationList): VariableStatement;
constructor(): EmptyStatement;
constructor(expression: Expression): ExpressionStatement;
constructor(node: ExpressionStatement, expression: Expression): ExpressionStatement;
constructor(expression: Expression, thenStatement: Statement, elseStatement?: Statement): IfStatement;
constructor(node: IfStatement, expression: Expression, thenStatement: Statement, elseStatement: Statement | undefined): IfStatement;
constructor(statement: Statement, expression: Expression): DoStatement;
constructor(node: DoStatement, statement: Statement, expression: Expression): DoStatement;
constructor(expression: Expression, statement: Statement): WhileStatement;
constructor(node: WhileStatement, expression: Expression, statement: Statement): WhileStatement;
constructor(initializer: ForInitializer | undefined, condition: Expression | undefined, incrementor: Expression | undefined, statement: Statement): ForStatement;
constructor(node: ForStatement, initializer: ForInitializer | undefined, condition: Expression | undefined, incrementor: Expression | undefined, statement: Statement): ForStatement;
constructor(initializer: ForInitializer, expression: Expression, statement: Statement): ForInStatement;
constructor(node: ForInStatement, initializer: ForInitializer, expression: Expression, statement: Statement): ForInStatement;
constructor(awaitModifier: AwaitKeyword | undefined, initializer: ForInitializer, expression: Expression, statement: Statement): ForOfStatement;
constructor(node: ForOfStatement, awaitModifier: AwaitKeyword | undefined, initializer: ForInitializer, expression: Expression, statement: Statement): ForOfStatement;
constructor(label?: string | Identifier): ContinueStatement;
constructor(node: ContinueStatement, label: Identifier | undefined): ContinueStatement;
constructor(label?: string | Identifier): BreakStatement;
constructor(node: BreakStatement, label: Identifier | undefined): BreakStatement;
constructor(expression?: Expression): ReturnStatement;
constructor(node: ReturnStatement, expression: Expression | undefined): ReturnStatement;
constructor(expression: Expression, statement: Statement): WithStatement;
constructor(node: WithStatement, expression: Expression, statement: Statement): WithStatement;
constructor(expression: Expression, caseBlock: CaseBlock): SwitchStatement;
constructor(node: SwitchStatement, expression: Expression, caseBlock: CaseBlock): SwitchStatement;
constructor(label: string | Identifier, statement: Statement): LabeledStatement;
constructor(node: LabeledStatement, label: Identifier, statement: Statement): LabeledStatement;
constructor(expression: Expression): ThrowStatement;
constructor(node: ThrowStatement, expression: Expression): ThrowStatement;
constructor(tryBlock: Block, catchClause: CatchClause | undefined, finallyBlock: Block | undefined): TryStatement;
constructor(node: TryStatement, tryBlock: Block, catchClause: CatchClause | undefined, finallyBlock: Block | undefined): TryStatement;
constructor(): DebuggerStatement;
constructor(name: string | BindingName, exclamationToken?: ExclamationToken, type?: TypeNode, initializer?: Expression): VariableDeclaration;
constructor(node: VariableDeclaration, name: BindingName, exclamationToken: ExclamationToken | undefined, type: TypeNode | undefined, initializer: Expression | undefined): VariableDeclaration;
constructor(declarations: readonly VariableDeclaration[], flags?: NodeFlags): VariableDeclarationList;
constructor(node: VariableDeclarationList, declarations: readonly VariableDeclaration[]): VariableDeclarationList;
constructor(modifiers: readonly ModifierLike[] | undefined, asteriskToken: AsteriskToken | undefined, name: string | Identifier | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined, body: Block | undefined): FunctionDeclaration;
constructor(node: FunctionDeclaration, modifiers: readonly ModifierLike[] | undefined, asteriskToken: AsteriskToken | undefined, name: Identifier | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined, body: Block | undefined): FunctionDeclaration;
constructor(modifiers: readonly ModifierLike[] | undefined, name: string | Identifier | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, heritageClauses: readonly HeritageClause[] | undefined, members: readonly ClassElement[]): ClassDeclaration;
constructor(node: ClassDeclaration, modifiers: readonly ModifierLike[] | undefined, name: Identifier | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, heritageClauses: readonly HeritageClause[] | undefined, members: readonly ClassElement[]): ClassDeclaration;
constructor(modifiers: readonly ModifierLike[] | undefined, name: string | Identifier, typeParameters: readonly TypeParameterDeclaration[] | undefined, heritageClauses: readonly HeritageClause[] | undefined, members: readonly TypeElement[]): InterfaceDeclaration;
constructor(node: InterfaceDeclaration, modifiers: readonly ModifierLike[] | undefined, name: Identifier, typeParameters: readonly TypeParameterDeclaration[] | undefined, heritageClauses: readonly HeritageClause[] | undefined, members: readonly TypeElement[]): InterfaceDeclaration;
constructor(modifiers: readonly ModifierLike[] | undefined, name: string | Identifier, typeParameters: readonly TypeParameterDeclaration[] | undefined, type: TypeNode): TypeAliasDeclaration;
constructor(node: TypeAliasDeclaration, modifiers: readonly ModifierLike[] | undefined, name: Identifier, typeParameters: readonly TypeParameterDeclaration[] | undefined, type: TypeNode): TypeAliasDeclaration;
constructor(modifiers: readonly ModifierLike[] | undefined, name: string | Identifier, members: readonly EnumMember[]): EnumDeclaration;
constructor(node: EnumDeclaration, modifiers: readonly ModifierLike[] | undefined, name: Identifier, members: readonly EnumMember[]): EnumDeclaration;
constructor(modifiers: readonly ModifierLike[] | undefined, name: ModuleName, body: ModuleBody | undefined, flags?: NodeFlags): ModuleDeclaration;
constructor(node: ModuleDeclaration, modifiers: readonly ModifierLike[] | undefined, name: ModuleName, body: ModuleBody | undefined): ModuleDeclaration;
constructor(statements: readonly Statement[]): ModuleBlock;
constructor(node: ModuleBlock, statements: readonly Statement[]): ModuleBlock;
constructor(clauses: readonly CaseOrDefaultClause[]): CaseBlock;
constructor(node: CaseBlock, clauses: readonly CaseOrDefaultClause[]): CaseBlock;
constructor(name: string | Identifier): NamespaceExportDeclaration;
constructor(node: NamespaceExportDeclaration, name: Identifier): NamespaceExportDeclaration;
constructor(modifiers: readonly ModifierLike[] | undefined, isTypeOnly: boolean, name: string | Identifier, moduleReference: ModuleReference): ImportEqualsDeclaration;
constructor(node: ImportEqualsDeclaration, modifiers: readonly ModifierLike[] | undefined, isTypeOnly: boolean, name: Identifier, moduleReference: ModuleReference): ImportEqualsDeclaration;
constructor(modifiers: readonly ModifierLike[] | undefined, importClause: ImportClause | undefined, moduleSpecifier: Expression, attributes?: ImportAttributes): ImportDeclaration;
constructor(node: ImportDeclaration, modifiers: readonly ModifierLike[] | undefined, importClause: ImportClause | undefined, moduleSpecifier: Expression, attributes: ImportAttributes | undefined): ImportDeclaration;
constructor(isTypeOnly: boolean, name: Identifier | undefined, namedBindings: NamedImportBindings | undefined): ImportClause;
constructor(node: ImportClause, isTypeOnly: boolean, name: Identifier | undefined, namedBindings: NamedImportBindings | undefined): ImportClause;
...
constructor(elements: NodeArray<ImportAttribute>, multiLine?: boolean): ImportAttributes;
constructor(node: ImportAttributes, elements: NodeArray<ImportAttribute>, multiLine?: boolean): ImportAttributes;
constructor(name: ImportAttributeName, value: Expression): ImportAttribute;
constructor(node: ImportAttribute, name: ImportAttributeName, value: Expression): ImportAttribute;
constructor(name: Identifier): NamespaceImport;
constructor(node: NamespaceImport, name: Identifier): NamespaceImport;
constructor(name: ModuleExportName): NamespaceExport;
constructor(node: NamespaceExport, name: ModuleExportName): NamespaceExport;
constructor(elements: readonly ImportSpecifier[]): NamedImports;
constructor(node: NamedImports, elements: readonly ImportSpecifier[]): NamedImports;
constructor(isTypeOnly: boolean, propertyName: ModuleExportName | undefined, name: Identifier): ImportSpecifier;
constructor(node: ImportSpecifier, isTypeOnly: boolean, propertyName: ModuleExportName | undefined, name: Identifier): ImportSpecifier;
constructor(modifiers: readonly ModifierLike[] | undefined, isExportEquals: boolean | undefined, expression: Expression): ExportAssignment;
constructor(node: ExportAssignment, modifiers: readonly ModifierLike[] | undefined, expression: Expression): ExportAssignment;
constructor(modifiers: readonly ModifierLike[] | undefined, isTypeOnly: boolean, exportClause: NamedExportBindings | undefined, moduleSpecifier?: Expression, attributes?: ImportAttributes): ExportDeclaration;
constructor(node: ExportDeclaration, modifiers: readonly ModifierLike[] | undefined, isTypeOnly: boolean, exportClause: NamedExportBindings | undefined, moduleSpecifier: Expression | undefined, attributes: ImportAttributes | undefined): ExportDeclaration;
constructor(elements: readonly ExportSpecifier[]): NamedExports;
constructor(node: NamedExports, elements: readonly ExportSpecifier[]): NamedExports;
constructor(isTypeOnly: boolean, propertyName: string | ModuleExportName | undefined, name: string | ModuleExportName): ExportSpecifier;
constructor(node: ExportSpecifier, isTypeOnly: boolean, propertyName: ModuleExportName | undefined, name: ModuleExportName): ExportSpecifier;
constructor(expression: Expression): ExternalModuleReference;
constructor(node: ExternalModuleReference, expression: Expression): ExternalModuleReference;
constructor(): JSDocAllType;
constructor(): JSDocUnknownType;
constructor(type: TypeNode, postfix?: boolean): JSDocNonNullableType;
constructor(node: JSDocNonNullableType, type: TypeNode): JSDocNonNullableType;
constructor(type: TypeNode, postfix?: boolean): JSDocNullableType;
constructor(node: JSDocNullableType, type: TypeNode): JSDocNullableType;
constructor(type: TypeNode): JSDocOptionalType;
constructor(node: JSDocOptionalType, type: TypeNode): JSDocOptionalType;
constructor(parameters: readonly ParameterDeclaration[], type: TypeNode | undefined): JSDocFunctionType;
constructor(node: JSDocFunctionType, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined): JSDocFunctionType;
constructor(type: TypeNode): JSDocVariadicType;
constructor(node: JSDocVariadicType, type: TypeNode): JSDocVariadicType;
constructor(type: TypeNode): JSDocNamepathType;
constructor(node: JSDocNamepathType, type: TypeNode): JSDocNamepathType;
constructor(type: TypeNode): JSDocTypeExpression;
constructor(node: JSDocTypeExpression, type: TypeNode): JSDocTypeExpression;
constructor(name: EntityName | JSDocMemberName): JSDocNameReference;
constructor(node: JSDocNameReference, name: EntityName | JSDocMemberName): JSDocNameReference;
constructor(left: EntityName | JSDocMemberName, right: Identifier): JSDocMemberName;
constructor(node: JSDocMemberName, left: EntityName | JSDocMemberName, right: Identifier): JSDocMemberName;
constructor(name: EntityName | JSDocMemberName | undefined, text: string): JSDocLink;
constructor(node: JSDocLink, name: EntityName | JSDocMemberName | undefined, text: string): JSDocLink;
constructor(name: EntityName | JSDocMemberName | undefined, text: string): JSDocLinkCode;
constructor(node: JSDocLinkCode, name: EntityName | JSDocMemberName | undefined, text: string): JSDocLinkCode;
constructor(name: EntityName | JSDocMemberName | undefined, text: string): JSDocLinkPlain;
constructor(node: JSDocLinkPlain, name: EntityName | JSDocMemberName | undefined, text: string): JSDocLinkPlain;
constructor(jsDocPropertyTags?: readonly JSDocPropertyLikeTag[], isArrayType?: boolean): JSDocTypeLiteral;
constructor(node: JSDocTypeLiteral, jsDocPropertyTags: readonly JSDocPropertyLikeTag[] | undefined, isArrayType: boolean | undefined): JSDocTypeLiteral;
constructor(typeParameters: readonly JSDocTemplateTag[] | undefined, parameters: readonly JSDocParameterTag[], type?: JSDocReturnTag): JSDocSignature;
constructor(node: JSDocSignature, typeParameters: readonly JSDocTemplateTag[] | undefined, parameters: readonly JSDocParameterTag[], type: JSDocReturnTag | undefined): JSDocSignature;
constructor(tagName: Identifier | undefined, constraint: JSDocTypeExpression | undefined, typeParameters: readonly TypeParameterDeclaration[], comment?: string | NodeArray<JSDocComment>): JSDocTemplateTag;
constructor(node: JSDocTemplateTag, tagName: Identifier | undefined, constraint: JSDocTypeExpression | undefined, typeParameters: readonly TypeParameterDeclaration[], comment: string | NodeArray<JSDocComment> | undefined): JSDocTemplateTag;
constructor(tagName: Identifier | undefined, typeExpression?: JSDocTypeExpression | JSDocTypeLiteral, fullName?: Identifier | JSDocNamespaceDeclaration, comment?: string | NodeArray<JSDocComment>): JSDocTypedefTag;
constructor(node: JSDocTypedefTag, tagName: Identifier | undefined, typeExpression: JSDocTypeExpression | JSDocTypeLiteral | undefined, fullName: Identifier | JSDocNamespaceDeclaration | undefined, comment: string | NodeArray<JSDocComment> | undefined): JSDocTypedefTag;
constructor(tagName: Identifier | undefined, name: EntityName, isBracketed: boolean, typeExpression?: JSDocTypeExpression, isNameFirst?: boolean, comment?: string | NodeArray<JSDocComment>): JSDocParameterTag;
constructor(node: JSDocParameterTag, tagName: Identifier | undefined, name: EntityName, isBracketed: boolean, typeExpression: JSDocTypeExpression | undefined, isNameFirst: boolean, comment: string | NodeArray<JSDocComment> | undefined): JSDocParameterTag;
constructor(tagName: Identifier | undefined, name: EntityName, isBracketed: boolean, typeExpression?: JSDocTypeExpression, isNameFirst?: boolean, comment?: string | NodeArray<JSDocComment>): JSDocPropertyTag;
constructor(node: JSDocPropertyTag, tagName: Identifier | undefined, name: EntityName, isBracketed: boolean, typeExpression: JSDocTypeExpression | undefined, isNameFirst: boolean, comment: string | NodeArray<JSDocComment> | undefined): JSDocPropertyTag;
constructor(tagName: Identifier | undefined, typeExpression: JSDocTypeExpression, comment?: string | NodeArray<JSDocComment>): JSDocTypeTag;
constructor(node: JSDocTypeTag, tagName: Identifier | undefined, typeExpression: JSDocTypeExpression, comment: string | NodeArray<JSDocComment> | undefined): JSDocTypeTag;
constructor(tagName: Identifier | undefined, nameExpression: JSDocNameReference | undefined, comment?: string | NodeArray<JSDocComment>): JSDocSeeTag;
constructor(node: JSDocSeeTag, tagName: Identifier | undefined, nameExpression: JSDocNameReference | undefined, comment?: string | NodeArray<JSDocComment>): JSDocSeeTag;
constructor(tagName: Identifier | undefined, typeExpression?: JSDocTypeExpression, comment?: string | NodeArray<JSDocComment>): JSDocReturnTag;
constructor(node: JSDocReturnTag, tagName: Identifier | undefined, typeExpression: JSDocTypeExpression | undefined, comment: string | NodeArray<JSDocComment> | undefined): JSDocReturnTag;
constructor(tagName: Identifier | undefined, typeExpression: JSDocTypeExpression, comment?: string | NodeArray<JSDocComment>): JSDocThisTag;
constructor(node: JSDocThisTag, tagName: Identifier | undefined, typeExpression: JSDocTypeExpression | undefined, comment: string | NodeArray<JSDocComment> | undefined): JSDocThisTag;
constructor(tagName: Identifier | undefined, typeExpression: JSDocTypeExpression, comment?: string | NodeArray<JSDocComment>): JSDocEnumTag;
constructor(node: JSDocEnumTag, tagName: Identifier | undefined, typeExpression: JSDocTypeExpression, comment: string | NodeArray<JSDocComment> | undefined): JSDocEnumTag;
constructor(tagName: Identifier | undefined, typeExpression: JSDocSignature, fullName?: Identifier | JSDocNamespaceDeclaration, comment?: string | NodeArray<JSDocComment>): JSDocCallbackTag;
constructor(node: JSDocCallbackTag, tagName: Identifier | undefined, typeExpression: JSDocSignature, fullName: Identifier | JSDocNamespaceDeclaration | undefined, comment: string | NodeArray<JSDocComment> | undefined): JSDocCallbackTag;
constructor(tagName: Identifier | undefined, typeExpression: JSDocSignature, comment?: string | NodeArray<JSDocComment>): JSDocOverloadTag;
constructor(node: JSDocOverloadTag, tagName: Identifier | undefined, typeExpression: JSDocSignature, comment: string | NodeArray<JSDocComment> | undefined): JSDocOverloadTag;
constructor(tagName: Identifier | undefined, className: JSDocAugmentsTag["class"], comment?: string | NodeArray<JSDocComment>): JSDocAugmentsTag;
constructor(node: JSDocAugmentsTag, tagName: Identifier | undefined, className: JSDocAugmentsTag["class"], comment: string | NodeArray<JSDocComment> | undefined): JSDocAugmentsTag;
constructor(tagName: Identifier | undefined, className: JSDocImplementsTag["class"], comment?: string | NodeArray<JSDocComment>): JSDocImplementsTag;
constructor(node: JSDocImplementsTag, tagName: Identifier | undefined, className: JSDocImplementsTag["class"], comment: string | NodeArray<JSDocComment> | undefined): JSDocImplementsTag;
constructor(tagName: Identifier | undefined, comment?: string | NodeArray<JSDocComment>): JSDocAuthorTag;
constructor(node: JSDocAuthorTag, tagName: Identifier | undefined, comment: string | NodeArray<JSDocComment> | undefined): JSDocAuthorTag;
constructor(tagName: Identifier | undefined, comment?: string | NodeArray<JSDocComment>): JSDocClassTag;
constructor(node: JSDocClassTag, tagName: Identifier | undefined, comment: string | NodeArray<JSDocComment> | undefined): JSDocClassTag;
constructor(tagName: Identifier | undefined, comment?: string | NodeArray<JSDocComment>): JSDocPublicTag;
constructor(node: JSDocPublicTag, tagName: Identifier | undefined, comment: string | NodeArray<JSDocComment> | undefined): JSDocPublicTag;
constructor(tagName: Identifier | undefined, comment?: string | NodeArray<JSDocComment>): JSDocPrivateTag;
constructor(node: JSDocPrivateTag, tagName: Identifier | undefined, comment: string | NodeArray<JSDocComment> | undefined): JSDocPrivateTag;
constructor(tagName: Identifier | undefined, comment?: string | NodeArray<JSDocComment>): JSDocProtectedTag;
constructor(node: JSDocProtectedTag, tagName: Identifier | undefined, comment: string | NodeArray<JSDocComment> | undefined): JSDocProtectedTag;
constructor(tagName: Identifier | undefined, comment?: string | NodeArray<JSDocComment>): JSDocReadonlyTag;
constructor(node: JSDocReadonlyTag, tagName: Identifier | undefined, comment: string | NodeArray<JSDocComment> | undefined): JSDocReadonlyTag;
constructor(tagName: Identifier, comment?: string | NodeArray<JSDocComment>): JSDocUnknownTag;
constructor(node: JSDocUnknownTag, tagName: Identifier, comment: string | NodeArray<JSDocComment> | undefined): JSDocUnknownTag;
constructor(tagName: Identifier | undefined, comment?: string | NodeArray<JSDocComment>): JSDocDeprecatedTag;
constructor(node: JSDocDeprecatedTag, tagName: Identifier | undefined, comment?: string | NodeArray<JSDocComment>): JSDocDeprecatedTag;
constructor(tagName: Identifier | undefined, comment?: string | NodeArray<JSDocComment>): JSDocOverrideTag;
constructor(node: JSDocOverrideTag, tagName: Identifier | undefined, comment?: string | NodeArray<JSDocComment>): JSDocOverrideTag;
constructor(tagName: Identifier, typeExpression: JSDocTypeExpression | undefined, comment?: string | NodeArray<JSDocComment>): JSDocThrowsTag;
constructor(node: JSDocThrowsTag, tagName: Identifier | undefined, typeExpression: JSDocTypeExpression | undefined, comment?: string | NodeArray<JSDocComment> | undefined): JSDocThrowsTag;
constructor(tagName: Identifier | undefined, typeExpression: JSDocTypeExpression, comment?: string | NodeArray<JSDocComment>): JSDocSatisfiesTag;
constructor(node: JSDocSatisfiesTag, tagName: Identifier | undefined, typeExpression: JSDocTypeExpression, comment: string | NodeArray<JSDocComment> | undefined): JSDocSatisfiesTag;
constructor(tagName: Identifier | undefined, importClause: ImportClause | undefined, moduleSpecifier: Expression, attributes?: ImportAttributes, comment?: string | NodeArray<JSDocComment>): JSDocImportTag;
constructor(node: JSDocImportTag, tagName: Identifier | undefined, importClause: ImportClause | undefined, moduleSpecifier: Expression, attributes: ImportAttributes | undefined, comment: string | NodeArray<JSDocComment> | undefined): JSDocImportTag;
constructor(text: string): JSDocText;
constructor(node: JSDocText, text: string): JSDocText;
constructor(comment?: string | NodeArray<JSDocComment> | undefined, tags?: readonly JSDocTag[] | undefined): JSDoc;
constructor(node: JSDoc, comment: string | NodeArray<JSDocComment> | undefined, tags: readonly JSDocTag[] | undefined): JSDoc;
constructor(openingElement: JsxOpeningElement, children: readonly JsxChild[], closingElement: JsxClosingElement): JsxElement;
constructor(node: JsxElement, openingElement: JsxOpeningElement, children: readonly JsxChild[], closingElement: JsxClosingElement): JsxElement;
constructor(tagName: JsxTagNameExpression, typeArguments: readonly TypeNode[] | undefined, attributes: JsxAttributes): JsxSelfClosingElement;
constructor(node: JsxSelfClosingElement, tagName: JsxTagNameExpression, typeArguments: readonly TypeNode[] | undefined, attributes: JsxAttributes): JsxSelfClosingElement;
constructor(tagName: JsxTagNameExpression, typeArguments: readonly TypeNode[] | undefined, attributes: JsxAttributes): JsxOpeningElement;
constructor(node: JsxOpeningElement, tagName: JsxTagNameExpression, typeArguments: readonly TypeNode[] | undefined, attributes: JsxAttributes): JsxOpeningElement;
constructor(tagName: JsxTagNameExpression): JsxClosingElement;
constructor(node: JsxClosingElement, tagName: JsxTagNameExpression): JsxClosingElement;
constructor(openingFragment: JsxOpeningFragment, children: readonly JsxChild[], closingFragment: JsxClosingFragment): JsxFragment;
constructor(text: string, containsOnlyTriviaWhiteSpaces?: boolean): JsxText;
constructor(node: JsxText, text: string, containsOnlyTriviaWhiteSpaces?: boolean): JsxText;
constructor(): JsxOpeningFragment;
constructor(): JsxClosingFragment;
constructor(node: JsxFragment, openingFragment: JsxOpeningFragment, children: readonly JsxChild[], closingFragment: JsxClosingFragment): JsxFragment;
constructor(name: JsxAttributeName, initializer: JsxAttributeValue | undefined): JsxAttribute;
constructor(node: JsxAttribute, name: JsxAttributeName, initializer: JsxAttributeValue | undefined): JsxAttribute;
constructor(properties: readonly JsxAttributeLike[]): JsxAttributes;
constructor(node: JsxAttributes, properties: readonly JsxAttributeLike[]): JsxAttributes;
constructor(expression: Expression): JsxSpreadAttribute;
constructor(node: JsxSpreadAttribute, expression: Expression): JsxSpreadAttribute;
constructor(dotDotDotToken: DotDotDotToken | undefined, expression: Expression | undefined): JsxExpression;
constructor(node: JsxExpression, expression: Expression | undefined): JsxExpression;
constructor(namespace: Identifier, name: Identifier): JsxNamespacedName;
constructor(node: JsxNamespacedName, namespace: Identifier, name: Identifier): JsxNamespacedName;
constructor(expression: Expression, statements: readonly Statement[]): CaseClause;
constructor(node: CaseClause, expression: Expression, statements: readonly Statement[]): CaseClause;
constructor(statements: readonly Statement[]): DefaultClause;
constructor(node: DefaultClause, statements: readonly Statement[]): DefaultClause;
constructor(token: HeritageClause["token"], types: readonly ExpressionWithTypeArguments[]): HeritageClause;
constructor(node: HeritageClause, types: readonly ExpressionWithTypeArguments[]): HeritageClause;
constructor(variableDeclaration: string | BindingName | VariableDeclaration | undefined, block: Block): CatchClause;
constructor(node: CatchClause, variableDeclaration: VariableDeclaration | undefined, block: Block): CatchClause;
constructor(name: string | PropertyName, initializer: Expression): PropertyAssignment;
constructor(node: PropertyAssignment, name: PropertyName, initializer: Expression): PropertyAssignment;
constructor(name: string | Identifier, objectAssignmentInitializer?: Expression): ShorthandPropertyAssignment;
constructor(node: ShorthandPropertyAssignment, name: Identifier, objectAssignmentInitializer: Expression | undefined): ShorthandPropertyAssignment;
constructor(expression: Expression): SpreadAssignment;
constructor(node: SpreadAssignment, expression: Expression): SpreadAssignment;
constructor(name: string | PropertyName, initializer?: Expression): EnumMember;
constructor(node: EnumMember, name: PropertyName, initializer: Expression | undefined): EnumMember;
constructor(statements: readonly Statement[], endOfFileToken: EndOfFileToken, flags: NodeFlags): SourceFile;
constructor(node: SourceFile, statements: readonly Statement[], isDeclarationFile?: boolean, referencedFiles?: readonly FileReference[], typeReferences?: readonly FileReference[], hasNoDefaultLib?: boolean, libReferences?: readonly FileReference[]): SourceFile;
constructor(original: Node): NotEmittedStatement;
constructor(): NotEmittedTypeElement;
constructor(expression: Expression, original?: Node): PartiallyEmittedExpression;
constructor(node: PartiallyEmittedExpression, expression: Expression): PartiallyEmittedExpression;
constructor(elements: readonly Expression[]): CommaListExpression;
constructor(node: CommaListExpression, elements: readonly Expression[]): CommaListExpression;
constructor(sourceFiles: readonly SourceFile[]): Bundle;
constructor(node: Bundle, sourceFiles: readonly SourceFile[]): Bundle;
constructor(left: Expression, right: Expression): BinaryExpression;
constructor(left: ObjectLiteralExpression | ArrayLiteralExpression, right: Expression): DestructuringAssignment;
constructor(left: Expression, right: Expression): AssignmentExpression<EqualsToken>;
constructor(left: Expression, right: Expression): BinaryExpression;
constructor(left: Expression, right: Expression): BinaryExpression;
constructor(left: Expression, right: Expression): BinaryExpression;
constructor(left: Expression, right: Expression): BinaryExpression;
...
constructor(left: Expression, right: Expression): BinaryExpression;
constructor(left: Expression, right: Expression): BinaryExpression;
constructor(operand: Expression): PrefixUnaryExpression;
constructor(operand: Expression): PrefixUnaryExpression;
constructor(operand: Expression): PrefixUnaryExpression;
constructor(operand: Expression): PrefixUnaryExpression;
constructor(operand: Expression): PrefixUnaryExpression;
constructor(operand: Expression): PrefixUnaryExpression;
constructor(operand: Expression): PostfixUnaryExpression;
constructor(operand: Expression): PostfixUnaryExpression;
constructor(statements: readonly Statement[]): CallExpression;
constructor(statements: readonly Statement[], param: ParameterDeclaration, paramValue: Expression): CallExpression;
constructor(statements: readonly Statement[]): ImmediatelyInvokedArrowFunction;
constructor(statements: readonly Statement[], param: ParameterDeclaration, paramValue: Expression): ImmediatelyInvokedArrowFunction;
constructor(): VoidExpression;
constructor(expression: Expression): ExportAssignment;
constructor(exportName: Identifier): ExportDeclaration;
constructor(outerExpression: Expression | undefined, innerExpression: Expression, kinds?: OuterExpressionKinds): Expression;
        /**
...
constructor(): Statement[] | undefined;
        /** Hoists a function declaration to the containing scope. */
constructor(node: FunctionDeclaration): void;
        /** Hoists a variable declaration to the containing scope. */
constructor(node: Identifier): void;
    }
    interface TransformationContext extends CoreTransformationContext {
        /** Records a request for a non-scoped emit helper in the current context. */
constructor(helper: EmitHelper): void;
        /** Gets and resets the requested non-scoped emit helpers. */
constructor(): EmitHelper[] | undefined;
        /** Enables expression substitutions in the pretty printer for the provided SyntaxKind. */
constructor(kind: SyntaxKind): void;
        /** Determines whether expression substitutions are enabled for the provided node. */
constructor(node: Node): boolean;
        /**
...
constructor(node: Node): boolean;
    ...
    interface TransformationResult<T extends Node> {
         ...
         */
constructor(hint: EmitHint, node: Node): Node;
        /**
         ...
         */
constructor(hint: EmitHint, node: Node, emitCallback: (hint: EmitHint, node: Node) => void): void;
        /**
...
constructor(): void;
    ...
    interface Printer {
         ...
         * collisions.
         */
constructor(hint: EmitHint, node: Node, sourceFile: SourceFile): string;
        /**
...
constructor(sourceFile: SourceFile): string;
         ...
         */
constructor(bundle: Bundle): string;
    }
...
constructor(path: string, data: string, writeByteOrderMark?: boolean): void;
        /**
...
constructor(exitCode?: number): void;
        realpath?(path: string): string;
...
constructor(): SyntaxKind;
constructor(): SyntaxKind;
constructor(isTaggedTemplate: boolean): SyntaxKind;
        /** @deprecated use {@link reScanTemplateToken}(false) */
constructor(): SyntaxKind;
constructor(): SyntaxKind;
constructor(): SyntaxKind;
constructor(): SyntaxKind;
constructor(allowMultilineJsxText?: boolean): JsxTokenSyntaxKind;
constructor(): SyntaxKind;
constructor(): SyntaxKind;
constructor(): SyntaxKind;
constructor(): SyntaxKind;
constructor(): JsxTokenSyntaxKind;
constructor(): JSDocSyntaxKind;
constructor(): SyntaxKind;
constructor(): string;
constructor(text: string | undefined, start?: number, length?: number): void;
constructor(onError: ErrorCallback | undefined): void;
constructor(scriptTarget: ScriptTarget): void;
constructor(variant: LanguageVariant): void;
constructor(scriptKind: ScriptKind): void;
constructor(kind: JSDocParsingMode): void;
        /** @deprecated use {@link resetTokenState} */
constructor(textPos: number): void;
constructor(pos: number): void;
...
constructor(key: string, mode: ResolutionMode): T | undefined;
constructor(key: string, mode: ResolutionMode, value: T): this;
constructor(key: string, mode: ResolutionMode): this;
constructor(key: string, mode: ResolutionMode): boolean;
constructor(cb: (elem: T, key: string, mode: ResolutionMode) => void): void;
constructor(): number;
    }
    /**
...
constructor(name: string, mode: ResolutionMode, directoryName: string, redirectedReference: ResolvedProjectReference | undefined): T | undefined;
constructor(directoryName: string, redirectedReference?: ResolvedProjectReference): ModeAwareCache<T>;
constructor(): void;
        /**
...
constructor(nonRelativeName: string, mode: ResolutionMode, directoryName: string, redirectedReference: ResolvedProjectReference | undefined): T | undefined;
constructor(nonRelativeName: string, mode: ResolutionMode, redirectedReference?: ResolvedProjectReference): PerNonRelativeNameCache<T>;
constructor(): void;
        /**
         *  Updates with the current compilerOptions the cache will operate with.
         *  This updates the redirects map as well if needed so module resolutions are cached if they can across the projects
...
constructor(directory: string): T | undefined;
constructor(directory: string, result: T): void;
    }
...
constructor(): PackageJsonInfoCache;
    }
    /**
...
constructor(nonRelativeModuleName: string, mode: ResolutionMode, redirectedReference?: ResolvedProjectReference): PerModuleNameCache;
    }
...
constructor(sourceFile?: SourceFile, cancellationToken?: CancellationToken): readonly DiagnosticWithLocation[];
         ...
         */
constructor(sourceFile: SourceFile): readonly string[];
        /**
...
constructor(): string;
    ...
    interface SemanticDiagnosticsBuilderProgram extends BuilderProgram {
         ...
         */
constructor(cancellationToken?: CancellationToken, ignoreSourceFile?: (sourceFile: SourceFile) => boolean): AffectedFileResult<readonly Diagnostic[]>;
    }
    /**
    ...
    interface EmitAndSemanticDiagnosticsBuilderProgram extends SemanticDiagnosticsBuilderProgram {
         ...
         * in that order would be used to write the files
         */
constructor(writeFile?: WriteFileCallback, cancellationToken?: CancellationToken, emitOnlyDtsFiles?: boolean, customTransformers?: CustomTransformers): AffectedFileResult<EmitResult>;
    }
...
constructor(fileNames: string[]): void;
    }
    /**
...
constructor(fileName: string): Date | undefined;
constructor(fileName: string, date: Date): void;
constructor(fileName: string): void;
        getParsedCommandLine?(fileName: string): ParsedCommandLine | undefined;
...
constructor(project?: string, cancellationToken?: CancellationToken, writeFile?: WriteFileCallback, getCustomTransformers?: (project: string) => CustomTransformers): ExitStatus;
constructor(project?: string): ExitStatus;
constructor(project: string, cancellationToken?: CancellationToken, writeFile?: WriteFileCallback, getCustomTransformers?: (project: string) => CustomTransformers): ExitStatus;
constructor(project?: string): ExitStatus;
constructor(cancellationToken?: CancellationToken): InvalidatedProject<T> | undefined;
    }
    ...
    interface InvalidatedProjectBase {
         ...
         */
constructor(cancellationToken?: CancellationToken, writeFile?: WriteFileCallback, customTransformers?: CustomTransformers): ExitStatus;
constructor(): CompilerOptions;
constructor(): string;
    }
...
constructor(sourceFile?: SourceFile, cancellationToken?: CancellationToken): readonly Diagnostic[];
constructor(cancellationToken?: CancellationToken, ignoreSourceFile?: (sourceFile: SourceFile) => boolean): AffectedFileResult<readonly Diagnostic[]>;
constructor(targetSourceFile?: SourceFile, writeFile?: WriteFileCallback, cancellationToken?: CancellationToken, emitOnlyDtsFiles?: boolean, customTransformers?: CustomTransformers): EmitResult | undefined;
    }
...
constructor(start: number, end: number): string;
...
constructor(): number;
         ...
         */
constructor(oldSnapshot: IScriptSnapshot): TextChangeRange | undefined;
...
constructor(): CompletionInfo | undefined;
constructor(response: CompletionInfo): void;
constructor(): void;
    }
...
constructor(): void;
         ...
         */
constructor(fileName: string): DiagnosticWithLocation[];
        /**
         ...
         */
constructor(fileName: string): Diagnostic[];
        /**
...
constructor(fileName: string, span: TextSpan): ClassifiedSpan[];
constructor(fileName: string, span: TextSpan, format: SemanticClassificationFormat): ClassifiedSpan[] | ClassifiedSpan2020[];
        /** @deprecated Use getEncodedSemanticClassifications instead. */
constructor(fileName: string, span: TextSpan): ClassifiedSpan[];
constructor(fileName: string, span: TextSpan, format: SemanticClassificationFormat): ClassifiedSpan[] | ClassifiedSpan2020[];
        /** Encoded as triples of [start, length, ClassificationType]. */
constructor(fileName: string, span: TextSpan): Classifications;
        /**
         ...
         */
constructor(fileName: string, span: TextSpan, format?: SemanticClassificationFormat): Classifications;
        /**
         ...
         */
constructor(fileName: string, position: number, options: GetCompletionsAtPositionOptions | undefined, formattingSettings?: FormatCodeSettings): WithMetadata<CompletionInfo> | undefined;
        /**
         ...
         */
constructor(fileName: string, position: number, entryName: string, formatOptions: FormatCodeOptions | FormatCodeSettings | undefined, source: string | undefined, preferences: UserPreferences | undefined, data: CompletionEntryData | undefined): CompletionEntryDetails | undefined;
constructor(fileName: string, position: number, name: string, source: string | undefined): Symbol | undefined;
        /**
         ...
         */
constructor(fileName: string, position: number): QuickInfo | undefined;
constructor(fileName: string, startPos: number, endPos: number): TextSpan | undefined;
constructor(fileName: string, position: number): TextSpan | undefined;
constructor(fileName: string, position: number, options: SignatureHelpItemsOptions | undefined): SignatureHelpItems | undefined;
constructor(fileName: string, position: number, preferences: UserPreferences): RenameInfo;
        /** @deprecated Use the signature with `UserPreferences` instead. */
constructor(fileName: string, position: number, options?: RenameInfoOptions): RenameInfo;
constructor(fileName: string, position: number, findInStrings: boolean, findInComments: boolean, preferences: UserPreferences): readonly RenameLocation[] | undefined;
        /** @deprecated Pass `providePrefixAndSuffixTextForRename` as part of a `UserPreferences` parameter. */
constructor(fileName: string, position: number, findInStrings: boolean, findInComments: boolean, providePrefixAndSuffixTextForRename?: boolean): readonly RenameLocation[] | undefined;
constructor(fileName: string, position: number): SelectionRange;
constructor(fileName: string, position: number): readonly DefinitionInfo[] | undefined;
constructor(fileName: string, position: number): DefinitionInfoAndBoundSpan | undefined;
constructor(fileName: string, position: number): readonly DefinitionInfo[] | undefined;
constructor(fileName: string, position: number): readonly ImplementationLocation[] | undefined;
constructor(fileName: string, position: number): ReferenceEntry[] | undefined;
constructor(fileName: string, position: number): ReferencedSymbol[] | undefined;
constructor(fileName: string, position: number, filesToSearch: string[]): DocumentHighlights[] | undefined;
constructor(fileName: string): ReferenceEntry[];
constructor(searchValue: string, maxResultCount?: number, fileName?: string, excludeDtsFiles?: boolean, excludeLibFiles?: boolean): NavigateToItem[];
constructor(fileName: string): NavigationBarItem[];
constructor(fileName: string): NavigationTree;
constructor(fileName: string, position: number): CallHierarchyItem | CallHierarchyItem[] | undefined;
constructor(fileName: string, position: number): CallHierarchyIncomingCall[];
constructor(fileName: string, position: number): CallHierarchyOutgoingCall[];
constructor(fileName: string, span: TextSpan, preferences: UserPreferences | undefined): InlayHint[];
constructor(fileName: string): OutliningSpan[];
constructor(fileName: string, descriptors: TodoCommentDescriptor[]): TodoComment[];
constructor(fileName: string, position: number): TextSpan[];
constructor(fileName: string, position: number, options: EditorOptions | EditorSettings): number;
constructor(fileName: string, start: number, end: number, options: FormatCodeOptions | FormatCodeSettings): TextChange[];
constructor(fileName: string, options: FormatCodeOptions | FormatCodeSettings): TextChange[];
constructor(fileName: string, position: number, key: string, options: FormatCodeOptions | FormatCodeSettings): TextChange[];
constructor(fileName: string, position: number, options?: DocCommentTemplateOptions, formatOptions?: FormatCodeSettings): TextInsertion | undefined;
constructor(fileName: string, position: number, openingBrace: number): boolean;
        /**
         * This will return a defined result if the position is after the `>` of the opening tag, or somewhere in the text, of a JSXElement with no closing tag.
         * Editors should call this after `>` is typed.
         */
constructor(fileName: string, position: number): JsxClosingTagInfo | undefined;
constructor(fileName: string, position: number): LinkedEditingInfo | undefined;
constructor(fileName: string, position: number, onlyMultiLine: boolean): TextSpan | undefined;
        toLineColumnOffset?(fileName: string, position: number): LineAndCharacter;
constructor(fileName: string, start: number, end: number, errorCodes: readonly number[], formatOptions: FormatCodeSettings, preferences: UserPreferences): readonly CodeFixAction[];
constructor(scope: CombinedCodeFixScope, fixId: {}, formatOptions: FormatCodeSettings, preferences: UserPreferences): CombinedCodeActions;
constructor(action: CodeActionCommand, formatSettings?: FormatCodeSettings): Promise<ApplyCodeActionCommandResult>;
constructor(action: CodeActionCommand[], formatSettings?: FormatCodeSettings): Promise<ApplyCodeActionCommandResult[]>;
constructor(action: CodeActionCommand | CodeActionCommand[], formatSettings?: FormatCodeSettings): Promise<ApplyCodeActionCommandResult | ApplyCodeActionCommandResult[]>;
        /** @deprecated `fileName` will be ignored */
constructor(fileName: string, action: CodeActionCommand): Promise<ApplyCodeActionCommandResult>;
        /** @deprecated `fileName` will be ignored */
constructor(fileName: string, action: CodeActionCommand[]): Promise<ApplyCodeActionCommandResult[]>;
        /** @deprecated `fileName` will be ignored */
constructor(fileName: string, action: CodeActionCommand | CodeActionCommand[]): Promise<ApplyCodeActionCommandResult | ApplyCodeActionCommandResult[]>;
        /**
         ...
         */
constructor(fileName: string, positionOrRange: number | TextRange, preferences: UserPreferences | undefined, triggerReason?: RefactorTriggerReason, kind?: string, includeInteractiveActions?: boolean): ApplicableRefactorInfo[];
constructor(fileName: string, formatOptions: FormatCodeSettings, positionOrRange: number | TextRange, refactorName: string, actionName: string, preferences: UserPreferences | undefined, interactiveRefactorArguments?: InteractiveRefactorArguments): RefactorEditInfo | undefined;
constructor(fileName: string, positionOrRange: number | TextRange, preferences: UserPreferences | undefined, triggerReason?: RefactorTriggerReason, kind?: string): {
            newFileName: string;
            files: string[];
        };
constructor(args: OrganizeImportsArgs, formatOptions: FormatCodeSettings, preferences: UserPreferences | undefined): readonly FileTextChanges[];
constructor(oldFilePath: string, newFilePath: string, formatOptions: FormatCodeSettings, preferences: UserPreferences | undefined): readonly FileTextChanges[];
constructor(fileName: string, emitOnlyDtsFiles?: boolean, forceDtsEmit?: boolean): EmitOutput;
constructor(): Program | undefined;
constructor(fileName: string, textRange: TextRange): TextChange[];
constructor(fileName: string, textRange: TextRange): TextChange[];
constructor(fileName: string, textRange: TextRange): TextChange[];
constructor(fileName: string, textRange: TextRange): TextChange[];
constructor(fileName?: string): readonly string[];
constructor(): void;
constructor(fileName: string, copiedTextRanges: TextRange[]): boolean;
constructor(args: PasteEditsArgs, formatOptions: FormatCodeSettings): PasteEdits;
    }
    ...
    interface Classifier {
         ...
         */
constructor(text: string, lexState: EndOfLineState, syntacticClassifierAbsent: boolean): ClassificationResult;
constructor(text: string, endOfLineState: EndOfLineState, syntacticClassifierAbsent: boolean): Classifications;
    }
    ...
    interface DocumentRegistry {
         ...
         * in the registry and a new one was created.
         */
constructor(fileName: string, compilationSettingsOrHost: CompilerOptions | MinimalResolutionCacheHost, scriptSnapshot: IScriptSnapshot, version: string, scriptKind?: ScriptKind, sourceFileOptions?: CreateSourceFileOptions | ScriptTarget): SourceFile;
constructor(fileName: string, path: Path, compilationSettingsOrHost: CompilerOptions | MinimalResolutionCacheHost, key: DocumentRegistryBucketKey, scriptSnapshot: IScriptSnapshot, version: string, scriptKind?: ScriptKind, sourceFileOptions?: CreateSourceFileOptions | ScriptTarget): SourceFile;
        /**
...
constructor(fileName: string, compilationSettingsOrHost: CompilerOptions | MinimalResolutionCacheHost, scriptSnapshot: IScriptSnapshot, version: string, scriptKind?: ScriptKind, sourceFileOptions?: CreateSourceFileOptions | ScriptTarget): SourceFile;
constructor(fileName: string, path: Path, compilationSettingsOrHost: CompilerOptions | MinimalResolutionCacheHost, key: DocumentRegistryBucketKey, scriptSnapshot: IScriptSnapshot, version: string, scriptKind?: ScriptKind, sourceFileOptions?: CreateSourceFileOptions | ScriptTarget): SourceFile;
constructor(settings: CompilerOptions): DocumentRegistryBucketKey;
        /**
         ...
         */
constructor(fileName: string, compilationSettings: CompilerOptions, scriptKind?: ScriptKind): void;
        /**
         * Informs the DocumentRegistry that a file is not needed any longer.
         *
         * Note: It is not allowed to call release on a SourceFile that was not acquired from
         ...
         */
constructor(fileName: string, compilationSettings: CompilerOptions, scriptKind: ScriptKind, impliedNodeFormat: ResolutionMode): void;
        /**
         * @deprecated pass scriptKind for and impliedNodeFormat correctness */
constructor(path: Path, key: DocumentRegistryBucketKey, scriptKind?: ScriptKind): void;
constructor(path: Path, key: DocumentRegistryBucketKey, scriptKind: ScriptKind, impliedNodeFormat: ResolutionMode): void;
constructor(): string;
    }
