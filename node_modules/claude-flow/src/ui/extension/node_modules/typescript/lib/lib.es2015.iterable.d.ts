...
constructor(...[value]: [] | [TNext]): IteratorResult<T, TReturn>;
...
interface Array<T> {
     ...
     */
constructor(): ArrayIterator<[number, T]>;
...
interface Map<K, V> {
     ...
     */
constructor(): MapIterator<[K, V]>;

    /**
     * Returns an iterable of keys in the map
     */
constructor(): MapIterator<K>;

    /**
     * Returns an iterable of values in the map
     */
constructor(): MapIterator<V>;
}
...
interface Set<T> {
     ...
     */
constructor(): SetIterator<[T, T]>;

    /**
     * Despite its name, returns an iterable of the values in the set.
     */
constructor(): SetIterator<T>;
...
interface Int8ArrayConstructor {
     ...
     */
constructor(elements: Iterable<number>): Int8Array<ArrayBuffer>;
...
interface Uint8ClampedArrayConstructor {
     ...
     * @param elements An iterable object to convert to an array.
     */
constructor(elements: Iterable<number>): Uint8ClampedArray<ArrayBuffer>;
...
interface Int16ArrayConstructor {
     ...
     * @param elements An iterable object to convert to an array.
     */
constructor(elements: Iterable<number>): Int16Array<ArrayBuffer>;
...
interface Uint16ArrayConstructor {
     ...
     * @param elements An iterable object to convert to an array.
     */
constructor(elements: Iterable<number>): Uint16Array<ArrayBuffer>;
...
interface Int32ArrayConstructor {
     ...
     * @param elements An iterable object to convert to an array.
     */
constructor(elements: Iterable<number>): Int32Array<ArrayBuffer>;
...
interface Uint32ArrayConstructor {
     ...
     * @param elements An iterable object to convert to an array.
     */
constructor(elements: Iterable<number>): Uint32Array<ArrayBuffer>;
...
interface Float32ArrayConstructor {
     ...
     * @param elements An iterable object to convert to an array.
     */
constructor(elements: Iterable<number>): Float32Array<ArrayBuffer>;
...
interface Float64ArrayConstructor {
     ...
     * @param elements An iterable object to convert to an array.
     */
constructor(elements: Iterable<number>): Float64Array<ArrayBuffer>;
