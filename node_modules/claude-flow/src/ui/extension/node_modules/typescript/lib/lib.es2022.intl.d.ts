...
declare namespace Intl {
    ...
    interface Segmenter {
         ...
         */
constructor(input: string): Segments;
constructor(): ResolvedSegmenterOptions;
    }
    ...
    interface Segments {
         ...
         */
constructor(codeUnitIndex?: number): SegmentData;
    ...
    const Segmenter: {
         ...
         */
constructor(locales: LocalesArgument, options?: Pick<SegmenterOptions, "localeMatcher">): UnicodeBCP47LocaleIdentifier[];
    };
