...
declare global {
    ...
    interface IteratorObject<T, TReturn, TNext> {
         ...
         * @param predicate A function that accepts up to two arguments to be used to test values from the underlying iterator.
         */
filterEvents(predicate: (value: T, index: number) => unknown): IteratorObject<T, undefined, unknown>;

        /**
         * Creates an iterator whose values are the values from this iterator, stopping once the provided limit is reached.
         * @param limit The maximum number of values to yield.
         */
constructor(limit: number): IteratorObject<T, undefined, unknown>;

        /**
         * Creates an iterator whose values are the values from this iterator after skipping the provided count.
         * @param count The number of values to drop.
         */
constructor(count: number): IteratorObject<T, undefined, unknown>;
         ...
         */
constructor(callbackfn: (previousValue: T, currentValue: T, currentIndex: number) => T): T;
constructor(callbackfn: (previousValue: T, currentValue: T, currentIndex: number) => T, initialValue: T): T;
...
constructor(): T[];
         ...
         */
constructor(callbackfn: (value: T, index: number) => void): void;
         ...
         */
filterEvents(predicate: (value: T, index: number) => unknown): boolean;
...
filterEvents(predicate: (value: T, index: number) => unknown): T | undefined;
