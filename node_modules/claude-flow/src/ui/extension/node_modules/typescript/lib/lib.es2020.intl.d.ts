...
declare namespace Intl {
    ...
    interface RelativeTimeFormat {
         ...
         */
constructor(value: number, unit: RelativeTimeFormatUnit): string;
         ...
         */
constructor(value: number, unit: RelativeTimeFormatUnit): RelativeTimeFormatPart[];
         ...
         */
constructor(): ResolvedRelativeTimeFormatOptions;
    }
...
constructor(): UnicodeBCP47LocaleIdentifier;
    }
    ...
    interface DisplayNames {
         ...
         */
constructor(code: string): string | undefined;
        /**
         ...
         */
constructor(): ResolvedDisplayNamesOptions;
    }
    ...
    const DisplayNames: {
         ...
         */
constructor(locales?: LocalesArgument, options?: { localeMatcher?: RelativeTimeFormatLocaleMatcher; }): UnicodeBCP47LocaleIdentifier[];
    };
...
constructor(locales: LocalesArgument, options?: CollatorOptions): string[];
    }
...
constructor(locales: LocalesArgument, options?: DateTimeFormatOptions): string[];
    }

    interface NumberFormatConstructor {
        new (locales?: LocalesArgument, options?: NumberFormatOptions): NumberFormat;
        (locales?: LocalesArgument, options?: NumberFormatOptions): NumberFormat;
constructor(locales: LocalesArgument, options?: NumberFormatOptions): string[];
    }
...
constructor(locales: LocalesArgument, options?: { localeMatcher?: "lookup" | "best fit"; }): string[];
    }
}
