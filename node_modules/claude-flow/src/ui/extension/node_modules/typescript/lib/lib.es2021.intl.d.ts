...
constructor(startDate: Date | number | bigint, endDate: Date | number | bigint): string;
constructor(startDate: Date | number | bigint, endDate: Date | number | bigint): DateTimeRangeFormatPart[];
    }
    ...
    interface ListFormat {
         ...
         */
constructor(list: Iterable<string>): string;
         ...
         */
constructor(list: Iterable<string>): { type: "element" | "literal"; value: string; }[];
         ...
         */
constructor(): ResolvedListFormatOptions;
    }
    ...
    const ListFormat: {
         ...
         */
constructor(locales: LocalesArgument, options?: Pick<ListFormatOptions, "localeMatcher">): UnicodeBCP47LocaleIdentifier[];
    };
}
