 ...
 */
function compile(selector, options, _context) {
    var next = compileUnsafe(selector, options, context);
    return (0, subselects_js_1.ensureIsTag)(next, options.adapter);
}
exports.compile = compile;
function compileUnsafe(selector, options, _context) {
 ...
 */
function absolutize(token, _a, _context) {
...
function compileToken(token, options, _context) {
    var _a;
