...
function ensureIsTag(_next, adapter) {
...
var is = function (_next, token, options, _context, compileToken) {
...
exports.subselects = {
    ...
    matches: is,
    where: is,
    not: function (_next, token, options, _context, compileToken) {
        var func = compileToken(token, copyOptions(options), context);
    ...
    has: function (_next, subselect, options, _context, compileToken) {
