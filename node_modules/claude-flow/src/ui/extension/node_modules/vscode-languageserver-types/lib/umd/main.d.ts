...
export interface TextEditChange {
     ...
     */
constructor(): (TextEdit | AnnotatedTextEdit)[];
    /**
...
constructor(): void;
     ...
     * guarded using a client capability.
     */
constructor(edit: TextEdit | AnnotatedTextEdit): void;
    /**
     ...
     */
constructor(position: Position, newText: string): void;
constructor(position: Position, newText: string, annotation: ChangeAnnotation | ChangeAnnotationIdentifier): ChangeAnnotationIdentifier;
    /**
...
constructor(range: Range, newText: string, annotation?: ChangeAnnotation | ChangeAnnotationIdentifier): ChangeAnnotationIdentifier;
    /**
     ...
     * @param annotation An optional annotation.
     */
constructor(range: Range): void;
constructor(range: Range, annotation?: ChangeAnnotation | ChangeAnnotationIdentifier): ChangeAnnotationIdentifier;
}
/**
...
constructor(workspaceEdit?: WorkspaceEdit);
     ...
     * for resources.
     */
constructor(textDocument: OptionalVersionedTextDocumentIdentifier): TextEditChange;
constructor(uri: DocumentUri): TextEditChange;
    private initDocumentChanges;
    private initChanges;
constructor(uri: DocumentUri, options?: CreateFileOptions): void;
constructor(uri: DocumentUri, annotation: ChangeAnnotation | ChangeAnnotationIdentifier, options?: CreateFileOptions): ChangeAnnotationIdentifier;
constructor(oldUri: DocumentUri, newUri: DocumentUri, options?: RenameFileOptions): void;
constructor(oldUri: DocumentUri, newUri: DocumentUri, annotation?: ChangeAnnotation | ChangeAnnotationIdentifier, options?: RenameFileOptions): ChangeAnnotationIdentifier;
constructor(uri: DocumentUri, options?: DeleteFileOptions): void;
constructor(uri: DocumentUri, annotation: ChangeAnnotation | ChangeAnnotationIdentifier, options?: DeleteFileOptions): ChangeAnnotationIdentifier;
}
/**
...
constructor(range?: Range): string;
     ...
     */
constructor(offset: uinteger): Position;
    /**
     ...
     */
constructor(position: Position): uinteger;
    /**
