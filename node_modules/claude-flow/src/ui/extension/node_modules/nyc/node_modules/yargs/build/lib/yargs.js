...
function Yargs(processArgs = [], cwd = process.cwd(), parentRequire = require) {
    const self = {};
    let command; // TODO: Remove if unused
    let completion = null;
    let groups = {};
    const globalMiddleware = [];
    let output = '';
    const preservedGroups = {};
    let usage; // TODO: Remove if unused
    let validation; // TODO: Remove if unused
    ...
    let default$0; // TODO: Remove if unused
    ...
    // by this action.
    let options; // TODO: Remove if unused
    ...
    function unfreeze() {
        ...
        let configObjects; // TODO: Remove if unused
        ({
            options,
            configObjects,
            exitProcess,
    ...
    let recommendCommands; // TODO: Remove if unused
        ...
        try {
            ...
            if (argv._.length) {
                if (handlerKeys.length) {
                    let firstUnknownCommand; // TODO: Remove if unused
