...
function command(yargs, usage, validation, globalMiddleware = []) {
    ...
    let handlers = {};
    let aliasMap = {};
    let defaultCommand; // TODO: Remove if unused
    ...
    self.addDirectory = function addDirectory(dir, _context, _req, callerFile, opts) {
        opts = opts || {};
    ...
    self.runCommand = function runCommand(command, yargs, parsed, commandIndex) {
        ...
        if (commandHandler.handler && !yargs._hasOutput()) {
            ...
            let handlerResult; // TODO: Remove if unused
    ...
    // onto argv.
    function populatePositionals(commandHandler, argv, _context) {
