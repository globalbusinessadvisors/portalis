...
constructor(_req: HttpProxyAgentClientRequest, opts: AgentConnectOpts): void;
constructor(_req: HttpProxyAgentClientRequest, opts: AgentConnectOpts): void;
constructor(_req: HttpProxyAgentClientRequest, opts: AgentConnectOpts): Promise<net.Socket>;
}
export {};
