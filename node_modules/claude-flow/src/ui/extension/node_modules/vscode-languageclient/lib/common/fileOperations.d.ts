...
constructor(capabilities: proto.ServerCapabilities): void;
constructor(data: RegistrationData<proto.FileOperationRegistrationOptions>): void;
...
constructor(originalEvent: E): Promise<void>;
...
interface RequestEvent<I> {
    ...
    readonly files: ReadonlyArray<I>;
constructor(thenable: Thenable<code.WorkspaceEdit>): void;
...
constructor(originalEvent: E & RequestEvent<I>): Promise<void>;
    private waitUntil;
