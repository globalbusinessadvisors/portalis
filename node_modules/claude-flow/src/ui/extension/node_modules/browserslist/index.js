...
function filterByYear(since, _context) {
  since = since / 1000
...
function checkName(name, _context) {
  var data = byName(name, context)
...
function filterJumps(list, name, nVersions, _context) {
  var jump = 1
  switch (name) {
    case 'android':
...
function resolve(queries, _context) {
...
function loadCustomUsage(_context, config) {
...
function nodeQuery(_context, node) {
...
function sinceQuery(_context, node) {
  var year = parseInt(node.year)
  var month = parseInt(node.month || '01') - 1
  var day = parseInt(node.day || '01')
  return filterByYear(Date.UTC(year, month, day, 0, 0, 0), context)
}
function coverQuery(_context, node) {
