...
declare namespace browserslist {
   ...
   */
  let aliases: { // TODO: Remove if unused
    [alias: string]: string | undefined
  }
  /**
   * Aliases to work with joined versions like `ios_saf 7.0-7.1`.
   */
  let versionAliases: { // TODO: Remove if unused
    [browser: string]:
      | {
   ...
   */
  let desktopNames: { // TODO: Remove if unused
  ...
  let nodeVersions: string[] // TODO: Remove if unused
  interface Usage {
    [version: string]: number
  }
  ...
  let cache: { // TODO: Remove if unused
    [feature: string]: {
      [name: string]: {
   ...
   */
  let defaults: readonly string[] // TODO: Remove if unused
  /**
