...
function _stringStream(
  ...
  if (options?._useHtmlParser2) {
    ...
    return new Writable({
      decodeStrings: false,
constructor(chunk, _encoding, _callback) {
...
constructor(stream, (err) => cb(err, load(stream.document)));
  return stream;
}
/**
...
export async function fromURL(
  ...
  let undiciStream: Promise<undici.Dispatcher.StreamData<unknown>> | undefined; // TODO: Remove if unused
